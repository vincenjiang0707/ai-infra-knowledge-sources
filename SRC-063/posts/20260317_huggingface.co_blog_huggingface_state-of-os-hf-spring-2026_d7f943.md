...
published: Tue, 17 Mar 2026 16:37:55 GMT

Updated • 57.9k • 54

#
[
](https://huggingface.co#state-of-open-source-on-hugging-face-spring-2026)
State of Open Source on Hugging Face: Spring 2026

[Team Article](https://huggingface.co/blog)

This post builds on an earlier analysis conducted mid-2025, [available here](https://huggingface.co/blog/evijit/hf-hub-ecosystem-overview), which examined what the Hugging Face Community is building. We recommend reading additional perspectives on the open source ecosystem in and outside of Hugging Face from the [Data Provenance Initiative](https://arxiv.org/abs/2512.03073), [Interconnects](https://www.interconnects.ai/), [OpenRouter and a16z](https://openrouter.ai/state-of-ai), and [MIT and the Linux Foundation](https://www.linuxfoundation.org/blog/revealing-the-hidden-economics-of-open-models-in-the-ai-era). As the Hugging Face ecosystem is distributed, analyses are a combination of Hugging Face and community members' work, each of which is appropriately credited.
...
##
[
](https://huggingface.co#open-source-in-competition)
**Open Source in Competition**

More companies, both large and small, are building on open source. Over 30% of the Fortune 500 now maintain verified accounts on Hugging Face. Startups frequently use open models as default components: [Thinking Machines built its Tinker model options entirely on open weights, ](https://thinkingmachines.ai/tinker/)while popular IDEs such as [VSCode](https://code.visualstudio.com/) and [Cursor](https://cursor.com/docs) support both open and closed models. [Established American companies such as Airbnb have increased their engagement with the open ecosystem](https://www.thewirechina.com/2025/11/09/cheap-and-open-source-chinese-ai-models-are-taking-off/), and Hugging Face has seen more [legacy companies upgrading their organizational subscriptions](https://huggingface.co/enterprise) over the course of 2025.
...
##
[
](https://huggingface.co#the-geography-of-open-source)
...
[
](https://cdn-uploads.huggingface.co/production/uploads/62543749b777cd32720675c2/FukCP1ojU15Q7cNweAXe2.png)*Data from Hugging Face* | *Graph and Research from Longpre et al. “Economies of Open Intelligence: Tracing Power & Participation in the Model Ecosystem”*
...
[
](https://cdn-uploads.huggingface.co/production/uploads/6413251362e6057cbb6259bd/WjFZqWl-y3Sz7E3KVHCmH.png)*Data from Hugging Face* | *Graph and Research from Longpre et al. “Economies of Open Intelligence: Tracing Power & Participation in the Model Ecosystem”*
...
####
[
](https://huggingface.co#countries-organizations-and-individual-users)
...
[
](https://cdn-uploads.huggingface.co/production/uploads/62543749b777cd32720675c2/VztgqApx9IwW54zrD4lcL.png)*Data and Graph from Hugging Face*

####
[
](https://huggingface.co#between-the-us-and-china)
Between the U.S. and China

Of the newly created models in 2025, the majority of trending models were either developed in China or derivative of a model developed in China. The most popular models were developed by large organizations, predominantly from the U.S. and China. For more on the Chinese AI ecosystem, read our three part series reflecting on the changes in one year since the "DeepSeek Moment", with one on [strategic changes](https://huggingface.co/blog/huggingface/one-year-since-the-deepseek-moment),[ two on architectural changes](https://huggingface.co/blog/huggingface/one-year-since-the-deepseek-moment-blog-2),[ and three on organizations and the future](https://huggingface.co/blog/huggingface/one-year-since-the-deepseek-moment-blog-3).
...
####
[
](https://huggingface.co#global-open-source-and-sovereignty)
Global Open Source and Sovereignty

Open source AI is increasingly tied to questions of sovereignty. Open weight models allow governments and public institutions to fine-tune systems on local data under national legal frameworks. Models that can be deployed on domestic hardware reduce reliance on foreign-controlled cloud infrastructure. Transparency around model architecture, training processes, and evaluation supports regulatory review and public accountability. Read more about the [open source approach to sovereignty here](https://huggingface.co/blog/frimelle/sovereignty-and-open-source).

At the national level, governments are taking action. South Korea's National Sovereign AI Initiative [launched mid-2025](https://www.kedglobal.com/artificial-intelligence/newsView/ked202508040010) named national champions [LG AI Research](https://www.lgresearch.ai/),[ SK Telecom](https://www.sktelecom.com/),[ Naver Cloud](https://www.ncloud.com/),[ NC AI](https://nc-ai.com/en), and[ Upstage](https://www.upstage.ai/) to produce competitive domestic models. Three models from South Korea trended simultaneously on Hugging Face Hub in February 2026. In March 2026, In 2026, South Korea and U.S. startup Reflection AI [announced a data center partnership](https://www.wsj.com/tech/ai/nvidia-backed-ai-startup-to-spend-billions-on-korea-data-center-to-combat-china-f945a326), also bringing frontier open weight models to South Korea.

Switzerland's[ Swiss AI](https://huggingface.co/swiss-ai) initiative and various EU-funded projects reflect similar priorities. The UK's principle of "public money, public code" has influenced several government-backed AI initiatives.

*Hugging Face Trending Page February 2026*

These investments in open-source and open weight AI are already paying dividends for countries with thriving AI training ecosystems of their own, as we see that [models and datasets are typically most used in the regions where they're developed](https://huggingface.co/spaces/yjernite/january-hub); with developers often turning to the models that best represent their languages and reflect similar technical and application requirements.

*Data and Graph from Hugging Face*

##
[
](https://huggingface.co#model-popularity)
**Model Popularity**
...
##
[
](https://huggingface.co#papers-and-scientific-contributions)
...
Of Hugging Face's [Daily Papers](https://huggingface.co/papers/date), a set of papers curated by Hugging Face's [AK](https://huggingface.co/akhaliq), papers that reference model and dataset creation, showing the most open source adoption, are generally diverse. Prominent takeaways show medical papers being influential, while Big Tech's influence is sparse.

*Data from Hugging Face* | *Graphic and story by AI World*

##
[
](https://huggingface.co#derivative-models)
**Derivative Models**
...
##
[
](https://huggingface.co#adoption-and-accessibility)
...
Performance differences between frontier models and smaller systems often narrow rapidly through fine-tuning and task-specific adaptation. On the Hub, models with hundreds of millions of parameters support [search, tagging, and document processing workflows](https://huggingface.co/docs/hub/en/models-tasks), while models in the single-digit billions are widely used for coding, reasoning, and multimodal tasks. As a result, most major model developers now release families of models spanning a range of sizes. The rise of capable small models shifts autonomy closer to the edge, reducing dependency on centralized cloud providers.

##
[
](https://huggingface.co#compute-hardware-and-open-source)
**Compute, Hardware, and Open Source**

Open source AI development is closely linked to hardware trends. Most models are optimized for NVIDIA GPUs, but support for AMD hardware continues to expand. [Stability AI model collections](https://huggingface.co/stabilityai/collections) now optimize for both NVIDIA and AMD platforms. Libraries increasingly target both, and tooling has improved to make cross-hardware deployment more straightforward. In 2025 Hugging Face launched the [Kernel Hub](https://huggingface.co/kernels-community) to load and run kernels optimized for NVIDIA and AMD GPUs.

In parallel, Chinese open models are being released with explicit support for [domestically developed chips](https://huggingface.co/blog/huggingface/shifting-compute-landscape). Alibaba has invested in inference-focused chip architectures designed to fill Chinese data centers with hardware capable of running open source models locally.

While access to compute remains a core necessity across the board for development and deployment of AI models, open-source and open-weight models are helping break away from an ecosystem where it becomes the be-all and end-all, with increasingly more models at [all levels of performance pushing efficiency from 10x to 1000x lower costs than flagship AI models](https://huggingface.co/spaces/hfmlsoc/different-flops) the largest developers.
...
##
[
](https://huggingface.co#sub-communities-robotics)
...
[
](https://cdn-uploads.huggingface.co/production/uploads/62543749b777cd32720675c2/fKD6zEQrgNHdVH0wRlG90.png)*Data from Hugging Face* | *Graph and Story by AI World*

Community-contributed datasets span everything from household manipulation tasks to autonomous driving. The largest multimodal dataset for spatial intelligence, Learning to Drive (L2D), was released through a LeRobot collaboration with Yaak. Datasets like[ RoboMIND](https://huggingface.co/datasets/x-humanoid-robomind/RoboMIND), with over 107,000 real-world trajectories across 479 distinct tasks and multiple robot embodiments, provide the kind of scale and diversity needed for training generalizable robotic policies.

Hugging Face's[ acquisition of Pollen Robotics](https://huggingface.co/blog/hugging-face-pollen-robotics-acquisition) opened open source robotic sales to both industry and academic labs, as well as everyday hobbyists. [LeRobot](https://huggingface.co/docs/lerobot/en/index), Hugging Face's open source robotics library that provides models, datasets, and tools for real-world robotics in PyTorch, covering imitation learning, reinforcement learning, and vision-language-action models, experienced rapid growth. Over the past year, its GitHub repository stars nearly tripled.

*Data from GitHub* | *Graphic from* [star-history.com](http://star-history.com)

##
[
](https://huggingface.co#sub-communities-ai-for-science)
...
Community-led projects have formed around shared research goals, often involving [hundreds of contributors](https://huggingface.co/hugging-science) working across institutions and disciplines. These efforts highlight the role of open source as a mechanism for coordinating large-scale, interdisciplinary work that would be difficult to organize through traditional academic or corporate structures alone.

##
[
](https://huggingface.co#looking-forward)
**Looking Forward**
...
The geographic rebalancing of power is accelerating. Western organizations increasingly seek commercially deployable alternatives to Chinese models, creating urgency around efforts like[ OpenAI's GPT-OSS](https://huggingface.co/collections/openai/gpt-oss),[ AI2's OLMo](https://huggingface.co/collections/allenai/olmo-31), and [Google's Gemma](https://huggingface.co/google/collections) to offer competitive open options from US and European developers. Whether these efforts can match the adoption momentum of Qwen and DeepSeek will be a defining question of 2026.
