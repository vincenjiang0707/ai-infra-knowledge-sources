...
published: Tue, 17 Mar 2026 12:33:39 GMT

#
[
](https://huggingface.co#holotron-12b---high-throughput-computer-use-agent)
Holotron-12B - High Throughput Computer Use Agent
...
#
[
](https://huggingface.co#why-we-built-holotron-12b)
...
##
[
](https://huggingface.co#high-throughput-inference-with-a-hybrid-ssm-architecture)
...
##
[
](https://huggingface.co#training-and-evaluating-holotron-12b)
...
##
[
](https://huggingface.co#agent-benchmarks)
Agent Benchmarks
...
##
[
](https://huggingface.co#localization-benchmarks)
...
#
[
](https://huggingface.co#whats-next-scaling-the-future-of-agentic-intelligence-with-nemotron-3-omni)
