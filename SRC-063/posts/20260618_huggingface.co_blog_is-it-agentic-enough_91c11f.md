...
#
[
](https://huggingface.co#is-it-agentic-enough-benchmarking-open-models-on-your-own-tooling)
Is it agentic enough? Benchmarking open models on your own tooling
...
##
[
](https://huggingface.co#testing-software-for-agentic-use)
...
###
[
](https://huggingface.co#not-all-successes-are-equal)
...
###
[
](https://huggingface.co#how-do-we-run-evaluations)
...
###
[
](https://huggingface.co#which-models-to-benchmark-against)
...
[
](https://huggingface.co#large-open-models-hold-the-model-vary-the-revision)
...
###
[
](https://huggingface.co#small-models-hold-the-revision-vary-the-model)
...
##
[
](https://huggingface.co#tweaking-the-tool-markers-and-results)
...
###
[
](https://huggingface.co#whats-a-marker)
What's a marker?
...
###
[
](https://huggingface.co#is-the-cli--skill-commit-helping)
...
##
[
](https://huggingface.co#trying-it-yourself)
Trying it yourself
