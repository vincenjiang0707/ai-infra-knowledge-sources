...
Text Generation • 0.3B • Updated • 1.47k • 32

#
[
](https://huggingface.co#up-to-32x-faster-inference-with-lfm25-dspark)
Up to 3.2x Faster Inference with LFM2.5-DSpark
...
**Faster inference**: up to 3.18 throughput improvement on a GPU and up to 2.87x on-device.**Toward on-device agentic inference**: cuts function-calling latency by 57% on average for LFM2.5-2.6B**Day-one support for llama.cpp and SGLang**: LFM-compatible DSpark integration is open-sourced upstream

##
[
](https://huggingface.co#how-does-dspark-work)
...
##
[
](https://huggingface.co#quality-parity)
Quality parity
...
##
[
](https://huggingface.co#inference-speed-up-on-cpu-and-gpu)
...
| Dataset | Acceptance (of 10) | Speedup on H100 | Speedup on M4 Max |
|---|---|---|---|
| MATH500 | 6.02 | 2.56x 668 → 1712 tok/s |
2.62x 140 → 366 tok/s |
| HumanEval | 5.31 | 2.26x 664 → 1499 tok/s |
2.87x 136 → 389 tok/s |
| MBPP | 5.52 | 2.37x 667 → 1578 tok/s |
2.74x 137 → 375 tok/s |
| GSM8K | 4.34 | 1.67x 624 → 1041 tok/s |
2.73x 140 → 381 tok/s |
| MT-Bench | 3.90 | 1.66x 657 → 1091 tok/s |
1.72x 137 → 237 tok/s |
| Mean | 5.02 | 2.10x 656 → 1384 tok/s |
2.54x 138 → 350 tok/s |
...
##
[
](https://huggingface.co#how-to-use-lfm25-dspark)
...
**Safetensors**:[LFM2.5-2.6B-DSpark](https://huggingface.co/LiquidAI/LFM2.5-2.6B-DSpark),[LFM2.5-1.2B-Instruct-DSpark](https://huggingface.co/LiquidAI/LFM2.5-1.2B-Instruct-DSpark), and[LFM2.5-8B-A1B-DSpark](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B-DSpark)**GGUF**:[LFM2.5-2.6B-DSpark-GGUF](https://huggingface.co/LiquidAI/LFM2.5-2.6B-DSpark-GGUF),[LFM2.5-1.2B-Instruct-DSpark-GGUF](https://huggingface.co/LiquidAI/LFM2.5-1.2B-Instruct-DSpark-GGUF),[LFM2.5-8B-A1B-DSpark-GGUF](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B-DSpark-GGUF)
