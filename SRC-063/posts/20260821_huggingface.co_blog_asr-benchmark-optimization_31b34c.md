...
Automatic Speech Recognition • 2B • Updated • 211k • 1.14k

#
[
](https://huggingface.co#measuring-benchmark-optimization-in-speech-recognition)
Measuring benchmark optimization in speech recognition

[Update on GitHub](https://github.com/huggingface/blog/blob/main/asr-benchmark-optimization.md)
...
##
[
](https://huggingface.co#reference-disagreement-voxpopuli-case-study)
...
[nvidia/canary-qwen-2.5b](https://huggingface.co/nvidia/canary-qwen-2.5b)[ibm-granite/granite-speech-4.1-2b](https://huggingface.co/ibm-granite/granite-speech-4.1-2b)[microsoft/Phi-4-multimodal-instruct](https://huggingface.co/microsoft/Phi-4-multimodal-instruct)[nvidia/parakeet-tdt-0.6b-v2](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v2)[bosonai/higgs-audio-v3-8b-stt-v2](https://huggingface.co/bosonai/higgs-audio-v3-8b-stt-v2)[Qwen/Qwen3-ASR-0.6B-hf](https://huggingface.co/Qwen/Qwen3-ASR-0.6B-hf)[mistralai/Voxtral-Mini-3B-2507](https://huggingface.co/mistralai/Voxtral-Mini-3B-2507)[moonshotai/Kimi-Audio-7B-Instruct](https://huggingface.co/moonshotai/Kimi-Audio-7B-Instruct)[openai/whisper-large-v3](https://huggingface.co/openai/whisper-large-v3)[moonshine-ai/moonshine-streaming-medium](https://huggingface.co/moonshine-ai/moonshine-streaming-medium)**Drops the courtesy (❌) out of 11****6****5****1**Parakeet is the only model that flips between reproducing the benchmark on the real clip and getting it right on the same-speaker clone. Phi-4 is the only model still dropping the courtesy on the ep-fresh clone. When we instead resynthesize the sentence in a generic TTS voice unconnected to any parliamentary recording, all eleven models restore the courtesy.
...
##
[
](https://huggingface.co#masked-entity-retrieval)
...
- green highlighting with
__underline__marks a correct, audio-faithful insertion in place of the reference's erroneous wording; - red highlighting (plain text) reproduces the reference transcript's erroneous, audio-unsupported content: keeping "Mr President", writing "more than 1 amendments" where the audio says "one thousand six hundred", supplying the silenced year "2011", or ending on "plenary".
...
[nvidia/canary-qwen-2.5b](https://huggingface.co/nvidia/canary-qwen-2.5b)[ibm-granite/granite-speech-4.1-2b](https://huggingface.co/ibm-granite/granite-speech-4.1-2b)__one thousand six hundred__amendments to the[microsoft/Phi-4-multimodal-instruct](https://huggingface.co/microsoft/Phi-4-multimodal-instruct)[nvidia/parakeet-tdt-0.6b-v2](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v2)[bosonai/higgs-audio-v3-8b-stt-v2](https://huggingface.co/bosonai/higgs-audio-v3-8b-stt-v2)__one thousand six hundred__amendments to the[Qwen/Qwen3-ASR-0.6B-hf](https://huggingface.co/Qwen/Qwen3-ASR-0.6B-hf)__1,600__amendments to the[mistralai/Voxtral-Mini-3B-2507](https://huggingface.co/mistralai/Voxtral-Mini-3B-2507)__1,600__amendments to the[moonshotai/Kimi-Audio-7B-Instruct](https://huggingface.co/moonshotai/Kimi-Audio-7B-Instruct)__Ah__in the committee on budgets we voted on more than__one thousand six hundred__amendments to the[openai/whisper-large-v3](https://huggingface.co/openai/whisper-large-v3)__1,600__amendments to the[moonshine-ai/moonshine-streaming-medium](https://huggingface.co/moonshine-ai/moonshine-streaming-medium)__one thousand six hundred__amendments to theRecovery rates were highest on the public benchmarks and lower on held-out or newly collected audio (ep-fresh and libri-fresh below). On LibriSpeech, some of the strongest benchmark-performing models reproduced masked numbers in roughly 30–40% of examples, even though the number itself had been removed. The effect weakened on freshly collected data for several models, suggesting that the surrounding benchmark-associated audio—not only textual autocomplete—helped the models recover the reference.

##
[
](https://huggingface.co#orthographic-switching)
...
##
[
](https://huggingface.co#localizing-the-switches)
