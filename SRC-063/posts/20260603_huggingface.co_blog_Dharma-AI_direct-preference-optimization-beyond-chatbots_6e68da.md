...
#
[
](https://huggingface.co#direct-preference-optimization-beyond-chatbots)
Direct Preference Optimization Beyond Chatbots

[Team Article](https://huggingface.co/blog)

[
](https://huggingface.co#using-rejection-pairs-from-your-models-own-failures)
...
###
[
](https://huggingface.co#the-loop-survives-fine-tuning)
...
###
[
](https://huggingface.co#the-design-decision-degenerate-outputs-as-rejection-pairs)
...
###
[
](https://huggingface.co#consistent-across-five-model-families)
...
###
[
](https://huggingface.co#the-pattern-beyond-ocr)
