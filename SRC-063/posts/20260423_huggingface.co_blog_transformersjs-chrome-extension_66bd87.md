...
Any-to-Any • 5B • Updated • 144k • 479

#
[
](https://huggingface.co#how-to-use-transformersjs-in-a-chrome-extension)
How to Use Transformers.js in a Chrome Extension

[Update on GitHub](https://github.com/huggingface/blog/blob/main/transformersjs-chrome-extension.md)

[Gemma 4 E2B](https://huggingface.co/google/gemma-4-E2B)to help users navigate the web.
...
##
[
](https://huggingface.co#what-we-will-build)
What we will build
...
- Live extension:
[Chrome Web Store](https://chromewebstore.google.com/detail/transformerjs-gemma-4-bro/dhaknnnkcdkjhcclchmnfdhddoehoool) - Source code:
[github.com/nico-martin/gemma4-browser-extension](https://github.com/nico-martin/gemma4-browser-extension) - End result: a background-hosted Transformers.js engine, a side panel chat UI, and a content script for page extraction and highlighting.

##
[
](https://huggingface.co#1-chrome-extension-architecture-mv3)
...
###
[
](https://huggingface.co#11-runtime-contexts-and-entry-points)
...
, built from.`src/sidebar/index.html`

`content_scripts[].js = content.js`

with`matches: http(s)://*/*`

and`run_at: document_idle`

, built from.`src/content/content.ts`
...
###
[
](https://huggingface.co#12-what-runs-where)
1.2 What runs where

The key design decision is to keep heavy orchestration in the background and keep UI/page logic thin.

- Background (
) is the control plane: agent lifecycle, model initialization, tool execution, and shared services like feature extraction.`src/background/background.ts`

- Side panel (
) is the interaction layer: chat input/output, streaming updates, and setup controls.`src/sidebar/*`

- Content script (
) is the page bridge: DOM extraction and highlight actions.`src/content/content.ts`
...
###
[
](https://huggingface.co#13-messaging-contract)
...
##
[
](https://huggingface.co#2-transformersjs-integration-details)
2) Transformers.js integration details

###
[
](https://huggingface.co#21-models-and-responsibilities)
...
###
[
](https://huggingface.co#22-where-inference-runs)
...
###
[
](https://huggingface.co#23-download-and-cache-lifecycle)
...
downloads/initializes models and emits`DOWNLOAD_PROGRESS`
...
##
[
](https://huggingface.co#3-agent-and-tool-execution-loop)
3) Agent and tool execution loop

###
[
](https://huggingface.co#31-tool-calling-basics-why-this-layer-exists)
...
###
[
](https://huggingface.co#32-tool-interface-in-this-project)
...
###
[
](https://huggingface.co#33-loop-design-agentrunagent)
...
): system/user/tool/assistant turns used for messages in`generator(...)`
...
##
[
](https://huggingface.co#4-data-boundaries-and-persistence)
...
##
[
](https://huggingface.co#5-build-and-packaging-notes)
...
##
[
](https://huggingface.co#final-takeaway)
Final takeaway
