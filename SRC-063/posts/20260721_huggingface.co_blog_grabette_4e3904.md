...
Convert Grabette recordings into a LeRobot dataset
...
👉 ** Build a Grabette (GitHub)** ·

*Built with ❤️ by Pollen Robotics.*

Convert Grabette recordings into a LeRobot dataset

[@SteveNguyen](https://huggingface.co/SteveNguyen) [@glannuzel](https://huggingface.co/glannuzel) Congrats on the release, really excited to build one of these.
