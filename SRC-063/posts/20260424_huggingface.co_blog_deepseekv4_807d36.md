...
Text Generation • 291B • Updated • 1.49M • 2.25k

#
[
](https://huggingface.co#deepseek-v4-a-million-token-context-that-agents-can-actually-use)
DeepSeek-V4: a million-token context that agents can actually use

[Update on GitHub](https://github.com/huggingface/blog/blob/main/deepseekv4.md)
...
##
[
](https://huggingface.co#the-kv-cache-problem-for-agents)
...
[
](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig1_efficiency.png)*Figure 1: benchmark comparison (left), per-token FLOPs and accumulated KV cache against sequence length (right).*

##
[
](https://huggingface.co#hybrid-attention-csa-and-hca)
...
[
](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig3_csa.png)*Figure 3: CSA. The compressor collapses every 4 tokens into one compressed KV entry. The lightning indexer picks the top-k compressed blocks per query. A sliding-window branch handles the most recent uncompressed tokens.*
...
[
](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig4_hca.png)*Figure 4: HCA. A heavier compressor (128x vs. 4x) followed by dense attention over the compressed stream, with the same sliding-window branch for recency.*
...
[
](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig2_architecture.png)*Figure 2: overall architecture. Attention layers alternate between CSA and HCA. Feed-forward layers use DeepSeekMoE. Residual connections are replaced with manifold-constrained hyper-connections (mHC).*

##
[
](https://huggingface.co#what-changes-for-agents)
...
###
[
](https://huggingface.co#interleaved-thinking-across-tool-calls)
...
[
](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig7_thinking.png)*Figure 7: thinking with tools (top) preserves reasoning across all turns. Thinking without tools (bottom) discards reasoning at each new user message.*

###
[
](https://huggingface.co#tool-call-schema-with-dedicated-tokens)
...
###
[
](https://huggingface.co#dsec-a-sandbox-built-for-rl-rollouts)
...
##
[
](https://huggingface.co#agent-benchmark-results)
...
[
](https://huggingface.co/buckets/burtenshaw/deepseek-v4-figures/resolve/v4_fig9_mrcr.png)*Figure 9: MRCR 8-needle retrieval. V4-Pro-Max stays above 0.82 through 256K and holds at 0.59 at 1M.*

##
[
](https://huggingface.co#using-the-models)
Using the models
