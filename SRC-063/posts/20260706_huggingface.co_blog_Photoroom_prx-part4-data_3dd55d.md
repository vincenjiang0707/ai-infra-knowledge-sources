...
##
[
](https://huggingface.co#1-guiding-principles)
1. Guiding principles

###
[
](https://huggingface.co#a-diverse-dataset-for-pre-training)
...
###
[
](https://huggingface.co#a-mix-of-data-sources)
...
###
[
](https://huggingface.co#our-captions-philosophy)
...
###
[
](https://huggingface.co#data-formats)
Data formats
...
###
[
](https://huggingface.co#on-text-latents)
On text latents
...
###
[
](https://huggingface.co#on-image-encoding)
On image encoding
...
##
[
](https://huggingface.co#2-building-the-dataset-in-lance)
...
###
[
](https://huggingface.co#existing-captions-and-embeddings-for-exploration)
...
###
[
](https://huggingface.co#profiling-and-exploring-the-data)
...
##
[
](https://huggingface.co#3-re-captioning-everything-with-a-vlm)
...
[
](https://cdn-uploads.huggingface.co/production/uploads/680a58121b2c7c159d2bd481/DTRMDylmVp1dfdSaL7Epu.jpeg)*A small diffusion model trained on Qwen2.5-VL-7B captions (red) versus the baseline LLaVA-1.5-LLaMA3-8B captions (blue), scored every 10k steps up to 100k. Lower is better on all three metrics.*
...
###
[
](https://huggingface.co#choosing-the-captioner)
...
[Qwen2.5-VL-7B-Captioner-Relaxed](https://huggingface.co/Ertugrul/Qwen2.5-VL-7B-Captioner-Relaxed)(fine-tuned for captioning)[Qwen3-VL-8B](https://huggingface.co/Qwen/Qwen3-VL-8B-Instruct)[Qwen3.5-9B](https://huggingface.co/Qwen/Qwen3.5-9B)
...
[
](https://cdn-uploads.huggingface.co/production/uploads/680a58121b2c7c159d2bd481/5lfN6mZXLK6XvoGZYNAeL.jpeg)*FID, CMMD, and DINO-MMD over training for the three captioner candidates and two reference captioners, scored every 10k steps up to 100k. Lower is better on all three.*
...
captions cost to generate. We measured it only for the three candidates, all served through [vLLM](https://github.com/vllm-project/vllm)
...
same 20 img/s once fixed: it had been saved with the wrong architecture class, which broke vLLM's `torch.compile`

hashing and forced
slow eager mode until we re-saved it as `Qwen2_5_VLForConditionalGeneration`
...
##
[
](https://huggingface.co#4-writing-mosaic-data-shards)
...
###
[
](https://huggingface.co#what-mds-is-and-why-we-use-it-over-lance)
...
**deterministic, resumable shuffling**: with a choice of algorithms that trade shuffle quality against host memory.**elastic mid-epoch checkpoint resume**: change the number of nodes/ranks and resume without re-seeing or skipping samples.**weighted mixing of multiple streams**: different datasets/subsets at chosen ratios while keeping the shuffling and resumption guarantees intact.

###
[
](https://huggingface.co#resolution--aspect-ratio-bucketing)
...
##
[
](https://huggingface.co#5-data-filtering)
5. Data filtering
...
##
[
](https://huggingface.co#6-deduplication)
6. Deduplication
...
[Qwen2.5-VL-7B-Instruct](https://huggingface.co/Qwen/Qwen2.5-VL-7B-Instruct)[LLaVA-1.5-LLaMA3-8B](https://huggingface.co/xtuner/llava-llama-3-8b-v1_1)[Qwen2.5-VL-7B-Captioner-Relaxed](https://huggingface.co/Ertugrul/Qwen2.5-VL-7B-Captioner-Relaxed)[Qwen3-VL-8B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-8B-Instruct)[Qwen3.5-9B](https://huggingface.co/Qwen/Qwen3.5-9B)

Evaluation metrics

[FID (Heusel et al., 2017)](https://arxiv.org/abs/1706.08500)[CMMD, "Rethinking FID" (Jayasumana et al., 2024)](https://arxiv.org/abs/2401.09603)[DINOv2 (Oquab et al., 2023), the features behind DINO-MMD](https://arxiv.org/abs/2304.07193)
