...
source: https://huggingface.co/blog/daggr
published: Thu, 29 Jan 2026 00:00:00 GMT

Image-to-Image • 4B • Updated • 404k • 970

#
[
](https://huggingface.co#introducing-daggr-chain-apps-programmatically-inspect-visually)
Introducing Daggr: Chain apps programmatically, inspect visually

[Update on GitHub](https://github.com/huggingface/blog/blob/main/daggr.md)

**TL;DR:**

[Daggr](https://github.com/gradio-app/daggr)is a new, open-source Python library for building AI workflows that connect Gradio apps, ML models, and custom functions. It automatically generates a visual canvas where you can inspect intermediate outputs, rerun individual steps, and manage state for complex pipelines, all in a few lines of Python code!
...
[Background](https://huggingface.co#background)[Getting Started](https://huggingface.co#getting-started)[Sharing Your Workflows](https://huggingface.co#sharing-your-workflows)[End-to-End Example with Different Nodes](https://huggingface.co#end-to-end-example-with-different-nodes)[Next Steps](https://huggingface.co#next-steps)
...
###
[
](https://huggingface.co#node-types)
Node Types
...
###
[
](https://huggingface.co#sharing-your-workflows)
...
##
[
](https://huggingface.co#end-to-end-example-with-different-nodes)
