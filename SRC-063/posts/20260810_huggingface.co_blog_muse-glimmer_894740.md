...
Image-Text-to-Text • Updated • 195

#
[
](https://huggingface.co#meta-is-back-with-muse-glimmer-local-agentic-multimodal-and-open-source)
Meta is back with Muse Glimmer: local, agentic, multimodal, and open source!
...
###
[
](https://huggingface.co#text-decoder)
Text Decoder
...
###
[
](https://huggingface.co#perception-encoder)
Perception Encoder
...
###
[
](https://huggingface.co#text-only-inference)
Text-only Inference
...
###
[
](https://huggingface.co#prompting-the-model-with-images-and-text)
...
###
[
](https://huggingface.co#video-inference)
Video Inference
...
###
[
](https://huggingface.co#multimodal-tool-calling)
...
Here is an end to end script to perform object detection
...
###
[
](https://huggingface.co#speculative-decoding-with-transformers)
...
###
[
](https://huggingface.co#speculative-decoding-with-llamacpp)
...
##
[
](https://huggingface.co#support-for-muse-glimmer-vllm-with-transformers-backend)
...
##
[
](https://huggingface.co#connect-openclaw-to-muse-glimmer)
...
###
[
](https://huggingface.co#hey-muse-glimmer-quantize-yourself)
...
###
[
](https://huggingface.co#hey-muse-glimmer-deploy-yourself)
...
###
[
](https://huggingface.co#hey-muse-glimmer-optimize-yourself)
...
###
[
](https://huggingface.co#hey-muse-glimmer-research-the-hub)
