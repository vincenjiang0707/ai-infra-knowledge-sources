...
#
[
](https://huggingface.co#profiling-in-pytorch-part-2-from-nnlinear-to-a-fused-mlp)
Profiling in PyTorch (Part 2): From nn.Linear to a Fused MLP

[Update on GitHub](https://github.com/huggingface/blog/blob/main/torch-mlp-fusion.md)

This article is also available in Chinese [简体中文](https://huggingface.co/blog/zh/torch-mlp-fusion).
...
##
[
](https://huggingface.co#from-matmul-add-to-linear)
...
###
[
](https://huggingface.co#what-is-the-transpose-doing)
...
###
[
](https://huggingface.co#why-are-there-no-separate-mul-and-add-kernels)
...
[
](https://huggingface.co#can---compile-help-a-single-linear)
Can --compile help a single Linear?

Let's compile the forward call and look at the profiler trace. (The profiler trace is visualized in the [next section](https://huggingface.co#where-did-the-transpose-go-kernel-layouts-and-pre-ops))
...
whenever a model feels slow. For a single GEMM-with-bias, compile has very little to do. This is not a bug, this is just that compile needs more than one operation to possibly do any fusing. Let's prove that by [looking at an MLP](https://huggingface.co#stacking-two-linears-the-mlp).

###
[
](https://huggingface.co#where-did-the-transpose-go-kernel-layouts-and-pre-ops)
...
##
[
](https://huggingface.co#stacking-three-linears-the-mlp)
...
###
[
](https://huggingface.co#why-are-there-two-types-of-gemm-kernels)
...
###
[
](https://huggingface.co#what-does-torchcompile-do)
...
###
[
](https://huggingface.co#the-fused-triton-kernel)
...
##
[
](https://huggingface.co#lets-use-hand-tuned-kernels)
...
###
[
](https://huggingface.co#why-use-the-kernels-library)
...
###
[
](https://huggingface.co#why-tuned-kernels-are-better)
