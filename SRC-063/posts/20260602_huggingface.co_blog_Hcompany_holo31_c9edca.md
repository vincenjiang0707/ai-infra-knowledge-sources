...
Collection Computer use - edge to cloud • 8 items • Updated • 40

#
[
](https://huggingface.co#holo31-fast--local-computer-use-agents)
Holo3.1: Fast & Local Computer Use Agents
...
#
[
](https://huggingface.co#computer-use-across-gui-environments-and-agent-harnesses)
...
##
[
](https://huggingface.co#mobile-automation)
Mobile Automation
...
##
[
](https://huggingface.co#cross-harness-performance)
...
##
[
](https://huggingface.co#smaller-sizes-for-cost-performance-tradeoffs)
...
#
[
](https://huggingface.co#fast--local-inference)
...
##
[
](https://huggingface.co#towards-local-agents-on-consumer-hardware)
...
#
[
](https://huggingface.co#availability)
Availability
...
- Holo Models API:
[https://hcompany.ai/holo-models-api](https://hcompany.ai/holo-models-api) - Hugging Face:
