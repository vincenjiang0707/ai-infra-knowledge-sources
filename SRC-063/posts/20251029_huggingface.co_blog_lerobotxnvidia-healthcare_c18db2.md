...
source: https://huggingface.co/blog/lerobotxnvidia-healthcare
...
#
[
](https://huggingface.co#building-a-healthcare-robot-from-simulation-to-deployment-with-nvidia-isaac)
Building a Healthcare Robot from Simulation to Deployment with NVIDIA Isaac

[Update on GitHub](https://github.com/huggingface/blog/blob/main/lerobotxnvidia-healthcare.md)

This article is also available in Chinese [简体中文](https://huggingface.co/blog/zh/lerobotxnvidia-healthcare).
...
[Building a Healthcare Robot from Simulation to Deployment with NVIDIA Isaac](https://huggingface.co#building-a-healthcare-robot-from-simulation-to-deployment-with-nvidia-isaac)
...
###
[
](https://huggingface.co#sim2real-mixed-training-approach)
