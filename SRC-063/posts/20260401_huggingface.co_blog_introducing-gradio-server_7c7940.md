...
** Text Behind Image** : an editor where you upload a photo, the background gets removed using an ML model, and then you place stylized text
...
compositingThe frontend talks to the backend using the [Gradio JS Client](https://www.gradio.app/guides/getting-started-with-the-js-client):
...
`@app.api()` endpoints are client-compatible |
