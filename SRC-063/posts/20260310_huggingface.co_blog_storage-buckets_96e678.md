...
#
[
](https://huggingface.co#introducing-storage-buckets-on-the-hugging-face-hub)
Introducing Storage Buckets on the Hugging Face Hub

[Update on GitHub](https://github.com/huggingface/blog/blob/main/storage-buckets.md)
...
CLI. And because they are backed by [Xet](https://huggingface.co/docs/hub/en/xet), they are especially efficient for ML artifacts that share content across files.

##
[
](https://huggingface.co#why-we-built-buckets)
...
##
[
](https://huggingface.co#why-xet-matters)
Why Xet matters
...
##
[
](https://huggingface.co#pre-warming-bringing-data-close-to-compute)
...
##
[
](https://huggingface.co#using-buckets-from-python)
Using Buckets from Python

Everything above also works from Python via [ huggingface_hub](https://github.com/huggingface/huggingface_hub) (available since

[v1.5.0](https://github.com/huggingface/huggingface_hub/releases/tag/v1.5.0)). The API follows the same pattern: create, sync, inspect.
...
##
[
](https://huggingface.co#filesystem-integration)
Filesystem integration

Buckets also work through `HfFileSystem`

, the [fsspec](https://filesystem-spec.readthedocs.io/)-compatible filesystem in `huggingface_hub`
...
##
[
](https://huggingface.co#from-buckets-to-versioned-repos)
...
##
[
](https://huggingface.co#trusted-by-launch-partners)
...
##
[
](https://huggingface.co#conclusion-and-resources)
