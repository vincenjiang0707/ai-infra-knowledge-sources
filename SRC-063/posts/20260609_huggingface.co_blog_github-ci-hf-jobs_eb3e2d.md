...
Hi [@k-l-lambda](https://huggingface.co/k-l-lambda) what error do you see when try to run more than 3 CPU Spaces? Can you share a bit more about your CI setup?
