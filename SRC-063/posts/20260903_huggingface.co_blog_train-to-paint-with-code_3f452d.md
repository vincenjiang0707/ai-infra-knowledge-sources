...
Image-Text-to-Text • Updated • 272 • 38

#
[
](https://huggingface.co#training-a-coding-model-to-paint-watercolours-with-trl-and-openenv)
Training a coding model to paint watercolours with TRL and OpenEnv
...
##
[
](https://huggingface.co#why-people-loved-it)
Why people loved it
...
##
[
](https://huggingface.co#rl-over-taste)
RL over taste
...
##
[
](https://huggingface.co#the-rl-environment-you-need-to-build)
...
##
[
](https://huggingface.co#the-pool-is-the-reward-function)
...
##
[
](https://huggingface.co#just-one-more-yolo-run)
...
##
[
](https://huggingface.co#what-it-actually-learned)
...
##
[
](https://huggingface.co#infra-is-hard)
Infra is hard
...
##
[
](https://huggingface.co#what-it-costs)
What it costs
...
##
[
](https://huggingface.co#what-i-would-try-next)
...
##
[
](https://huggingface.co#what-i-changed-from-the-original)
...
##
[
](https://huggingface.co#everything-is-published)
