...
#
[
](https://huggingface.co#adding-benchmaxxer-repellant-to-the-open-asr-leaderboard)
Adding Benchmaxxer Repellant to the Open ASR Leaderboard

[Update on GitHub](https://github.com/huggingface/blog/blob/main/open-asr-leaderboard-private-data.md)
...
##
[
](https://huggingface.co#new-high-quality-private-datasets)
...
##
[
](https://huggingface.co#how-can-i-evaluate-my-model-on-this-data)
...
##
[
](https://huggingface.co#do-models-trained-on-the-data-providers-have-an-advantage)
