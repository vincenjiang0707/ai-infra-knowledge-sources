...
source: https://huggingface.co/blog/google-cloud
published: Thu, 13 Nov 2025 00:00:00 GMT

#
[
](https://huggingface.co#building-for-an-open-future---our-new-partnership-with-google-cloud)
Building for an Open Future - our new partnership with Google Cloud

[Update on GitHub](https://github.com/huggingface/blog/blob/main/google-cloud.md)

This article is also available in Chinese [简体中文](https://huggingface.co/blog/zh/google-cloud).
...
##
[
](https://huggingface.co#a-partnership-for-google-cloud-customers)
...
##
[
](https://huggingface.co#the-gateway-to-open-models---a-fast-lane-for-google-cloud-customers)
...
##
[
](https://huggingface.co#a-partnership-for-hugging-face-customers)
