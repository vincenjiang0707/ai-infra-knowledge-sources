source: https://docs.ray.io/en/latest/serve/llm/architecture/core.html
lastmod: 
...
## Core abstractions[#](https://docs.ray.io#core-abstractions)
...
### LLMEngine protocol[#](https://docs.ray.io#llmengine-protocol)
...
#### Key methods[#](https://docs.ray.io#key-methods)
...
#### Engine implementations[#](https://docs.ray.io#engine-implementations)

Ray Serve LLM provides:

**VLLMEngine**: Implementation using vLLM.Supports continuous batching and paged attention.
...
**SGLangServer**: Community-supported integration using SGLang’s in-process engine with RadixAttention. See the[SGLang integration guide](https://docs.ray.io/user-guides/sglang.html)for details.
...
### LLMConfig[#](https://docs.ray.io#llmconfig)

`LLMConfig`

is the central configuration object that specifies everything needed to deploy an LLM. The fields below are the most important ones. For a complete field-by-field reference with defaults, see the [Configuration reference](https://docs.ray.io/user-guides/configuration.html).
...
#### Model loading configuration[#](https://docs.ray.io#model-loading-configuration)
...
#### LoRA configuration[#](https://docs.ray.io#lora-configuration)
...
### Deployment protocols[#](https://docs.ray.io#deployment-protocols)

Ray Serve LLM defines two key protocols that components must implement:

#### DeploymentProtocol[#](https://docs.ray.io#deploymentprotocol)
...
#### LLMServerProtocol[#](https://docs.ray.io#llmserverprotocol)
...
## Builder pattern[#](https://docs.ray.io#builder-pattern)
...
### Why use builders?[#](https://docs.ray.io#why-use-builders)

Builders provide two key benefits:

**Flexibility**: Different deployment configurations for the same class.**Production readiness**: You can use builders in YAML files and run`serve run config.yaml`

with the target builder module.

### Builder example[#](https://docs.ray.io#builder-example)
...
## Async constructor pattern[#](https://docs.ray.io#async-constructor-pattern)
...
### Why use async constructors?[#](https://docs.ray.io#why-use-async-constructors)

Async constructors provide several benefits:

**Engine initialization is async**: Loading models and allocating GPU memory takes time.**Failure detection**: If the engine fails to start, the replica fails immediately.**Explicit control**: Clear distinction between when the server is ready versus initializing.**Testing flexibility**:`sync_init`

allows testing without engine startup.

## Component relationships[#](https://docs.ray.io#component-relationships)
...
## Extension points[#](https://docs.ray.io#extension-points)

The core architecture provides several extension points:

### Custom engines[#](https://docs.ray.io#custom-engines)
...
### Custom server implementations[#](https://docs.ray.io#custom-server-implementations)
...
### Custom ingress[#](https://docs.ray.io#custom-ingress)
...
### Custom builders[#](https://docs.ray.io#custom-builders)
