source: https://docs.ray.io/en/latest/serve/llm/user-guides/vllm-compatibility.html
lastmod: 

# vLLM compatibility[#](https://docs.ray.io#vllm-compatibility)

Ray Serve LLM provides an OpenAI-compatible API that aligns with vLLM’s OpenAI-compatible server. Most of the `engine_kwargs`

that work with `vllm serve`

work with Ray Serve LLM, giving you access to vLLM’s feature set through Ray Serve’s distributed deployment capabilities.
...
and Ray Serve LLM with no code changes and scaleUse Ray Serve’s production features such as autoscaling, multi-model serving, and advanced routing
...
## Embeddings[#](https://docs.ray.io#embeddings)
...
### Deploy an embedding model[#](https://docs.ray.io#deploy-an-embedding-model)
...
## Transcriptions[#](https://docs.ray.io#transcriptions)
...
### Deploy a transcription model[#](https://docs.ray.io#deploy-a-transcription-model)
...
## Structured output[#](https://docs.ray.io#structured-output)
...
### JSON mode[#](https://docs.ray.io#json-mode)
...
### JSON schema with Pydantic[#](https://docs.ray.io#json-schema-with-pydantic)
...
## Vision language models[#](https://docs.ray.io#vision-language-models)
...
### Deploy a vision model[#](https://docs.ray.io#deploy-a-vision-model)
...
### Supported models[#](https://docs.ray.io#supported-models)
...
## Reasoning models[#](https://docs.ray.io#reasoning-models)
