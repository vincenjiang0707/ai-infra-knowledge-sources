source: https://docs.vllm.ai/en/latest/examples/rl/rdt_vllm_serve/
lastmod: 2026-09-23

# Rdt vLLM Serve[¶](https://docs.vllm.ai#rdt-vllm-serve)

Source [https://github.com/vllm-project/vllm/blob/main/examples/rl/rdt_vllm_serve.py](https://github.com/vllm-project/vllm/blob/main/examples/rl/rdt_vllm_serve.py).
