...
Source [https://github.com/vllm-project/vllm/blob/main/examples/ray_serving/ray_serve_deepseek.py](https://github.com/vllm-project/vllm/blob/main/examples/ray_serving/ray_serve_deepseek.py).
