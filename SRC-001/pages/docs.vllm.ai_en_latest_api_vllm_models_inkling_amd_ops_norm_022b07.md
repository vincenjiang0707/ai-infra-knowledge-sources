source: https://docs.vllm.ai/en/latest/api/vllm/models/inkling/amd/ops/norm/
lastmod: 2026-09-23

#

`vllm.models.inkling.amd.ops.norm`

[¶](https://docs.vllm.ai#vllm.models.inkling.amd.ops.norm)

Functions:

-
–[add_rmsnorm](https://docs.vllm.ai#vllm.models.inkling.amd.ops.norm.add_rmsnorm)Fused

`res = residual + delta; y = rmsnorm(res)`

. -
–[embed_dual_rmsnorm_cat](https://docs.vllm.ai#vllm.models.inkling.amd.ops.norm.embed_dual_rmsnorm_cat)The MTP depth-layer input in one launch:

-
–[embed_rmsnorm](https://docs.vllm.ai#vllm.models.inkling.amd.ops.norm.embed_rmsnorm)Fused
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.ops.norm.add_rmsnorm)
...
## Source code in `vllm/models/inkling/amd/ops/norm.py`
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.ops.norm.embed_dual_rmsnorm_cat)
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.ops.norm.embed_rmsnorm)
