...
## What data is collected?[¶](https://docs.vllm.ai#what-data-is-collected)

The list of data collected by the latest version of vLLM can be found here: [ vllm/usage/usage_lib.py](https://github.com/vllm-project/vllm/blob/main/vllm/usage/usage_lib.py)
...
## Opting out[¶](https://docs.vllm.ai#opting-out)

You can opt out of usage stats collection by setting the `VLLM_NO_USAGE_STATS`

or `DO_NOT_TRACK`

environment variable, or by creating a `~/.config/vllm/do_not_track`
