...
fuses the MLA output gating -- the gate projection, the sigmoid and the elementwise product -- into a single kernel launch, replacing the eager `attn_out * sigmoid(hidden_states @ weight.T)`
