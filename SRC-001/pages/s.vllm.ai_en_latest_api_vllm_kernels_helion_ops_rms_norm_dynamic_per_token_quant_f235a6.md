source: https://docs.vllm.ai/en/latest/api/vllm/kernels/helion/ops/rms_norm_dynamic_per_token_quant/
lastmod: 2026-09-23
...
## Source code in `vllm/kernels/helion/ops/rms_norm_dynamic_per_token_quant.py`
