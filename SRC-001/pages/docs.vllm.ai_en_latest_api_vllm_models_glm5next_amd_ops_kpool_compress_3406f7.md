source: https://docs.vllm.ai/en/latest/api/vllm/models/glm5next/amd/ops/kpool_compress/
lastmod: 2026-09-23
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress)
...
-
–[append_tail_to_topk](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.append_tail_to_topk)Append non-pooled tail tokens after expanded history tokens.

-
–[expand_pools_and_append_tail](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.expand_pools_and_append_tail)Fuse
...
(identity path). -
–[expand_pools_to_tokens](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.expand_pools_to_tokens)Expand selected full-pool ids to a strict-width token topk tensor.

-
–[history_group_budget_for_topk](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.history_group_budget_for_topk)Number of pools to select so that expanding yields

`topk`

tokens. -
–[kpool_compress_and_write_cache](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache)Compress
...
. -
–[kpool_decode_update_and_maybe_write_cache_batched](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched)Batched decode-step kpool update for spec verify (

`next_n > 1`

). -
–[kpool_seed_tail_cache](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_seed_tail_cache)Seed the paged tail cache from a prefill batch (see the kernel).
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress._kpool_decode_update_batched_kernel)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress._kpool_softmax_rotate_write_cache_kernel)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress._kpool_tail_seed_kernel)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.append_tail_to_topk)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.expand_pools_and_append_tail)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.expand_pools_to_tokens)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.history_group_budget_for_topk)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(kv_cache))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(slot_k))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(slot_score))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(ape))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(loc))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(pool_size))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(head_dim))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(write_mask))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(round_scale))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(return_compressed))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_compress_and_write_cache(write_cache))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(kv_cache))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(tail_kv_cache))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(tail_slot_mapping))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(key))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(slot_score))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(ape))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(slot_mapping))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(positions))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(pool_size))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(head_dim))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_decode_update_and_maybe_write_cache_batched(round_scale))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.kpool_compress.kpool_seed_tail_cache)
