...
Source [https://github.com/vllm-project/vllm/blob/main/examples/ray_serving/run_cluster.sh](https://github.com/vllm-project/vllm/blob/main/examples/ray_serving/run_cluster.sh).
