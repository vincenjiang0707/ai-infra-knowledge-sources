source: https://docs.vllm.ai/en/latest/api/vllm/models/deepseek_v41/common/ops/cache_utils/
lastmod: 2026-09-23
...
[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils)
...
-
–[build_flashinfer_mixed_sparse_indices](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.build_flashinfer_mixed_sparse_indices)Build the FlashInfer DSV4 sparse-index matrix for decode-first batches.

-
–[compute_global_topk_indices_and_lens](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.compute_global_topk_indices_and_lens)Map local topk indices to global KV cache slots and count valid entries.

-
–[dequantize_and_gather_k_cache](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.dequantize_and_gather_k_cache)Dequantize and gather a paged DSv4 K cache.

-
–[quantize_and_insert_k_cache](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.quantize_and_insert_k_cache)Quantize K tensor and insert into paged K cache.

-
–[quantize_and_insert_k_kernel](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.quantize_and_insert_k_kernel)Quantize K tensor and insert into paged K cache.
...
[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils._combine_topk_swa_warmup_inputs)

One warmup row per v4.1 layer type (compress ratio) in the model.

Every layer slices the shared `index_topk`

-wide indices buffer, so the padded width is the same for all rows; SWA-only layers (ratio 0) pass `TOP_K=0`
...
[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils._dequantize_and_gather_k_mxfp8_kernel)
...
[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils._dequantize_and_gather_k_nvfp4_kernel)
...
`_quantize_and_insert_k_mxfp8_kernel(k_ptr, slot_mapping_ptr, k_cache_ptr, num_tokens, head_dim, scale_dim, quant_block, cache_block_size, block_stride, fp8_max, use_fnuz=False)`

[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils._quantize_and_insert_k_mxfp8_kernel)
...
[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.build_flashinfer_mixed_sparse_indices)
...
[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.compute_global_topk_indices_and_lens)
...
[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.dequantize_and_gather_k_cache)
...
[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.quantize_and_insert_k_cache)
...
[¶](https://docs.vllm.ai#vllm.models.deepseek_v41.common.ops.cache_utils.quantize_and_insert_k_kernel)
