source: https://docs.vllm.ai/en/latest/examples/ray_serving/multi-node-serving/
lastmod: 2026-09-23

# Multi-Node-Serving[¶](https://docs.vllm.ai#multi-node-serving)

Source [https://github.com/vllm-project/vllm/blob/main/examples/ray_serving/multi-node-serving.sh](https://github.com/vllm-project/vllm/blob/main/examples/ray_serving/multi-node-serving.sh).
