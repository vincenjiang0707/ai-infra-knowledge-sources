...
**Blackwell GPU Limitation**: INT8 is not supported on compute capability >= 10.0 (e.g., RTX 6000 Blackwell). Use [FP8 quantization](https://docs.vllm.ai/fp8/) instead, or run on Hopper/Ada/Ampere architectures.
