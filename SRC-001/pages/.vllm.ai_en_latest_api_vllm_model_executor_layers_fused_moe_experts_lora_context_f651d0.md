source: https://docs.vllm.ai/en/latest/api/vllm/model_executor/layers/fused_moe/experts/lora_context/
lastmod: 2026-09-23
...
## Source code in `vllm/model_executor/layers/fused_moe/experts/lora_context.py`
