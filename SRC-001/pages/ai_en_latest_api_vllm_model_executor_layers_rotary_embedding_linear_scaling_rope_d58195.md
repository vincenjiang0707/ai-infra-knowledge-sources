source: https://docs.vllm.ai/en/latest/api/vllm/model_executor/layers/rotary_embedding/linear_scaling_rope/
lastmod: 2026-09-23
...
The offset to cache can be accessed via `scaling_factor_to_offset`
