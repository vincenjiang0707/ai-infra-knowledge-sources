source: https://docs.vllm.ai/en/latest/deployment/integrations/kuberay/
lastmod: 2026-09-23

# KubeRay[¶](https://docs.vllm.ai#kuberay)
...
## Why KubeRay instead of manual scripts?[¶](https://docs.vllm.ai#why-kuberay-instead-of-manual-scripts)
...
## Learn more[¶](https://docs.vllm.ai#learn-more)
