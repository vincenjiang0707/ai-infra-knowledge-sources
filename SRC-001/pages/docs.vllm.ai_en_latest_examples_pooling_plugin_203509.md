...
Source [https://github.com/vllm-project/vllm/tree/main/examples/pooling/plugin](https://github.com/vllm-project/vllm/tree/main/examples/pooling/plugin).

## Prithvi Geospatial MAE IO Processor[¶](https://docs.vllm.ai#prithvi-geospatial-mae-io-processor)
...
## Prithvi Geospatial MAE Offline[¶](https://docs.vllm.ai#prithvi-geospatial-mae-offline)
...
## Prithvi Geospatial MAE Online[¶](https://docs.vllm.ai#prithvi-geospatial-mae-online)
