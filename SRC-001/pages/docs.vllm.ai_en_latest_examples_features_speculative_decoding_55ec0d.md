...
Source [https://github.com/vllm-project/vllm/tree/main/examples/features/speculative_decoding](https://github.com/vllm-project/vllm/tree/main/examples/features/speculative_decoding).

## Extract Hidden States Offline[¶](https://docs.vllm.ai#extract-hidden-states-offline)
...
## MLPSpeculator Offline[¶](https://docs.vllm.ai#mlpspeculator-offline)
...
## Spec Decode Offline[¶](https://docs.vllm.ai#spec-decode-offline)
