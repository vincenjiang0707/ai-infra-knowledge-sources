source: https://docs.vllm.ai/en/latest/api/vllm/compilation/passes/utility/noop_elimination/
lastmod: 2026-09-23
...
([int](https://docs.python.org/3/builtins/functions.html#int) | [SymInt](https://pytorch.org/docs/stable/torch.html#torch.SymInt)

) – The dimension arg to reshape/slice
...
) – The corresponding dimension in the input tensor
