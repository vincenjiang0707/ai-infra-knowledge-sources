source: https://docs.vllm.ai/projects/recipes/en/stable/GLM/GLM-V.html
lastmod: 2026-04-27

# GLM-4V Usage Guide[¶](https://docs.vllm.ai#glm-4v-usage-guide)

This guide describes how to run GLM-4.5V / GLM-4.6V with native FP8. In the GLM-4.5V / GLM-4.6V series, FP8 models have minimal accuracy loss. Unless you need strict reproducibility for benchmarking or similar scenarios, we recommend using FP8 to run at a lower cost.
...
is usually good for most scenarios. Note that GLM-4.5V only supports a 64K context length, while GLM-4.6V supports a 128K context length. - You can set
...
Once the server for the `zai-org/GLM-4.5V-FP8`
...
### Results[¶](https://docs.vllm.ai#results)
