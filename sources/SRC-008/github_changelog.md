...
Please visit the official doc to start the journey: https://vllm-ascend.readthedocs.io/en/v0.7.1-dev
...
- [Docker] Add vllm-ascend [container image](https://quay.io/repository/ascend/vllm-ascend) [#64](https://github.com/vllm-project/vllm-ascend/pull/64)
...
### Core
- Torch.compile feature is supported with V1 engine now. It's disabled by default because this feature rely on CANN 8.1 release. We'll make it avaiable by default in the next release [#426](https://github.com/vllm-project/vllm-ascend/pull/426)
...
**Experimental**: Now you can enable V1 egnine by setting the environment variable `VLLM_USE_V1=1`, see the feature support status of vLLM Ascend in [here](https://vllm-ascend.readthedocs.io/en/latest/user_guide/suppoted_features.html).
...
- Improve Deepseek V3 eager mode and graph mode performance, now you can use `--additional_config={'enable_graph_mode': True}` to enable graph mode. [#598](https://github.com/vllm-project/vllm-ascend/pull/598) [#731](https://github.com/vllm-project/vllm-ascend/pull/731)
...
### Known issue
- If you are running the DeepSeek with `VLLM_USE_V1=1` enabled will encounter `call aclnnInplaceCopy failed`, Please refer [#778](https://github.com/vllm-project/vllm-ascend/issues/778) to fix.
...
This is the 2nd official release candidate of v0.9.0 for vllm-ascend. Please follow the [official doc](https://vllm-ascend.readthedocs.io/en/) to start the journey. From this release, V1 Engine is recommended to use. The code of V0 Engine is frozen and will not be maintained any more. Please set environment `VLLM_USE_V1=1` to enable V1 Engine.
...
- In some case, vLLM process may be crashed with aclgraph enabled. We're working this issue and it'll be fixed in the next release. [#1038](https://github.com/vllm-project/vllm-ascend/issues/1038)
...
## New Contributors
* @chris668899 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/771
* @NeverRaR made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/789
* @cxcxflying made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/740
* @22dimensions made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/835
* @wonderful199082 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/814
* @yangpuPKU made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/937
* @ttanzhiqiang made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/909
* @ponix-j made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/874
* @XWFAlone made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/890
* @NINGBENZHE made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/896
* @momo609 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/970
* @David9857 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/947
* @depeng1994 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1013
* @hahazhky made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/987
* @weijinqian0 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1067
* @sdmyzlp made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1091
* @zxdukki made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/941
* @ChenTaoyu-SJTU made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/736
* @Yuxiao-Xu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1116
...
## New Contributors
* @henryxuxu0716 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1214
* @shikang-hangzhou made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1291
* @pichangping made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1320
* @NNUCJ made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1434
* @JC-ut0 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1294
* @zheliuyu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1705
* @shaopeng-666 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1929
* @lilinsiman made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1940
* @raindaywhu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1943
* @wanghanqingLYT made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2003
* @lbk-sys made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2006

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.9.1rc1...v0.9.1rc2
...
## New Contributors
* @pkking made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1792
* @lianyiibo made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1811
* @nuclearwu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1867
* @aidoczh made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1870
* @shiyuan680 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1930
* @ZrBac made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1964
* @Ronald1995 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1988
* @taoxudonghaha made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1884
* @hongfugui made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1583
* @YuanCheng-coder made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2067
* @Liccol made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2127
* @1024daniel made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2037
* @yangqinghao-cmss made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2121

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.9.2rc1...v0.10.0rc1
...
- Full graph mode support are not yet available for some case with `full_cuda_graph` enable. [#2182](https://github.com/vllm-project/vllm-ascend/issues/2182)

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.9.1rc2...v0.9.1rc3
...
## New Contributors
* @lidenghui1110 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1917
* @haojiangzheng made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1772
* @QwertyJack made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2298
* @LCAIZJ made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/1568
* @liuchenbing made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2325
* @gameofdimension made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2407
* @NicholasTao made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2403
* @ZhaoJiangJiang made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2453
* @s-jiayang made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2373
* @NSDie made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2528
* @panchao-hub made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2639
* @zzy-ContiLearn made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2541
* @baxingpiaochong made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2664

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.10.0rc1...v0.10.1rc1
...
## New Contributors
* @WithHades made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2589
* @vllm-ascend-ci made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2755
* @1092626063 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2708
* @marcobarlo made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2039
* @realliujiaxu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2719
* @machenglong2025 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2805
* @FFFrog made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2815
* @anon189Ty made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2619
* @zhaozx-cn made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2787
* @wenba0 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2778
* @wuweiqiang24 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2814
* @wyu0-0 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2857
* @nwpu-zxr made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2824

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.10.1rc1...v0.10.2rc1

## v0.11.0rc0 (2025-09-29)
...
- DeepSeek V3.2 is supported now. [#3270](https://github.com/vllm-project/vllm-ascend/pull/3270) Please follow the [official guide](https://vllm-ascend.readthedocs.io/en/latest/tutorials/multi-node_dsv3.2.html) to take a try.
...
## New Contributors
* @offline893 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2956
* @1Fire4 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2869
* @jesse996 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2796
* @Lucaskabela made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2969
* @qyqc731 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2962
* @Mercykid-bash made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3042
* @MaoJianwei made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3116
* @booker123456 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3071
* @Csrayz made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2372
* @Clorist33 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3035
* @clrs97 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2931
* @zzhx1 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3027
* @mfyCn-1204 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3123
* @dragondream-chen made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3132
* @florenceCH made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3126
* @slippersss made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3153
* @socrahow made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3151

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.10.2rc1...v0.11.0rc0

## v0.11.0rc1 (2025-11-10)

This is the first release candidate of v0.11.0 for vLLM Ascend. Please follow the [official doc](https://vllm-ascend.readthedocs.io/en) to get started.
...
## New Contributors
* @huangdong2022 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3205
* @kiscad made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3226
* @dsxsteven made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3381
* @elilzhu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3426
* @yuzhup made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3203
* @DreamerLeader made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3476
* @yechao237 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3473
* @leijie-cn made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3519
* @Anionex made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3311
* @Semmer2 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4041

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.11.0rc0...v0.11.0rc1
...
**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.11.0rc1...v0.11.0rc2
...
**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.11.0rc2...v0.11.0rc3
...
* @huangdong2022 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3205
* @kiscad made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3226
* @jiangyunfan1 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3370
* @dsxsteven made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3381
* @elilzhu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3426
* @yuzhup made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3203
* @DreamerLeader made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3476
* @yechao237 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3473
* @leijie-ww made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3519
* @Anionex made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3311
* @drslark made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3549
* @KyrieDrewWang made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3490
* @HF-001 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3433
* @yzy1996 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3615
* @destinysky made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2888
* @HuaJiaHeng made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3676
* @lio1226 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3434
* @yenuo26 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3707
* @gcanlin made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3729
* @QilaiZhang made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3572
* @ck-hw-1018 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3757
* @Meihan-chen made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3861
* @Liwx1014 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3870
* @ForBetterCodeNine made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3937
* @Pz1116 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3752
* @Liziqi-77 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3690
* @herizhen made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4089
* @Apocalypse990923-qshi made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3801
* @thonean made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3756
* @845473182 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4144
* @wangxiaochao6 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4183
* @Delphine-Nic made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4209
* @InSec made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4245
* @Tjh-UKN made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4241
* @zjchenn made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4354
* @LHXuuu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4036
* @ChenxiQ made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3804
* @swy20190 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4550
* @fluctlux made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4045
* @coder-fny made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4529
* @MingYang119 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4625
* @amy-why-3459 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4176
* @h1074112368 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4707
* @GuoRen868 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4139
* @AlvisGong made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4702
* @lulina made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4526
* @zengzengran made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4687
* @shiro-zzzz made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4194
* @lhp-deep made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4626
* @wangqiankun13 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4790
* @Trunrain made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4606
* @wind-all made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4543
* @ghphotoframe made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4248
* @ChenCangtao made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4700
* @Gongdayao made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4666
* @chenjunyi-dev made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4852
* @xlan-huawei made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4899
* @hwhaokun made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4868
* @yangshihao6 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4636
* @wangyao-i made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4228

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.11.0rc0...v0.12.0rc1
...
## New Contributors
* @sunchendd made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4721

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.11.0rc3...v0.11.0
...
## New Contributors
* @ming1212 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4607
* @knight0528 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4902
* @UnifiedCacheManager made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4411
* @Toneymiller made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5053
* @JeffLee1874 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4615
* @ader47 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4953
* @YzTongNiar made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5115
* @TingW09 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5086
* @ZT-AIA made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4788
* @yuxinshan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5063
* @LICO1314 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5142
* @yuxingcyx made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4830
* @hukongyi made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4141
* @luluxiu520 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5167
* @YuhanBai made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4501
* @pisceskkk made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5183
* @OsirisDuan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4304
* @LJQ142857 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5228
* @lengrongfu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5258
* @hzxuzhonghu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4674
* @TmacAaron made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4541
* @chenaoxuan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4443
* @changdawei1 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5305
* @wjunLu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5287
* @cookieyyds made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5373
* @maoxx241 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5322
* @jiangkuaixue123 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5435

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.12.0rc1...v0.13.0rc1
...
## New Contributors
* @zhanzy178 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4587
* @jiazhengyi made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5251
* @Fager10086 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5458
* @hu-qi made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5257
* @chuyuelin made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3833
* @L4-1024 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2920
* @zhangmuzhibangde made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5415
* @frankie-ys made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5045
* @Debonex made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5516
* @wangyibo1005 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5552
* @pacoxu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5646
* @zyz111222 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5556
* @wwwumr made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5711
* @icerain-alt made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4939
* @Feng-xiaosuo made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5624
* @gh924 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5592
* @brandneway made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5848
* @ichaoren made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5827

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.13.0rc1...v0.13.0rc2
...
* @jiazhengyi made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5251
* @Fager10086 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5458
* @ZCG12345 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5271
* @hu-qi made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5257
* @chuyuelin made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/3833
* @L4-1024 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/2920
* @zhangmuzhibangde made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5415
* @frankie-ys made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5045
* @Debonex made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5516
* @starmountain1997 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5371
* @wangyibo1005 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5552
* @pacoxu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5646
* @zyz111222 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5556
* @wwwumr made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5711
...
* @Feng-xiaosuo made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5624
* @gh924 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5592
* @Rozwel-dx made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5555
* @taoyao1221 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/4467
* @Tflowers-0129 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5776
* @aipaes made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5992
* @guanguan0308 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5866
* @maxmgrdv made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5143
* @simplzyu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5668
* @Mitchell-xiyunfeng made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6216
* @huangfeifei1995 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6107

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.13.0rc1...v0.14.0rc1
...
## New Contributors
* @SkychenLee made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6457

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.11.0...v0.13.0
...
## New Contributors
* @gjc0824 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5416
* @pu-zhe made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6270
* @mengchengTang made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6141
* @Sergey-Zlobin made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6327
* @wubin58 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6310
* @huangazazaz made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6290
* @IWantFight made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6432
* @Zhang-Bryan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6274
* @acat-rw made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6469
* @GoCHug made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6581
* @luomin2005 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6681
* @yydyzr made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6642
* @nakairika made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6709
* @huyq made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6664
* @lih827 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6393
* @mikequan0425 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/5901
* @yejj710 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6593
* @Spicy-Stick made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6543
* @chenchuw886 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6686
* @LoganJane made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6755
* @Bowen-Leee made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6514
* @Li-Yongwen made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6696
* @wangbj127 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6702

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.14.0rc1...v0.15.0rc1

## v0.16.0rc1 (2026-03-10)
...
## New Contributors
* @Eric-dot made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6670
* @tanhaoan333 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6828
* @NJX-njx made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6965
* @Zhujiyang2 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6939
* @songjianquan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6740
* @liuchen2026fly made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6928
* @guleo made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6827
* @wanghengkang made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6977
* @xiaocongtou6 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6940
* @chenxi-hh made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7010
* @wanghuanjun2113 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7064
* @banxiaduhuo made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6715
* @xmpp777 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6933
* @s-zk made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6872
* @ZRJ026 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6985

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.15.0rc1...v0.16.0rc1
...
## New Contributors
* @ppppeng made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7109
* @SparrowMu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7105
* @tfhddd made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7127
* @drizzlezyk made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7208
* @chloroethylene made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6882
* @bazingazhou233-hub made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7286

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.16.0rc1...v0.17.0rc1
...
- C8(INT8 KV cache) is now supported for DeepSeek-V3.1 with PD disaggregation scenario. [#7222](https://github.com/vllm-project/vllm-ascend/pull/7222)
...
```
- There is an known issue  on the current triton-ascend, as shown in [#7782](https://github.com/vllm-project/vllm-ascend/issues/7782) Please upgrade triton-ascend to 3.2.0.dev20260322 to avoid this issue, please use the official docker images or manually install the specific triton-ascend version as following:
...
## New Contributors
* @GGGGua made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7295
* @asunxiao made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7066
* @liuhy1213-cell made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7300
* @jiangmengyu18 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7383
* @ksiyuan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7417
* @yesyue-w made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7046
* @lijiahang226 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7232
* @ZhuQi-seu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7368
* @GoMarck made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7392


**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.17.0rc1...0.18.0rc1

## v0.13.0rc3 (2026-04-24)
...
* [BugFix][v0.13.0] fix a bug that patch from PR #5786 does not take effect by @Angazenn in https://github.com/vllm-project/vllm-ascend/pull/6615
* [v0.13.0][Ops] Make triton rope support index_selecting from cos_sin_cache by @Angazenn in https://github.com/vllm-project/vllm-ascend/pull/6602
* [0.13.0][bugfix]fix profiler initialization bug with calling stack by @linfeng-yuan in https://github.com/vllm-project/vllm-ascend/pull/6714
* [0.13.0] modify release note & supported matrix by @zzzzwwjj in https://github.com/vllm-project/vllm-ascend/pull/6751
* [v0.13.0][Fusion]add checks to skip fusion where split_rmsnorm_rope is not supported by @Angazenn in https://github.com/vllm-project/vllm-ascend/pull/6749
* [DOC] add request forwarding (cherry-pick from #6780) by @starmountain1997 in https://github.com/vllm-project/vllm-ascend/pull/6788
* [Bugfix] Fix vllm-ascend 0.13.0 error: `TypeError: apply_token_bitmask_inplace_cpu(): incompatible function arguments` by @wjunLu in https://github.com/vllm-project/vllm-ascend/pull/6823
* [Bugfix] mtp forces eager mode by @zhenwenqi2024 in https://github.com/vllm-project/vllm-ascend/pull/6760
* [DOC] add layer_sharding and fix link by @starmountain1997 in https://github.com/vllm-project/vllm-ascend/pull/6808
* [v0.13.0][CI] Upgrade to CANN 8.5.1 by @wxsIcey in https://github.com/vllm-project/vllm-ascend/pull/6865
* [Bugfix] Resolve operator name collision for DeepSeekV3.2 in RL scena… by @Mind-s in https://github.com/vllm-project/vllm-ascend/pull/7034
* [doc] Added Ascend PyTorch Profiler section by @herizhen in https://github.com/vllm-project/vllm-ascend/pull/6905
* [0.13.0][cherry-pick][Bugfix][csrc] Add compile-time Ascend950/910_95 compatibility for custom ops between CANN8.5 and 9.0 by @zjchenn in https://github.com/vllm-project/vllm-ascend/pull/7116
* [0.13.0][cherry-pick][Bugfix][Triton] Centralize Ascend extension op dispatch in triton_utils by @zjchenn in https://github.com/vllm-project/vllm-ascend/pull/7112
* [Doc][Misc][v0.13.0] Updated the document configuration for DeepSeek-V3.2 by @Nagisa125 in https://github.com/vllm-project/vllm-ascend/pull/7957
* [CI] Fix Releases/v0.13.0 CI tests by @wjunLu in https://github.com/vllm-project/vllm-ascend/pull/7952
* [BugFix]Fix compilation errors for operators dispatch_gmm_combine_decode/moe_combine_normal/moe_dispatch_normal by @wangyibo1005 in https://github.com/vllm-project/vllm-ascend/pull/7840
* [v0.13.0][Feature] Add DeepSeek v4 initial support by @wangxiyuan in https://github.com/vllm-project/vllm-ascend/pull/8648

## New Contributors
* @Mind-s made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7034

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.13.0...v0.13.0rc3
...
## New Contributors
* @chenweiqiang11 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8178

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.18.0rc1...v0.18.0
...
* @liuhy1213-cell made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7300
* @ksiyuan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7417
* @idouba made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7210
* @yesyue-w made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7046
* @lijiahang226 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7232
* @ZhuQi-seu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7368
* @GoMarck made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7392
* @zhijie-os made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7631
* @YangShuai52 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7440
* @lenghuixing0330 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7636
* @PHOEBEMOON0802 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7459
* @yangsonglin13 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/6869
* @Cztk5380 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7760
* @SijieFu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7939
* @lcfenglinwan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7877
* @AyiStar made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7967
* @z00918512 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7808
* @justice-dance made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7779
* @SumrainChan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7789
* @Goalina made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8103
* @triomino made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8220
* @freyfwt made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8019
* @orangeBoxun made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8083
* @skf-1999 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8276
* @zzzzzz198 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8372
* @donpromax made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8465
* @linsheng1 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8346
* @semiba11er made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8464
* @anning-2026 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7381
* @KlyzhenkoVadim made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7374
* @lihaokun-2026 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8157
* @baoxuebin-2026 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7912
* @alex101-ops made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8709

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.17.0rc1...v0.19.1rc1
...
- KV Pool feature for DeepSeek V4 now faces several known issues affects user-friendliness and performance, including special startup parameter requirements, special key storing behaviors, etc. For details, please refer to issue [#9975](https://github.com/vllm-project/vllm-ascend/issues/9975).
...
## New Contributors
* @chen-commits made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8790
* @Lin-Qingyang-Alec made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8799
* @weixinAc made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8681
* @Maybe2191 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8706
* @ChefWu551 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8398
* @AlanisZomeg made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9018
* @ccc000-cell made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8928
* @wenjinhust made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8611
* @vvaen made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8508
* @quancs made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9049
* @ZeroFadeAway made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9218
* @mccube2000 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9298
* @yuhongming-2026 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/7886
* @lihaofei-2026 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8537
* @Tian-Fantasea made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/8968
* @panther-zhu made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9389
* @nanxingMy made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9381
* @Shelleyaaa made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9433
* @MosCloud made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9450
* @ltdo111 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9441
* @internel-error made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9616
* @ZRICHARD9527 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9201
* @xuchi-0808 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9537
* @CXY-Katrina made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9525
* @xszbuaa made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9344
* @ningjingbengxiaohai made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9692
* @vladimirevmenoff made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9264
* @Biuapha made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9765
* @jyoung6652 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9189
* @U1stRsouland made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9812
* @KaiMa-endeavour made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9663
* @ztzx3156 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9721
* @Yuli-yx made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9690
* @1-Y-C made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9601
* @yilunh998 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9893
* @zqs164 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9533
* @nomewang made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9757
* @cfq0 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9638
* @ljy19911228 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9481
* @muziyuhui666 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9972
* @Fishermanykx made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9908
* @nofushanquan made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9835
* @zouzy5137 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10004
* @SOMEONEUNSEEN made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9772
* @goodgoodname made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10032
* @baolongsun made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10266
* @evan-ai-arg made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9476
* @MINGJING-WU made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10338
* @luobicangqiong made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10248

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.19.1rc1...v0.21.0rc1
...
- Qwen3.x with PD disaggregation plus MTP could still show precision issues because former KVCache blocks may remain dirty. [#10961](https://github.com/vllm-project/vllm-ascend/issues/10961)
...
* @Shelleyaaa made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9433
* @MosCloud made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9450
* @zhao-stack made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9238
* @internel-error made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9616
* @ZRICHARD9527 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9201
* @CXY-Katrina made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9525
* @xszbuaa made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9344
...
* @KaiMa-endeavour made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9663
* @ztzx3156 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9721
* @Bybbbb11 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9382
* @1-Y-C made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9601
* @yilunh998 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9893
* @nomewang made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9757
* @cfq0 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9638
...
* @zouzy5137 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10004
* @goodgoodname made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10032
* @robellliu-dev made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9801
* @baolongsun made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10266
* @evan-ai-arg made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9476
* @luobicangqiong made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10248
* @2416602906 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10178
* @lHrHenry233 made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/10009
* @He1pa made their first contribution in https://github.com/vllm-project/vllm-ascend/pull/9830

**Full Changelog**: https://github.com/vllm-project/vllm-ascend/compare/v0.19.1rc1...v0.22.1rc1

## v0.23.0rc1 (2026-07-19)
