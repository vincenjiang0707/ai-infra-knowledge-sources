source: https://docs.mthreads.com/torchmusa/torchmusa-doc-online/YOLO_transfer
...
## 手动修改代码迁移[](https://docs.mthreads.com#手动修改代码迁移)
...
### device 设置[](https://docs.mthreads.com#device-设置)
...
### DDP 通信后端设置[](https://docs.mthreads.com#ddp-通信后端设置)
...
### 混合精度训练设置[](https://docs.mthreads.com#混合精度训练设置)
...
### 随机数种子设置[](https://docs.mthreads.com#随机数种子设置)
...
## 基于 musa_converter 工具自动迁移[](https://docs.mthreads.com#基于-musa_converter-工具自动迁移)

### musa_converter 工具介绍[](https://docs.mthreads.com#musa_converter-工具介绍)

musa_converter 是 torch_musa 开发者提供的一个可以将能够在 CUDA 平台上运行的原生 PyTorch 训练/推理脚本转化为能够在 MUSA 平台上直接运行的一键式转换工具。

用户可以在命令行执行 `musa_converter -h `
...
### 使用 musa_converter 迁移 YOLOv5[](https://docs.mthreads.com#使用-musa_converter-迁移-yolov5)

在命令行中运行 `musa-converter -r ./yolov5 -l ./yolov5/train.py`
