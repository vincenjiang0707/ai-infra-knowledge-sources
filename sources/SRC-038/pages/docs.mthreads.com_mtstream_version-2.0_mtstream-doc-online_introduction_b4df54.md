source: https://docs.mthreads.com/mtstream/version-2.0/mtstream-doc-online/introduction
...
# 4. 安装 MTStream SDK 2.0

# 从 AIModule 1.5.0 发布目录获取 mt-stream-sdk_2.0-*.deb

sudo dpkg -i mt-stream-sdk_2.0-*.deb
