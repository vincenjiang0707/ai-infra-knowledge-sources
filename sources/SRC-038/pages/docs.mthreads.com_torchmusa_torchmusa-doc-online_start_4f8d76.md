source: https://docs.mthreads.com/torchmusa/torchmusa-doc-online/start
...
## 常用环境变量[](https://docs.mthreads.com#常用环境变量)
...
## 推理示例代码[](https://docs.mthreads.com#推理示例代码)
...
## 训练示例代码[](https://docs.mthreads.com#训练示例代码)
...
## 混合精度 AMP 训练示例代码[](https://docs.mthreads.com#混合精度-amp-训练示例代码)
...
## 分布式训练示例代码[](https://docs.mthreads.com#分布式训练示例代码)
...
## 使能 TensorCore 示例代码[](https://docs.mthreads.com#使能-tensorcore-示例代码)

在 s4000 上，当输入数据类型是 flaot32 时，可以通过设置 TensorFloat32 来使能 TensorCore，从而加速计算过程。TensorFloat32 的加速原理可以参考 [TensorFloat‑32](https://pytorch.org/docs/stable/notes/cuda.html#tensorfloat%E2%80%9132%E2%80%91tf32%E2%80%91on%E2%80%91ampere%E2%80%91devices) 。
...
## C++部署示例代码[](https://docs.mthreads.com#c部署示例代码)
