source: https://docs.mthreads.com/megatron/megatron-doc-online/Llama3-8B模型训练
...
ip a|grep inet|grep -v 127.0.0.1 |grep -v inet6|awk '{print $2;}'|tr -d "addr:"|head -n1 | cut -d '/' -f1
