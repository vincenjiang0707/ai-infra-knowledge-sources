source: https://docs.nvidia.com/cuda/cuda-programming-guide/01-introduction/introduction.html

# 1.1. Introduction[#](https://docs.nvidia.com#introduction)

## 1.1.1. The Graphics Processing Unit[#](https://docs.nvidia.com#the-graphics-processing-unit)
...
## 1.1.2. The Benefits of Using GPUs[#](https://docs.nvidia.com#the-benefits-of-using-gpus)
