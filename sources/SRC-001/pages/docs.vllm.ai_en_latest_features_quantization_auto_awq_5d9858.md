...
library is deprecated. This functionality has been adopted by the vLLM project in[. For the recommended quantization workflow, please see the AWQ examples in]`llm-compressor`

[. For more details on the deprecation, refer to the original]`llm-compressor`
