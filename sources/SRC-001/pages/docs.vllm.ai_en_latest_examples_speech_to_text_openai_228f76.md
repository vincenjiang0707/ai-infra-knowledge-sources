...
Source [https://github.com/vllm-project/vllm/tree/main/examples/speech_to_text/openai](https://github.com/vllm-project/vllm/tree/main/examples/speech_to_text/openai).

## OpenAI Transcription Client[¶](https://docs.vllm.ai#openai-transcription-client)
