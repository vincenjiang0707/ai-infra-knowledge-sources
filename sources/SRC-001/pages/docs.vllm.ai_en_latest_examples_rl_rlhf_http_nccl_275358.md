source: https://docs.vllm.ai/en/latest/examples/rl/rlhf_http_nccl/
lastmod: 2026-09-24

# RLHF Http NCCL[¶](https://docs.vllm.ai#rlhf-http-nccl)

Source [https://github.com/vllm-project/vllm/blob/main/examples/rl/rlhf_http_nccl.py](https://github.com/vllm-project/vllm/blob/main/examples/rl/rlhf_http_nccl.py).
