source: https://docs.vllm.ai/en/latest/usage/faq/
lastmod: 2026-09-24
...
A: You can try [e5-mistral-7b-instruct](https://huggingface.co/intfloat/e5-mistral-7b-instruct) and [BAAI/bge-base-en-v1.5](https://huggingface.co/BAAI/bge-base-en-v1.5); more are listed [here](https://docs.vllm.ai/models/supported_models/).
...
## Mitigation Strategies[¶](https://docs.vllm.ai#mitigation-strategies)

- For improved stability and reduced variance, use
`float32`

. Note that this will require more memory. - If using
`bfloat16`

, switching to`float16`

can also help. - Using request seeds can aid in achieving more stable generation for temperature > 0, but discrepancies due to precision differences may still occur.