source: https://docs.vllm.ai/en/latest/examples/features/prompt_embed/
lastmod: 2026-09-24

# Prompt Embed[¶](https://docs.vllm.ai#prompt-embed)

Source [https://github.com/vllm-project/vllm/tree/main/examples/features/prompt_embed](https://github.com/vllm-project/vllm/tree/main/examples/features/prompt_embed).

## Prompt Embed Inference With OpenAI Client[¶](https://docs.vllm.ai#prompt-embed-inference-with-openai-client)
