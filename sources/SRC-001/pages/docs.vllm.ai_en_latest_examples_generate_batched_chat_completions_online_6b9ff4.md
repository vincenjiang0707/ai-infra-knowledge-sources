source: https://docs.vllm.ai/en/latest/examples/generate/batched_chat_completions_online/
lastmod: 2026-09-24

# Batched Chat Completions Online[¶](https://docs.vllm.ai#batched-chat-completions-online)

Source [https://github.com/vllm-project/vllm/blob/main/examples/generate/batched_chat_completions_online.py](https://github.com/vllm-project/vllm/blob/main/examples/generate/batched_chat_completions_online.py).
