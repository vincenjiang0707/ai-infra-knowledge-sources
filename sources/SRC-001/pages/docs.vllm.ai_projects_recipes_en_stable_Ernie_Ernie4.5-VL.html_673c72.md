source: https://docs.vllm.ai/projects/recipes/en/stable/Ernie/Ernie4.5-VL.html
lastmod: 2026-04-27

# Ernie4.5 VL Model Usage Guide[¶](https://docs.vllm.ai#ernie45-vl-model-usage-guide)
...
### AMD ROCm: MI300X/MI325X/MI355X[¶](https://docs.vllm.ai#amd-rocm-mi300xmi325xmi355x)
...
## Running Ernie4.5-VL[¶](https://docs.vllm.ai#running-ernie45-vl)

### Serving Ernie4.5-VL Model on H100 GPUs[¶](https://docs.vllm.ai#serving-ernie45-vl-model-on-h100-gpus)
...
For benchmarking, only the first `vllm bench serve`

after service startup to ensure it is not affected by prefix cache
