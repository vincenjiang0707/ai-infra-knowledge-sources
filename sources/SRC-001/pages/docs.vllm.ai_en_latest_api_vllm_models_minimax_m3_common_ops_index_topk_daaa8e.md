source: https://docs.vllm.ai/en/latest/api/vllm/models/minimax_m3/common/ops/index_topk/
lastmod: 2026-09-24
...
[¶](https://docs.vllm.ai#vllm.models.minimax_m3.common.ops.index_topk)
...
Index-K cache layout (vLLM): `(num_blocks, 128, idx_head_dim)`
...
-
–[minimax_m3_index_decode](https://docs.vllm.ai#vllm.models.minimax_m3.common.ops.index_topk.minimax_m3_index_decode)Decode index block-score + top-k, both split-K (cudagraph-safe).

-
–[minimax_m3_index_decode_score](https://docs.vllm.ai#vllm.models.minimax_m3.common.ops.index_topk.minimax_m3_index_decode_score)Decode index block-score (split-K, cudagraph-safe); no top-k.

-
–[minimax_m3_index_score](https://docs.vllm.ai#vllm.models.minimax_m3.common.ops.index_topk.minimax_m3_index_score)Compute per-token index scores for each visible sparse block.

-
–[minimax_m3_index_topk](https://docs.vllm.ai#vllm.models.minimax_m3.common.ops.index_topk.minimax_m3_index_topk)Select index top-k from a precomputed score tensor.
...
[¶](https://docs.vllm.ai#vllm.models.minimax_m3.common.ops.index_topk.minimax_m3_index_decode)
...
[¶](https://docs.vllm.ai#vllm.models.minimax_m3.common.ops.index_topk.minimax_m3_index_decode_score)
...
[¶](https://docs.vllm.ai#vllm.models.minimax_m3.common.ops.index_topk.minimax_m3_index_score)
...
[¶](https://docs.vllm.ai#vllm.models.minimax_m3.common.ops.index_topk.minimax_m3_index_topk)
