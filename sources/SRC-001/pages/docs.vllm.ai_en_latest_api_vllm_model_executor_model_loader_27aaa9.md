...
`_init_mm_encoder_only_weight_filter(model, model_config)`

[¶](https://docs.vllm.ai#vllm.model_executor.model_loader.DefaultModelLoader._init_mm_encoder_only_weight_filter)
