source: https://docs.vllm.ai/en/latest/examples/disaggregated/flexkv_connector/
lastmod: 2026-09-24

# Flexkv Connector[¶](https://docs.vllm.ai#flexkv-connector)

Source [https://github.com/vllm-project/vllm/tree/main/examples/disaggregated/flexkv_connector](https://github.com/vllm-project/vllm/tree/main/examples/disaggregated/flexkv_connector).

## Prefix Caching Flexkv[¶](https://docs.vllm.ai#prefix-caching-flexkv)
...
1. git clone [[email protected]](https://docs.vllm.ai/cdn-cgi/l/email-protection):taco-project/FlexKV.git
