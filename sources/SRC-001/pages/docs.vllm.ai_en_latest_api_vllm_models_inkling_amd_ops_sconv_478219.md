source: https://docs.vllm.ai/en/latest/api/vllm/models/inkling/amd/ops/sconv/
lastmod: 2026-09-24

#

`vllm.models.inkling.amd.ops.sconv`

[¶](https://docs.vllm.ai#vllm.models.inkling.amd.ops.sconv)
...
-
–[fused_sconv](https://docs.vllm.ai#vllm.models.inkling.amd.ops.sconv.fused_sconv)Single-launch insert + depthwise causal conv1d over the paged cache.

-
–[sconv_seq_metadata](https://docs.vllm.ai#vllm.models.inkling.amd.ops.sconv.sconv_seq_metadata)Fill static per-token seq_idx / query_start buffers in one launch.
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.ops.sconv.fused_sconv)
...
## Source code in `vllm/models/inkling/amd/ops/sconv.py`
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.ops.sconv.sconv_seq_metadata)
