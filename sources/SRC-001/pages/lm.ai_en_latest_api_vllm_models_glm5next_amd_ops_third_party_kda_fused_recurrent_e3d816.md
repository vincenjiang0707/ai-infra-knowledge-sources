source: https://docs.vllm.ai/en/latest/api/vllm/models/glm5next/amd/ops/third_party/kda/fused_recurrent/
lastmod: 2026-09-23

#

`vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent`

[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent)

Functions:

-
–[fused_recurrent_gated_delta_rule](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule)Args:
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule)
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(q))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(k))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(v))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(g))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(beta))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(scale))`Optional[`
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(initial_state))`Optional[`
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(inplace_final_state))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(cu_seqlens))
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(ssm_state_indices))`Optional[`
...
[¶](https://docs.vllm.ai#vllm.models.glm5next.amd.ops.third_party.kda.fused_recurrent.fused_recurrent_gated_delta_rule(num_accepted_tokens))`Optional[`
...
## Source code in `vllm/models/glm5next/amd/ops/third_party/kda/fused_recurrent.py`
