source: https://docs.vllm.ai/projects/recipes/en/stable/moonshotai/Kimi-K2-Think.html
lastmod: 2026-04-27

# Kimi-K2-Thinking Usage Guide[¶](https://docs.vllm.ai#kimi-k2-thinking-usage-guide)
...
## Launching Kimi-K2-Thinking with vLLM[¶](https://docs.vllm.ai#launching-kimi-k2-thinking-with-vllm)
...
run tensor-parallel like this: The `--reasoning-parser` flag specifies the reasoning parser to use for extracting reasoning content from the model output.## High Throughput Scenarios

vLLM supports [Decode Context Parallel](https://docs.vllm.ai/en/latest/serving/context_parallel_deployment.html#decode-context-parallel), significant benefits in high throughput scenarios. You can enable DCP by adding `--decode-context-parallel-size number`, like: The `--reasoning-parser` flag specifies the reasoning parser to use for extracting reasoning content from the model output.## Metrics[¶](https://docs.vllm.ai#metrics)

We tested the `GSM8K`

accuracy of 2 types of launch scripts (TP8 vs TP8+DCP8)
...
We used the following script to benchmark `moonshotai/Kimi-K2-Thinking`
...
### TP8+DCP8 Benchmark Output[¶](https://docs.vllm.ai#tp8dcp8-benchmark-output)
...
## DCP Gain Analysis[¶](https://docs.vllm.ai#dcp-gain-analysis)
...
- TP8
- TP8+DCP8
[(Worker_TP0 pid=666845) INFO 11-06 15:34:58 [gpu_worker.py:349] Available KV cache memory: 46.80 GiB](https://docs.vllm.ai#__codelineno-9-1)[(EngineCore_DP0 pid=666657) INFO 11-06 15:34:59 [kv_cache_utils.py:1224] Multiplying the GPU KV cache size by the dcp_world_size 8.](https://docs.vllm.ai#__codelineno-9-2)[(EngineCore_DP0 pid=666657) INFO 11-06 15:34:59 [kv_cache_utils.py:1229] GPU KV cache size: 5,721,088 tokens](https://docs.vllm.ai#__codelineno-9-3)
