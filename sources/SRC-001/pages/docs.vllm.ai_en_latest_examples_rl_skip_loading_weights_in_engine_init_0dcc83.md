...
Source [https://github.com/vllm-project/vllm/blob/main/examples/rl/skip_loading_weights_in_engine_init.py](https://github.com/vllm-project/vllm/blob/main/examples/rl/skip_loading_weights_in_engine_init.py).
