source: https://docs.vllm.ai/en/latest/api/vllm/model_executor/kernels/linear/mixed_precision/dynamic_4bit/
lastmod: 2026-09-24
...
linear
mixed_precision
vllm.model_executor.kernels.linear.mixed_precision.dynamic_4bit
¶
Back to top