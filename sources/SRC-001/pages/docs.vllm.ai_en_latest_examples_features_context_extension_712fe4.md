source: https://docs.vllm.ai/en/latest/examples/features/context_extension/
lastmod: 2026-09-24

# Context Extension[¶](https://docs.vllm.ai#context-extension)

Source [https://github.com/vllm-project/vllm/tree/main/examples/features/context_extension](https://github.com/vllm-project/vllm/tree/main/examples/features/context_extension).

## Context Extension Offline[¶](https://docs.vllm.ai#context-extension-offline)
