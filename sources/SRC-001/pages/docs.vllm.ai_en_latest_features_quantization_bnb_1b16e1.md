source: https://docs.vllm.ai/en/latest/features/quantization/bnb/
lastmod: 2026-09-24

# BitsAndBytes[¶](https://docs.vllm.ai#bitsandbytes)
...
BitsAndBytes support is provided by the out-of-tree [ vllm-bnb-plugin](https://github.com/vllm-project/vllm-bnb-plugin). Install the plugin before using BitsAndBytes with vLLM:
...
## Read quantized checkpoint[¶](https://docs.vllm.ai#read-quantized-checkpoint)
