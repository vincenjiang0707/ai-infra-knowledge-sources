source: https://docs.vllm.ai/en/latest/examples/disaggregated/mooncake_connector/
lastmod: 2026-09-23

# Mooncake Connector[¶](https://docs.vllm.ai#mooncake-connector)

Source [https://github.com/vllm-project/vllm/tree/main/examples/disaggregated/mooncake_connector](https://github.com/vllm-project/vllm/tree/main/examples/disaggregated/mooncake_connector).
