source: https://docs.vllm.ai/projects/recipes/en/stable/Llama/Llama3.3-70B.html
lastmod: 2026-04-27

# Quick Start Recipe for Llama 3.3 70B on vLLM - NVIDIA Blackwell & Hopper Hardware[¶](https://docs.vllm.ai#quick-start-recipe-for-llama-33-70b-on-vllm-nvidia-blackwell-hopper-hardware)
...
[nvidia/Llama-3.3-70B-Instruct-FP8](https://huggingface.co/nvidia/Llama-3.3-70B-Instruct-FP8) - FP4 model for Blackwell:
...
: Configuration for vLLM compilation stage. We recommend setting it to`'{"pass_config":{"fuse_allreduce_rms":true,"fuse_attn_quant":true,"eliminate_noops":true}}'`
...
The two main tunable configs for Llama 3.3 70B are the `--tensor-parallel-size`
