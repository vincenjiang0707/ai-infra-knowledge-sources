source: https://docs.vllm.ai/projects/recipes/en/stable/Jina/Jina-reranker-m0.html
lastmod: 2026-04-27

# Jina Reranker vLLM Deployment Recipe[¶](https://docs.vllm.ai#jina-reranker-vllm-deployment-recipe)
...
## Online Deployment[¶](https://docs.vllm.ai#online-deployment)
...
### 2. Rerank API[¶](https://docs.vllm.ai#2-rerank-api)
...
### 3. Score API[¶](https://docs.vllm.ai#3-score-api)

The Score API computes similarity scores between a query and multiple documents without ranking them.

#### Text-to-Text Scoring[¶](https://docs.vllm.ai#text-to-text-scoring)
...
#### Request Parameters[¶](https://docs.vllm.ai#request-parameters)

`model`

: Model identifier (required)`text_1`

: Query text (required)`text_2`

: Document(s) to score against. Can be a single string or an array of strings (required)

#### Response Format[¶](https://docs.vllm.ai#response-format_1)
...
#### Multimodal Scoring[¶](https://docs.vllm.ai#multimodal-scoring)
...
## Offline Deployment[¶](https://docs.vllm.ai#offline-deployment)
