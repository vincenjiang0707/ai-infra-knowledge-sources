source: https://docs.vllm.ai/en/latest/api/vllm/model_executor/models/llava/
lastmod: 2026-09-24
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava)

Classes:

-
–[LlavaForConditionalGeneration](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration) -
–[LlavaImageEmbeddingInputs](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaImageEmbeddingInputs)Dimensions:

-
–[LlavaImagePixelInputs](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaImagePixelInputs)Dimensions:

-
–[PixtralHFImagePixelInputs](https://docs.vllm.ai#vllm.model_executor.models.llava.PixtralHFImagePixelInputs)Dimensions:


Attributes:

-
([LlavaImageInputs](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaImageInputs)

) –[TypeAlias](https://docs.python.org/3/library/typing.html#typing.TypeAlias)Alias for supported LLaVA image input types.


##

`LlavaImageInputs = LlavaImagePixelInputs | PixtralHFImagePixelInputs | LlavaImageEmbeddingInputs`

`module-attribute`

[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaImageInputs)
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration)
...
-
–[forward](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration.forward)Run forward pass for LLaVA-1.5.

-
–[get_mm_mapping](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration.get_mm_mapping)Get the module prefix in multimodal models.
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration.forward)
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration.forward(input_ids))
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration.forward(positions))
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration.forward(intermediate_tensors))
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration.forward(inputs_embeds))
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration.forward(**kwargs))
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaForConditionalGeneration.get_mm_mapping)
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaImageEmbeddingInputs)
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.LlavaImagePixelInputs)
...
may be different per batch and image, in which case the data is passed as a list instead of a batched tensor.
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava.PixtralHFImagePixelInputs)
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava._get_num_hidden_layers)
...
[¶](https://docs.vllm.ai#vllm.model_executor.models.llava._get_num_hidden_layers(hf_config))`LlavaLikeConfig`
