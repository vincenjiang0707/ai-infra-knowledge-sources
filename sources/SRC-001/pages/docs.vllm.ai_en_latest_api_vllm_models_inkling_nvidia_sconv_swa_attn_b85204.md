source: https://docs.vllm.ai/en/latest/api/vllm/models/inkling/nvidia/sconv_swa_attn/
lastmod: 2026-09-24
...
-
[InklingConvState](#vllm.models.inkling.nvidia.sconv_swa_attn.InklingConvState)

– Per-decoder-layer owner emitting one sliding-window conv-state spec.

-
[InklingSconvBackend](#vllm.models.inkling.nvidia.sconv_swa_attn.InklingSconvBackend)
