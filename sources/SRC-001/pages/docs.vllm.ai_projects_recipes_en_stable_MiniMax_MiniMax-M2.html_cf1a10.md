source: https://docs.vllm.ai/projects/recipes/en/stable/MiniMax/MiniMax-M2.html
lastmod: 2026-04-27

# MiniMax-M2 Series Usage Guide[¶](https://docs.vllm.ai#minimax-m2-series-usage-guide)
...
## System Requirements[¶](https://docs.vllm.ai#system-requirements)
...
### Installing vLLM for AMD GPU (ROCm)[¶](https://docs.vllm.ai#installing-vllm-for-amd-gpu-rocm)
...
#### Install nightly version[¶](https://docs.vllm.ai#install-nightly-version)
...
- We also verified the accuracy of
`MiniMax-M2.7`

in commit[0f3ce4c74b1875791d6604e006b6e905fde9f698](https://github.com/vllm-project/vllm/commit/0f3ce4c74b1875791d6604e006b6e905fde9f698)on AIME25, GPQA-D, and GSM8K. You can use the following method to install this version.
...
## Launching M2 series with vLLM[¶](https://docs.vllm.ai#launching-m2-series-with-vllm)

### NVIDIA GPU[¶](https://docs.vllm.ai#nvidia-gpu)
...
Note:`fuse_minimax_qk_norm`

fusion is a feature introduced in[#PR 37045]. To use this feature, please ensure that the vllm you are using includes this PR.

### AMD GPU (ROCm)[¶](https://docs.vllm.ai#amd-gpu-rocm)
...
### DeepGEMM Usage[¶](https://docs.vllm.ai#deepgemm-usage)
