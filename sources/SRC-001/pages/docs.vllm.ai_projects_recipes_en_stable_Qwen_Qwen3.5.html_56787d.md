source: https://docs.vllm.ai/projects/recipes/en/stable/Qwen/Qwen3.5.html
lastmod: 2026-04-27

# Qwen3.5 & Qwen3.6 Usage Guide[¶](https://docs.vllm.ai#qwen35-qwen36-usage-guide)
...
[Qwen3.6-35B-A3B](https://huggingface.co/Qwen/Qwen3.6-35B-A3B)/[FP8](https://huggingface.co/Qwen/Qwen3.6-35B-A3B-FP8)[Qwen3.5](https://huggingface.co/Qwen/Qwen3.5-397B-A17B)[Qwen3.5-397B-A17B](https://huggingface.co/Qwen/Qwen3.5-397B-A17B)/[FP8](https://huggingface.co/Qwen/Qwen3.5-397B-A17B-FP8)## Installing vLLM[¶](https://docs.vllm.ai#installing-vllm)
...
## Running Qwen3.6[¶](https://docs.vllm.ai#running-qwen36)
...
## Running Qwen3.5[¶](https://docs.vllm.ai#running-qwen35)
...
### Throughput-Focused Serving[¶](https://docs.vllm.ai#throughput-focused-serving)

#### Text-Only[¶](https://docs.vllm.ai#text-only)
...
### Latency-Focused Serving[¶](https://docs.vllm.ai#latency-focused-serving)
...
### GB200 Deployment[¶](https://docs.vllm.ai#gb200-deployment)
...
### MI355X Deployment[¶](https://docs.vllm.ai#mi355x-deployment)
