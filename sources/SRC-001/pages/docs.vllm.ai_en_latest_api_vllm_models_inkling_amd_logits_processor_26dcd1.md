source: https://docs.vllm.ai/en/latest/api/vllm/models/inkling/amd/logits_processor/
lastmod: 2026-09-23
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.logits_processor)
...
-
–[InklingLogitsProcessor](https://docs.vllm.ai#vllm.models.inkling.amd.logits_processor.InklingLogitsProcessor)`LogitsProcessor`
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.logits_processor.InklingLogitsProcessor)
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.logits_processor.InklingLogitsProcessor(vocab_size))
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.logits_processor.InklingLogitsProcessor(org_vocab_size))
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.logits_processor.InklingLogitsProcessor(scale))
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.logits_processor.InklingLogitsProcessor(logits_as_input))
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.logits_processor.InklingLogitsProcessor(soft_cap))
...
[¶](https://docs.vllm.ai#vllm.models.inkling.amd.logits_processor.InklingLogitsProcessor(logits_mup_width_multiplier))
...
## Source code in `vllm/models/inkling/amd/logits_processor.py`
