source: https://docs.vllm.ai/en/latest/api/vllm/entrypoints/serve/middleware/authenticate/
lastmod: 2026-09-24
...
## Source code in `vllm/entrypoints/serve/middleware/authenticate.py`
