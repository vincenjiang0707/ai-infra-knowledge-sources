source: https://docs.vllm.ai/en/latest/examples/features/tensorize_vllm_model/
lastmod: 2026-09-24

# Tensorize vLLM Model[¶](https://docs.vllm.ai#tensorize-vllm-model)

Source [https://github.com/vllm-project/vllm/blob/main/examples/features/tensorize_vllm_model.py](https://github.com/vllm-project/vllm/blob/main/examples/features/tensorize_vllm_model.py).
