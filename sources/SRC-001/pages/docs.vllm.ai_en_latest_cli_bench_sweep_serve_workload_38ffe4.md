source: https://docs.vllm.ai/en/latest/cli/bench/sweep/serve_workload/
lastmod: 2026-09-24

# vllm bench sweep serve_workload[¶](https://docs.vllm.ai#vllm-bench-sweep-serve_workload)
...
### workload options[¶](https://docs.vllm.ai#workload-options)

`--workload-var`

[¶](https://docs.vllm.ai#-workload-var)
...
[¶](https://docs.vllm.ai#-workload-iters)

- Number of workload levels to explore. This includes the first two iterations used to interpolate the value of
`workload_var`

for remaining iterations. - Default:
`10`