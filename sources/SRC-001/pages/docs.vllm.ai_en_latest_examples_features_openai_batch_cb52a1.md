...
Source [https://github.com/vllm-project/vllm/tree/main/examples/features/openai_batch](https://github.com/vllm-project/vllm/tree/main/examples/features/openai_batch).

This is a guide to performing batch inference using the OpenAI batch file format, **not** the complete Batch (REST) API.


## File Format[¶](https://docs.vllm.ai#file-format)
...
## Pre-requisites[¶](https://docs.vllm.ai#pre-requisites)

- The examples in this document use
`meta-llama/Meta-Llama-3-8B-Instruct`

.- Create a
[user access token](https://huggingface.co/docs/hub/en/security-tokens) - Install the token on your machine (Run
`hf auth login`

). - Get access to the gated model by
[visiting the model card](https://huggingface.co/meta-llama/Meta-Llama-3-8B-Instruct)and agreeing to the terms and conditions.

- Create a

## Example 1: Running with a local file[¶](https://docs.vllm.ai#example-1-running-with-a-local-file)

### Step 1: Create your batch file[¶](https://docs.vllm.ai#step-1-create-your-batch-file)
...
For example, to run against our example input file located at `https://raw.githubusercontent.com/vllm-project/vllm/main/examples/features/openai_batch/openai_example_batch.jsonl`
...
### Additional prerequisites[¶](https://docs.vllm.ai#additional-prerequisites)

[Create an S3 bucket](https://docs.aws.amazon.com/AmazonS3/latest/userguide/creating-bucket.html).- The
`awscli`

package (Run`pip install awscli`

) to configure your credentials and interactively use s3. - The
`boto3`
...
### Step 1: Upload your input script[¶](https://docs.vllm.ai#step-1-upload-your-input-script)
...
### Step 2: Generate your presigned urls[¶](https://docs.vllm.ai#step-2-generate-your-presigned-urls)

Presigned urls can only be generated via the SDK. You can run the following python script to generate your presigned urls. Be sure to replace the `MY_BUCKET`
...
## Example 4: Using embeddings endpoint[¶](https://docs.vllm.ai#example-4-using-embeddings-endpoint)

### Additional prerequisites[¶](https://docs.vllm.ai#additional-prerequisites_1)
...
### Step 1: Create your batch file[¶](https://docs.vllm.ai#step-1-create-your-batch-file_1)
...
### Step 2: Run the batch[¶](https://docs.vllm.ai#step-2-run-the-batch_1)

You can run the batch using the same command as in earlier examples.

### Step 3: Check your results[¶](https://docs.vllm.ai#step-3-check-your-results_1)
...
## Example 5: Using score endpoint[¶](https://docs.vllm.ai#example-5-using-score-endpoint)

### Additional prerequisites[¶](https://docs.vllm.ai#additional-prerequisites_2)
...
### Step 1: Create your batch file[¶](https://docs.vllm.ai#step-1-create-your-batch-file_2)
...
### Step 2: Run the batch[¶](https://docs.vllm.ai#step-2-run-the-batch_2)

You can run the batch using the same command as in earlier examples.

### Step 3: Check your results[¶](https://docs.vllm.ai#step-3-check-your-results_2)
