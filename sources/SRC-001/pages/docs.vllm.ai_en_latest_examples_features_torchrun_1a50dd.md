source: https://docs.vllm.ai/en/latest/examples/features/torchrun/
lastmod: 2026-09-24

# Torchrun[¶](https://docs.vllm.ai#torchrun)
...
## Torchrun Dp Example Offline[¶](https://docs.vllm.ai#torchrun-dp-example-offline)
...
## Torchrun Example Offline[¶](https://docs.vllm.ai#torchrun-example-offline)
