...
Source [https://github.com/vllm-project/vllm/blob/main/examples/ray_serving/batch_llm_inference.py](https://github.com/vllm-project/vllm/blob/main/examples/ray_serving/batch_llm_inference.py).
