...
[here](https://lws.sigs.k8s.io/docs/installation/).

## Deploy and Serve[¶](https://docs.vllm.ai#deploy-and-serve)

Deploy the following yaml file `lws.yaml`

(we have examples that use multiprocessing or Ray):
...
## Access ClusterIP service[¶](https://docs.vllm.ai#access-clusterip-service)
...
## Serve the model[¶](https://docs.vllm.ai#serve-the-model)
