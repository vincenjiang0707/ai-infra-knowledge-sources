...
state: open | updated: 2026-09-25T11:52:41Z
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| B200 (sm_100a) | 26 | 26/26 | 0.999518x | 1.087976x | 1.253235x | 259.003 | 258.878 | 281.789 |
| B300 (sm_103a) | 26 | 26/26 | 0.998850x | 1.085203x | 1.230394x | 257.062 | 256.766 | 278.964 |
| uniform routing | 26 | 26/26 | 0.998882x | 1.072383x | 1.197458x | 284.240 | 283.923 | 304.815 |
| skewed routing | 26 | 26/26 | 0.999485x | 1.100983x | 1.287705x | 234.238 | 234.117 | 257.892 |
| all rows | 52 | 52/52 | 0.999184x | 1.086589x | 1.241762x | 258.031 | 257.820 | 280.373 |

## Round 2: mid-shape FC2 tuning (two host files changed; generated sources unchanged)

Scope of the change relative to the currently published head:
- sm_100a (B200), M in {32, 64, 128} uniform and skewed routing: the route table now selects the already-shipped FC2 program variant with the direct-store + warp-arrive epilogue instead of the previous FC2 variant (one entry in the JIT route table; every generated source file is byte-identical to the current head).
- sm_103a (B300), M in {32, 64, 128, 256}: FC2 CTA pool of 6 selected on the host (two lines in the runtime module; no kernel source change). The measured tree also carries a source-arm harness fix for M = 256 that does not touch the exported files.

Method unchanged from the published measurements: frozen full-call boundary, symmetric external CUDA graphs, CUPTI cold-L2 GPU time, FlashInfer baseline at the same fixed commit with fresh autotune, five arms per row (source | export | FlashInfer | previously published export | pre-change realization), compute-sanitizer synccheck/racecheck (+ memcheck where stores changed), independent CPU-only audit of the raw timing evidence.

### B200 (sm_100a) mid rows, all accepted, no flags

| row | export us | source/export | FlashInfer/export | published-export/export | pre-change/export |
|---|---|---|---|---|---|
| M32 uniform | 206.689 | 1.0000 | 1.0175 | 1.1174 | 1.0087 |
| M32 skew | 90.368 | 1.0018 | 1.0605 | 1.4766 | 1.0046 |
| M64 uniform | 332.992 | 1.0001 | 1.0225 | 1.1047 | 1.0101 |
| M64 skew | 145.439 | 1.0000 | 1.0614 | 1.4746 | 1.0070 |
| M128 uniform | 336.800 | 0.9994 | 1.0279 | 1.1409 | 1.0080 |
| M128 skew | 231.264 | 1.0001 | 1.0372 | 1.3567 | 1.0053 |

### B300 (sm_103a) mid rows

| row | export us | source/export | FlashInfer/export | published-export/export | pre-change/export | note |
|---|---|---|---|---|---|---|
| M32 uniform | 209.186 | 1.000 | 1.022 | 1.119 | 1.009 | |
| M32 skew | 91.137 | 0.999 | 1.068 | 1.487 | 0.999 | pool 6 neutral at this shape (0.1 us behind pre-change, within noise); accepted, reported |
| M64 uniform | 341.221 | 0.999 | 1.021 | 1.105 | 1.009 | |
| M64 skew | 147.617 | 0.999 | 1.066 | 1.468 | 1.003 | |
| M128 uniform | 344.677 | 0.999 | 1.020 | 1.130 | 1.009 | |
| M128 skew | 236.226 | 0.999 | 1.032 | 1.337 | 1.006 | |

### B300 (sm_103a) M256 pair (host fix)

| row | export us | source/export | FlashInfer/export | published-export/export | pre-change/export |
|---|---|---|---|---|---|
| M256 uniform | 350.787 | 1.000 | 1.023 | 1.169 | 1.007 |
| M256 skew | 372.547 | 1.000 | 1.017 | 1.187 | 1.009 |

All remaining 38 rows are byte-identical to the published head and keep their published measurements; no historical substitution is used for any changed row.
...
| sm_100a_m00032_uniform | B200 | 206.689 | 206.689 | 210.304 | 1.017490x | 1.000000x | 1.121530x | 652.4 | 3.752 / 3.752 / 3.817 |
| sm_100a_m00032_skew | B200 | 90.368 | 90.528 | 95.839 | 1.060541x | 1.001771x | 1.517705x | 978.6 | 3.737 / 3.732 / 3.957 |
| sm_100a_m00064_uniform | B200 | 332.992 | 333.024 | 340.479 | 1.022484x | 1.000096x | 1.119742x | 551.0 | 3.752 / 3.752 / 3.835 |
| sm_100a_m00064_skew | B200 | 145.439 | 145.440 | 154.367 | 1.061387x | 1.000007x | 1.479438x | 797.2 | 3.742 / 3.742 / 3.971 |
| sm_100a_m00128_uniform | B200 | 336.800 | 336.607 | 346.207 | 1.027931x | 0.999427x | 1.145748x | 559.1 | 3.760 / 3.762 / 3.866 |
| sm_100a_m00128_skew | B200 | 231.264 | 231.295 | 239.871 | 1.037217x | 1.000134x | 1.371939x | 628.2 | 3.747 / 3.748 / 3.885 |
...
| sm_103a_m00032_uniform | B300 | 209.186 | 209.251 | 213.699 | 1.021574x | 1.000311x | 1.115194x | 564.3 | 3.755 / 3.754 / 3.835 |
| sm_103a_m00032_skew | B300 | 91.137 | 91.041 | 97.313 | 1.067766x | 0.998947x | 1.465234x | 917.2 | 3.749 / 3.753 / 4.007 |
| sm_103a_m00064_uniform | B300 | 341.221 | 341.028 | 348.229 | 1.020538x | 0.999434x | 1.092562x | 514.3 | 3.753 / 3.755 / 3.832 |
| sm_103a_m00064_skew | B300 | 147.617 | 147.457 | 157.377 | 1.066117x | 0.998916x | 1.443099x | 735.2 | 3.752 / 3.756 / 4.005 |
| sm_103a_m00128_uniform | B300 | 344.677 | 344.421 | 351.654 | 1.020242x | 0.999257x | 1.117162x | 460.4 | 3.756 / 3.759 / 3.836 |
| sm_103a_m00128_skew | B300 | 236.226 | 236.034 | 243.746 | 1.031834x | 0.999187x | 1.327830x | 586.6 | 3.751 / 3.754 / 3.874 |
| sm_103a_m00256_uniform | B300 | 350.787 | 350.723 | 358.948 | 1.023265x | 0.999818x | 1.161198x | 505.8 | 3.754 / 3.754 / 3.842 |
| sm_103a_m00256_skew | B300 | 372.547 | 372.419 | 378.915 | 1.017093x | 0.999656x | 1.178753x | 510.1 | 3.752 / 3.753 / 3.818 |
...
|---|---:|---:|---:|---:|---:|---:|
| B200 (sm_100a) | 26 | 18898.139 | 98.588 | 98.650 | 108.303 | 123.877 |
| B300 (sm_103a) | 26 | 18633.997 | 97.587 | 97.702 | 106.949 | 118.789 |
| all rows | 52 | 37532.137 | 196.174 | 196.352 | 215.252 | 242.666 |
...
| B200 M32/M64/M128 (uniform+skew) | B200 | 6 | 4166.509 | 1875.230 | 22.490 | 22.488 | 23.332 | 28.754 |
...
| B300 M32/M64/M128 (uniform+skew) | B300 | 6 | 3778.025 | 1953.977 | 22.516 | 22.531 | 23.389 | 28.734 |
| B300 M256 (uniform+skew) | B300 | 2 | 1015.841 | 359.493 | 7.506 | 7.508 | 7.660 | 8.857 |
...
| B300 | 2,780 | 5,850,306,560 | 7,565,258,880 | 88 | 3,330 | 160 | 74 |
| Combined | 6,350 | 12,256,620,544 | 15,844,942,080 | 208 | 7,650 | 390 | 170 |
...
- `NVIDIA B200`: 12 device UUID(s): `1a7f9ffc-bf1e-ff95-60d8-c49720b8707a`, `29653327-a4f7-908e-5dea-c561db58021f`, `3e497cd5-3562-540d-4379-26d918d35c5a`, `47212bdc-0600-61cd-e362-267db412ef15`, `477dd790-fa89-2f0c-cace-b7329b309237`, `6be3be98-1386-fc1a-2d2f-97b841cd74fc`, `72185052-b15f-1cd5-e0e9-f561d04bb990`, `72b2017a-9091-1857-fbdf-22cc6b547fa4`, `7724dc25-bbe5-1707-265a-4725655dda83`, `a09eb925-75a0-13b5-aff1-bd9eafe5f336`, `a273c7b7-081d-9217-e3f4-8328bed281de`, `c915a50d-1eb3-a004-ae41-d839b2c622e3`
- `NVIDIA B300 SXM6 AC`: 14 device UUID(s): `02129573-8b9e-337d-00ea-a62571508c98`, `1f676c6c-d48a-b37e-27b0-132aab03cf03`, `5b85dedd-e9f9-8e1c-7638-1bfd49589409`, `75e5e6e6-0a83-22b1-7fd4-5a8164a4a8a7`, `88325615-43a6-02ab-76c1-324dbc560167`, `88fd91da-b105-72e8-a448-24b5280d4385`, `9cde7a68-49e4-4e65-e473-bace41ea98b0`, `a7b2e150-1f32-a01c-6b77-3195e8dbda55`, `b48ea308-719c-c275-bfed-a44c110d9884`, `c83925bb-ed5f-611a-f17e-3ce5e1685f23`, `da741ac6-e0f7-6347-3e9c-2d86e37ab091`, `e0556da5-5afb-f13f-b3da-96d1b70ede0a`, `e29dabc5-633e-bb2c-f58c-bbf4505c81f4`, `ee6e0743-9622-5e8c-48e6-f2f650d36147`
...
|         Title check        | ✅ Passed | The title clearly identifies the Cake fused-MoE backend and the Kimi-K3 NVFP4 SiTU support for SM100 and SM103.                                                                                           |
|      Description check     | ✅ Passed | The description thoroughly explains the implementation, public API, tests, benchmarks, hardware, and related issues. It does not reproduce the template headings or pre-commit checklist, but the requir… |
...
[View the full check run](https://github.com/flashinfer-ai/flashinfer/actions/runs/36131582124)
...
GitLab MR [!1682](https://nv/flashinfer/-/merge_requests/1682) has been updated with latest changes, and the CI pipeline [#69791953](https://nv/flashinfer-ci/-/pipelines/69791953) is currently running. I'll report back once the pipeline job completes.
