# [PR #79748] [Operator Mechanism] Consolidate strided view validation and gradient fixes

source: https://github.com/PaddlePaddle/Paddle/pull/79748
state: closed | updated: 2026-09-15T03:02:00Z
labels: 
...
### codecov-commenter · 2026-09-08

## [Codecov](https://app.codecov.io/gh/PaddlePaddle/Paddle/pull/79748?dropdown=coverage&src=pr&el=h1&utm_medium=referral&utm_source=github&utm_content=comment&utm_campaign=pr+comments&utm_term=PaddlePaddle) Report
:x: Patch coverage is `90.40590%` with `26 lines` in your changes missing coverage. Please review.
:warning: Please [upload](https://docs.codecov.com/docs/codecov-uploader) report for BASE (`develop@0489926`). [Learn more](https://docs.codecov.io/docs/error-reference?utm_medium=referral&utm_source=github&utm_content=comment&utm_campaign=pr+comments&utm_term=PaddlePaddle#section-missing-base-commit) about missing BASE report.

| [Files with missing lines](https://app.codecov.io/gh/PaddlePaddle/Paddle/pull/79748?dropdown=coverage&src=pr&el=tree&utm_medium=referral&utm_source=github&utm_content=comment&utm_campaign=pr+comments&utm_term=PaddlePaddle) | Patch % | Lines |
|---|---|---|
| [paddle/phi/kernels/funcs/strided\_utils.h](https://app.codecov.io/gh/PaddlePaddle/Paddle/pull/79748?src=pr&el=tree&filepath=paddle%2Fphi%2Fkernels%2Ffuncs%2Fstrided_utils.h&utm_medium=referral&utm_source=github&utm_content=comment&utm_campaign=pr+comments&utm_term=PaddlePaddle#diff-cGFkZGxlL3BoaS9rZXJuZWxzL2Z1bmNzL3N0cmlkZWRfdXRpbHMuaA==) | 88.88% | [25 Missing :warning: ](https://app.codecov.io/gh/PaddlePaddle/Paddle/pull/79748?src=pr&el=tree&utm_medium=referral&utm_source=github&utm_content=comment&utm_campaign=pr+comments&utm_term=PaddlePaddle) |
| [paddle/fluid/eager/nan\_inf\_utils.cc](https://app.codecov.io/gh/PaddlePaddle/Paddle/pull/79748?src=pr&el=tree&filepath=paddle%2Ffluid%2Feager%2Fnan_inf_utils.cc&utm_medium=referral&utm_source=github&utm_content=comment&utm_campaign=pr+comments&utm_term=PaddlePaddle#diff-cGFkZGxlL2ZsdWlkL2VhZ2VyL25hbl9pbmZfdXRpbHMuY2M=) | 75.00% | [1 Missing :warning: ](https://app.codecov.io/gh/PaddlePaddle/Paddle/pull/79748?src=pr&el=tree&utm_medium=referral&utm_source=github&utm_content=comment&utm_campaign=pr+comments&utm_term=PaddlePaddle) |
...
[:umbrella: View full report in Codecov by Harness](https://app.codecov.io/gh/PaddlePaddle/Paddle/pull/79748?dropdown=coverage&src=pr&el=continue&utm_medium=referral&utm_source=github&utm_content=comment&utm_campaign=pr+comments&utm_term=PaddlePaddle).   
