source: https://github.com/open-source/sponsors?locale=ja
...
[Comprehensive website security and health monitoring with performance analysis](https://github.com/sponsors/Lissy93?locale=ja)
...
[Intuitive, open-source interface for native GenAI applications](https://github.com/sponsors/tjbck?locale=ja)
...
[A command line tool and library for transferring data with URL syntax](https://github.com/sponsors/curl?locale=ja)
...
Sign in and start by navigating to [your dependencies](https://github.com/sponsors/explore?locale=ja), your [explore tab](https://github.com/explore?locale=ja), [trending repositories](https://github.com/explore?locale=ja), or [collections](https://github.com/collections?locale=ja). When a repository has the Sponsor graphic, you can sponsor them directly.
