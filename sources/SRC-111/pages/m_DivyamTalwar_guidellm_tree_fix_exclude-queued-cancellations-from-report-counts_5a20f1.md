source: https://github.com/DivyamTalwar/guidellm/tree/fix/exclude-queued-cancellations-from-report-counts
...
using `--output yaml "path=benchmarks.yaml"`
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/DivyamTalwar/guidellm/blob/fix/exclude-queued-cancellations-from-report-counts/docs/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
