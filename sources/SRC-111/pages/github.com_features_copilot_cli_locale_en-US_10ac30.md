source: https://github.com/features/copilot/cli?locale=en-US

Built on GitHub’s native `/mcp`

integration, Copilot can search issues, analyze labels and activity, and summarize scope so you can move from backlog to implementation without context hunting.

# Less // TODO: more done

Run a GitHub-native agent in your terminal that works directly with your issues and pull requests, executes across a `/fleet`

of parallelized subagents, and carries you from `/plan`

to merged code.

[Read the documentation.](https://docs.github.com/en/copilot/how-tos/copilot-cli/cli-best-practices)Included in Copilot Free, Pro, Pro+, Max, Business, and Enterprise subscriptions.

[Get Copilot CLI](https://github.com/github/copilot-cli)

[Read the documentation.](https://docs.github.com/en/copilot/how-tos/copilot-cli/cli-best-practices) Available with Copilot Free, Pro, Pro+, Max, Business, and Enterprise.
...
Start in the CLI with a `/plan`

, then open the work in VS Code to refine code directly.
...
### Work with your issues via native GitHub `/mcp`

support

`/plan`

with a team of agents. Execute with autopilot.

Shift+Tab into plan mode to outline the work, use `/model`

to compare approaches, and then Shift+Tab into autopilot mode when you want Copilot to carry the task forward without step-by-step approval.

### Shape behavior with `/agent`
...
[Read the documentation](https://docs.github.com/copilot/how-tos/copilot-cli/cli-best-practices)

## Resources on GitHub Copilot CLI

[GitHub CLI documentation](https://docs.github.com/copilot/concepts/agents/about-copilot-cli)

Learn how to set up Copilot CLI and use the terminal for your agentic workflows.

[GitHub MCP Registry](https://github.com/mcp?locale=en-US)

Discover an ecosystem of partner and community-driven MCP servers to connect to Copilot CLI.

[Build an app with Copilot CLI](https://github.com/skills/create-applications-with-the-copilot-cli?locale=en-US)
...
Copilot CLI access is included as part of your Copilot subscription. Each interaction with the agent draws on your respective plan’s AI Credits allowance. For additional information on billing, please refer to our documentation.
...
Yes, you can interact with Copilot CLI in the VS Code integrated terminal and in the VS Code chat panel. Please see [our docs page](https://code.visualstudio.com/docs/copilot/agents/background-agents) for more information.
