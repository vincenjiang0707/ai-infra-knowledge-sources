source: https://github.com/open-source/sponsors?locale=fr-fr
...
[Comprehensive website security and health monitoring with performance analysis](https://github.com/sponsors/Lissy93?locale=fr-FR)
...
[Intuitive, open-source interface for native GenAI applications](https://github.com/sponsors/tjbck?locale=fr-FR)
...
[A command line tool and library for transferring data with URL syntax](https://github.com/sponsors/curl?locale=fr-FR)
...
Sign in and start by navigating to [your dependencies](https://github.com/sponsors/explore?locale=fr-FR), your [explore tab](https://github.com/explore?locale=fr-FR), [trending repositories](https://github.com/explore?locale=fr-FR), or [collections](https://github.com/collections?locale=fr-FR). When a repository has the Sponsor graphic, you can sponsor them directly.
