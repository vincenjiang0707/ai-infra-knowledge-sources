source: https://github.com/DivyamTalwar/guidellm/tree/fix/metrics-ignore-missing-values
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/DivyamTalwar/guidellm/blob/fix/metrics-ignore-missing-values/docs/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
