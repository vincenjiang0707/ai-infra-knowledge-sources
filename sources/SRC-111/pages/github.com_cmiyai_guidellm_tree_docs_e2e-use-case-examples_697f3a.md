source: https://github.com/cmiyai/guidellm/tree/docs/e2e-use-case-examples
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/cmiyai/guidellm/blob/docs/e2e-use-case-examples/docs/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
