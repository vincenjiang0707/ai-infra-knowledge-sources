source: https://github.com/vllm-project/guidellm/discussions/203

# test with ollama backend failed. #203

[Answered](https://github.com#discussioncomment-13587987)by

[sjmonson](https://github.com/sjmonson)

[alexhegit](https://github.com/alexhegit)asked this question in
...
must match the name of the model on HuggingFace. If it does not you must pass`--processor`

as either the HuggingFace name or path to the model on disk (e.g.`--processor Qwen/Qwen3-4B`
