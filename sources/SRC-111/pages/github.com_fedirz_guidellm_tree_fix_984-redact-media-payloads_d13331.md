source: https://github.com/fedirz/guidellm/tree/fix/984-redact-media-payloads
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/fedirz/guidellm/blob/fix/984-redact-media-payloads/docs/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
