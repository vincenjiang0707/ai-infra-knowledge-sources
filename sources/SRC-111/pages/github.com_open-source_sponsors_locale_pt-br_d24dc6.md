source: https://github.com/open-source/sponsors?locale=pt-br
...
[Comprehensive website security and health monitoring with performance analysis](https://github.com/sponsors/Lissy93?locale=pt-BR)
...
[Intuitive, open-source interface for native GenAI applications](https://github.com/sponsors/tjbck?locale=pt-BR)
...
[A command line tool and library for transferring data with URL syntax](https://github.com/sponsors/curl?locale=pt-BR)
...
Sign in and start by navigating to [your dependencies](https://github.com/sponsors/explore?locale=pt-BR), your [explore tab](https://github.com/explore?locale=pt-BR), [trending repositories](https://github.com/explore?locale=pt-BR), or [collections](https://github.com/collections?locale=pt-BR). When a repository has the Sponsor graphic, you can sponsor them directly.
