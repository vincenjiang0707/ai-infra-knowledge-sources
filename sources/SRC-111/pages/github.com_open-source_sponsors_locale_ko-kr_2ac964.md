source: https://github.com/open-source/sponsors?locale=ko-kr
...
[Comprehensive website security and health monitoring with performance analysis](https://github.com/sponsors/Lissy93?locale=ko-KR)
...
[Intuitive, open-source interface for native GenAI applications](https://github.com/sponsors/tjbck?locale=ko-KR)
...
[A command line tool and library for transferring data with URL syntax](https://github.com/sponsors/curl?locale=ko-KR)
...
Sign in and start by navigating to [your dependencies](https://github.com/sponsors/explore?locale=ko-KR), your [explore tab](https://github.com/explore?locale=ko-KR), [trending repositories](https://github.com/explore?locale=ko-KR), or [collections](https://github.com/collections?locale=ko-KR). When a repository has the Sponsor graphic, you can sponsor them directly.
