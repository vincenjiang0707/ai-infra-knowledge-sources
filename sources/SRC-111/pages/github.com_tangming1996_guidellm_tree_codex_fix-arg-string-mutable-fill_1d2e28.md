source: https://github.com/tangming1996/guidellm/tree/codex/fix-arg-string-mutable-fill
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/tangming1996/guidellm/blob/codex/fix-arg-string-mutable-fill/docs/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
