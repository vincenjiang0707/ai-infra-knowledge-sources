source: https://github.com/open-source/sponsors?locale=de-de
...
[Comprehensive website security and health monitoring with performance analysis](https://github.com/sponsors/Lissy93?locale=de-DE)
...
[Intuitive, open-source interface for native GenAI applications](https://github.com/sponsors/tjbck?locale=de-DE)
...
[A command line tool and library for transferring data with URL syntax](https://github.com/sponsors/curl?locale=de-DE)
...
Sign in and start by navigating to [your dependencies](https://github.com/sponsors/explore?locale=de-DE), your [explore tab](https://github.com/explore?locale=de-DE), [trending repositories](https://github.com/explore?locale=de-DE), or [collections](https://github.com/collections?locale=de-DE). When a repository has the Sponsor graphic, you can sponsor them directly.
