source: https://github.com/RheagalFire/guidellm/tree/feat/add-litellm-provider
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/RheagalFire/guidellm/blob/feat/add-litellm-provider/docs/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
