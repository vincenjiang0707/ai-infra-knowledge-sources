source: https://github.com/DivyamTalwar/guidellm/tree/fix/accumulator-reservoir-retention
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/DivyamTalwar/guidellm/blob/fix/accumulator-reservoir-retention/docs/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
