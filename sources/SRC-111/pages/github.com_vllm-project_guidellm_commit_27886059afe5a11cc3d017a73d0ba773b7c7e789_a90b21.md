source: https://github.com/vllm-project/guidellm/commit/27886059afe5a11cc3d017a73d0ba773b7c7e789
...
| `7` | `+` |
| `8` | `+`from guidellm.data.generators.multi_image import generate_synthetic_images |
| `9` | `+`from guidellm.data.schemas import MultiImageDatasetConfig |
| `10` | `+` |
