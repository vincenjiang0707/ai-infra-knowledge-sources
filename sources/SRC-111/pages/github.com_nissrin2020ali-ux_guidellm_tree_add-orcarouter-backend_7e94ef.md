source: https://github.com/nissrin2020ali-ux/guidellm/tree/add-orcarouter-backend
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/nissrin2020ali-ux/guidellm/blob/add-orcarouter-backend/docs/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
