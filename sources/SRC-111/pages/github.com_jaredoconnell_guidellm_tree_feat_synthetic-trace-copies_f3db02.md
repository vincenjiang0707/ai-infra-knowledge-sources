source: https://github.com/jaredoconnell/guidellm/tree/feat/synthetic-trace-copies
...
replaces the default JSON and CSV outputs. See [output configuration](https://github.com/jaredoconnell/guidellm/blob/feat/synthetic-trace-copies/docs/en/guides/outputs.md#cli-output-configuration) for examples of selecting formats, including generating HTML alongside JSON and CSV.

Use JSON or YAML for detailed analysis, CSV for spreadsheet comparisons, HTML for self-contained visual reports, and PLOT for static performance graphs. See [supported file formats](https://github.com/jaredoconnell/guidellm/blob/feat/synthetic-trace-copies/docs/en/guides/outputs.md#supported-file-formats) for their contents and default filenames, and [configuring file outputs](https://github.com/jaredoconnell/guidellm/blob/feat/synthetic-trace-copies/docs/en/guides/outputs.md#configuring-file-outputs) to choose output paths.

The console provides a summary of each benchmark. Its tables can be copied into spreadsheet software using `|`

as the delimiter. See [console output](https://github.com/jaredoconnell/guidellm/blob/feat/synthetic-trace-copies/docs/en/guides/outputs.md#console-output) for progress and display controls.
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/jaredoconnell/guidellm/blob/feat/synthetic-trace-copies/docs/en/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
