source: https://github.com/git-jxj/guidellm/tree/fix/empty-data-worker
...
for multimodal prompts. See [Synthetic Visual Data](https://github.com/git-jxj/guidellm/blob/fix/empty-data-worker/docs/guides/multimodal/synthetic_vision.md) for example commands and the full list of configuration options.
