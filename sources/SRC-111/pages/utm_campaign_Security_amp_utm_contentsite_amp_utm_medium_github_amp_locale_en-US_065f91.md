source: https://github.com/security/plans?ref_cta=pricing&amp;ref_loc=footer&amp;ref_page=%2Fsolutions_usecase_devsecops&amp;scid=adv-security&amp;utm_campaign=Security&amp;utm_contentsite=&amp;utm_medium=github&amp;locale=en-US

# The perfect pair for complete protection

## GitHub Secret Protection

For teams and organizations serious about stopping secret leaks.[Get started now](https://github.com/get_started?with=secret-protection&locale=en-US)

## GitHub Code Security

For teams and organizations committed to fixing vulnerabilities before production.[Get started now](https://github.com/get_started?with=code-security&locale=en-US)
...
FreeNot includedTeamNot includedEnterpriseNot includedGet a clear view of your project’s dependencies with a summary of manifest, lock files, and submitted dependencies via the API.
