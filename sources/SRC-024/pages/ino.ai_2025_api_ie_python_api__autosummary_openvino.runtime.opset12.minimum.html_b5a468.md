source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset12.minimum.html
lastmod: 

# openvino.runtime.opset12.minimum[#](https://docs.openvino.ai#openvino-runtime-opset12-minimum)

-
openvino.runtime.opset12.minimum(
*left_node:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*right_node:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*auto_broadcast: str = 'NUMPY'*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset12.minimum) Return node which applies the minimum operation to input nodes elementwise.
