source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset1.detection_output.html
lastmod: 

# openvino.runtime.opset1.detection_output[#](https://docs.openvino.ai#openvino-runtime-opset1-detection-output)

-
openvino.runtime.opset1.detection_output(
*box_logits:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)*class_preds:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)*proposals:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)*attrs: dict*,*aux_class_preds:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray = None*aux_box_preds:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray = None*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset1.detection_output) Generate the detection output using information on location and confidence predictions.
