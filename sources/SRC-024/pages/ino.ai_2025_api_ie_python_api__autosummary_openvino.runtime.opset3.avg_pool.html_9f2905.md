source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset3.avg_pool.html
lastmod: 

# openvino.runtime.opset3.avg_pool[#](https://docs.openvino.ai#openvino-runtime-opset3-avg-pool)
