source: https://docs.openvino.ai/2025/api/c_cpp_api/group__ov__dev__api__compiled__model__api.html
lastmod: 

# Group Compiled Model base classes[#](https://docs.openvino.ai#group-compiled-model-base-classes)
