source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset13.shuffle_channels.html
lastmod: 

# openvino.runtime.opset13.shuffle_channels[#](https://docs.openvino.ai#openvino-runtime-opset13-shuffle-channels)

-
openvino.runtime.opset13.shuffle_channels(
*data:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)*axis: int*,*group: int*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset13.shuffle_channels) Perform permutation on data in the channel dimension of the input tensor.
