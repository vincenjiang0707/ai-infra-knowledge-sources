source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset11.depth_to_space.html
lastmod: 

# openvino.runtime.opset11.depth_to_space[#](https://docs.openvino.ai#openvino-runtime-opset11-depth-to-space)

-
openvino.runtime.opset11.depth_to_space(
*node:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)*mode: str*,*block_size: int = 1*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset11.depth_to_space) Rearranges input tensor from depth into blocks of spatial data.
