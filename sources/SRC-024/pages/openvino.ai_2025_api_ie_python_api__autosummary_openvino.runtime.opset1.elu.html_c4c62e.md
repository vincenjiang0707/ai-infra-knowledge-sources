source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset1.elu.html
lastmod: 

# openvino.runtime.opset1.elu[#](https://docs.openvino.ai#openvino-runtime-opset1-elu)

-
openvino.runtime.opset1.elu(
*data:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*alpha: type | dtype*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset1.elu) Perform Exponential Linear Unit operation element-wise on data from input node.
