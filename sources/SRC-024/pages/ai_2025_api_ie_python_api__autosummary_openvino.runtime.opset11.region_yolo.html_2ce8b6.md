source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset11.region_yolo.html
lastmod: 

# openvino.runtime.opset11.region_yolo[#](https://docs.openvino.ai#openvino-runtime-opset11-region-yolo)

-
openvino.runtime.opset11.region_yolo(
*input:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)*coords: int*,*classes: int*,*num: int*,*do_softmax: bool*,*mask: list[int]*,*axis: int*,*end_axis: int*,*anchors: list[float] | None = None*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset11.region_yolo) Return a node which produces the RegionYolo operation.
