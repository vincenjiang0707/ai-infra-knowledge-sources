source: https://docs.openvino.ai/2025/api/c_cpp_api/group__ov__dev__api__async__infer__request__api.html
lastmod: 

# Group Asynchronous Inference Request base classes[#](https://docs.openvino.ai#group-asynchronous-inference-request-base-classes)
