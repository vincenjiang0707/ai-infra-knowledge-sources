source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset1.space_to_depth.html
lastmod: 

# openvino.runtime.opset1.space_to_depth[#](https://docs.openvino.ai#openvino-runtime-opset1-space-to-depth)

-
openvino.runtime.opset1.space_to_depth(
*data:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)*mode: str*,*block_size: int = 1*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset1.space_to_depth) Perform SpaceToDepth operation on the input tensor.
