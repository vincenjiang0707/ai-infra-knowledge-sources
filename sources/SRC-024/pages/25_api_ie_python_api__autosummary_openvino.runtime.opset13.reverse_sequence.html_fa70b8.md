source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset13.reverse_sequence.html
lastmod: 

# openvino.runtime.opset13.reverse_sequence[#](https://docs.openvino.ai#openvino-runtime-opset13-reverse-sequence)

-
openvino.runtime.opset13.reverse_sequence(
*input:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*seq_lengths:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*batch_axis: int | float | ndarray*,*seq_axis: int | float | ndarray*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset13.reverse_sequence) Return a node which produces a ReverseSequence operation.
