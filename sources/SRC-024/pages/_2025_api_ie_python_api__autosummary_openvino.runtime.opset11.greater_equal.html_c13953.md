source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset11.greater_equal.html
lastmod: 

# openvino.runtime.opset11.greater_equal[#](https://docs.openvino.ai#openvino-runtime-opset11-greater-equal)

-
openvino.runtime.opset11.greater_equal(
*left_node:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*right_node:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*auto_broadcast: str = 'NUMPY'*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset11.greater_equal) Return node which checks if left node is greater or equal to the right node element-wise.
