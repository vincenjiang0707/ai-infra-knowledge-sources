source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset1.prior_box_clustered.html
lastmod: 

# openvino.runtime.opset1.prior_box_clustered[#](https://docs.openvino.ai#openvino-runtime-opset1-prior-box-clustered)

-
openvino.runtime.opset1.prior_box_clustered(
*output_size:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)*image_size:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*attrs: dict*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset1.prior_box_clustered) Generate prior boxes of specified sizes normalized to the input image size.
