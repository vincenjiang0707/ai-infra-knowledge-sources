source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset10.prior_box.html
lastmod: 

# openvino.runtime.opset10.prior_box[#](https://docs.openvino.ai#openvino-runtime-opset10-prior-box)

-
openvino.runtime.opset10.prior_box(
*layer_shape:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)*image_shape:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*attrs: dict*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset10.prior_box) Generate prior boxes of specified sizes and aspect ratios across all dimensions.
