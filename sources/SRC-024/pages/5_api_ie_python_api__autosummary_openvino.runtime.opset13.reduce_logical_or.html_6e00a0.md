source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset13.reduce_logical_or.html
lastmod: 

# openvino.runtime.opset13.reduce_logical_or[#](https://docs.openvino.ai#openvino-runtime-opset13-reduce-logical-or)

-
openvino.runtime.opset13.reduce_logical_or(
*node:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*reduction_axes:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*keep_dims: bool = False*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset13.reduce_logical_or) Logical OR reduction operation on input tensor, eliminating the specified reduction axes.
