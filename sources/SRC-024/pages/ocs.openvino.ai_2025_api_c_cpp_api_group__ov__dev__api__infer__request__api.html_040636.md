source: https://docs.openvino.ai/2025/api/c_cpp_api/group__ov__dev__api__infer__request__api.html
lastmod: 

# Group Inference Request common classes[#](https://docs.openvino.ai#group-inference-request-common-classes)

-
*group*Inference Request common classes A set of base and helper classes to implement a common inference request functionality.

-
class IInferRequest
[#](https://docs.openvino.ai#_CPPv4N2ov13IInferRequestE) *#include <iinfer_request.hpp>*An internal API of inference request to be implemented by plugin.
