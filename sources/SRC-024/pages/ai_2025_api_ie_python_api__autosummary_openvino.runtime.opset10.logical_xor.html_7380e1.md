source: https://docs.openvino.ai/2025/api/ie_python_api/_autosummary/openvino.runtime.opset10.logical_xor.html
lastmod: 

# openvino.runtime.opset10.logical_xor[#](https://docs.openvino.ai#openvino-runtime-opset10-logical-xor)

-
openvino.runtime.opset10.logical_xor(
*left_node:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*right_node:*,[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)| int | float | ndarray*auto_broadcast: str = 'NUMPY'*,*name: str | None = None*)[Node](https://docs.openvino.ai/openvino.Node.html#openvino.Node)[#](https://docs.openvino.ai#openvino.runtime.opset10.logical_xor) Return node which performs logical XOR operation on input nodes element-wise.
