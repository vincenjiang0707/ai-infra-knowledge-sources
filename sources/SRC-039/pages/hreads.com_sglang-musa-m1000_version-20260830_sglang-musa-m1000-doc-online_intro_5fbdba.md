source: https://docs.mthreads.com/sglang-musa-m1000/version-20260830/sglang-musa-m1000-doc-online/intro

# SGLang-MUSA M1000 简介

SGLang 是面向大语言模型和视觉语言模型的高��性能推理框架。SGLang-MUSA M1000 提供了在摩尔线程 M1000 端侧 GPU 上运行 SGLang 的适配能力，便于用户在 MUSA 软件栈中部署模型服务并进行推理验证。
