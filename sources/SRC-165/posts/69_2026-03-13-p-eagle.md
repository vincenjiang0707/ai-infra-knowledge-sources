...
[ArXiv Paper](https://www.arxiv.org/pdf/2602.01469)- HuggingFace Models (
[GPT-OSS 120B](https://huggingface.co/amazon/gpt-oss-120b-p-eagle),[GPT-OSS 20B](https://huggingface.co/amazon/GPT-OSS-20B-P-EAGLE),[Qwen3-Coder-30B-A3B-Instruct](https://huggingface.co/amazon/Qwen3-Coder-30B-A3B-Instruct-P-EAGLE)) - vLLM Integration
[Unified Parallel Drafting](https://github.com/vllm-project/vllm/pull/32887) - vLLM-Speculators (
[RFC](https://github.com/vllm-project/speculators/issues/292),[PR](https://github.com/vllm-project/speculators/pull/343))

### Quick start P-EAGLE

You can enable parallel drafting with a single configuration change in the `SpeculativeConfig`
...
is loaded from the model's `mask_hidden`
...
Try it today: download a pre-trained P-EAGLE head from HuggingFace, set `"parallel_drafting": true`
