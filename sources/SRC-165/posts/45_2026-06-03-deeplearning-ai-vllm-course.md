# 2026-06-03-deeplearning-ai-vllm-course
...
**Course**:[Fast & Efficient LLM Inference with vLLM](https://www.deeplearning.ai/courses/fast-and-efficient-llm-inference-with-vllm/)**Instructor**:[Cedric Clyburn](https://www.linkedin.com/in/cedricclyburn), Senior Developer Advocate at Red Hat**Duration**: ~1.5 hours, 9 video lessons, 3 hands-on code labs**Level**: Intermediate (assumes familiarity with Python and basic LLM concepts)
