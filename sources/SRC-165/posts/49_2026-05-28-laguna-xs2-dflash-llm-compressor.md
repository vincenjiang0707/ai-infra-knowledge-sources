# 2026-05-28-laguna-xs2-dflash-llm-compressor
...
- Explore the Laguna XS.2 models on the
[Hugging Face Hub](https://huggingface.co/collections/poolside/laguna-xs2) - Optimize your own models with
[LLM Compressor](https://github.com/vllm-project/llm-compressor)and[Speculators](https://github.com/vllm-project/speculators)
