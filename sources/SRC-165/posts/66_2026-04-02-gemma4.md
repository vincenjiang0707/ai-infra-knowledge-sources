...
**Native Vision and Audio:**All models natively process images and video. Smaller edge models (E2B/E4B) also feature native audio input for speech recognition.**Agentic Workflows:**Support for function-calling, structured JSON output, and native system instructions allows vLLM users to build reliable autonomous agents.**Extended Context:**vLLM handles Gemma 4's varying context windows—up to 128K for edge models and 256K for larger models—allowing for long-document and repository-level processing.**Global Fluency:**Natively trained on over 140 languages, enabling inclusive application development.
