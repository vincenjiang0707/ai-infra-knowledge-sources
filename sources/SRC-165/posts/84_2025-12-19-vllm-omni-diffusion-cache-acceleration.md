# 2025-12-19-vllm-omni-diffusion-cache-acceleration
...
Getting started with acceleration in vLLM-Omni is seamless. Simply define your `cache_backend`

when initializing the `Omni`
