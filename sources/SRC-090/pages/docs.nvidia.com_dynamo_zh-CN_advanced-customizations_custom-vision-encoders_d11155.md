source: https://docs.nvidia.com/dynamo/zh-CN/advanced-customizations/custom-vision-encoders
...
. Apply Dynamo’s
[media URL policy](https://docs.nvidia.com/dynamo/multimodal/overview), finite network timeouts,
