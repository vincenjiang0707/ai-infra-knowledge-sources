source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/modular-components/ai-simulate/spica/glm-5-fp-8-pareto-sweep
...
. Spica reaches **113.5%** of the latest replay
...
The packaged dependencies support this configuration’s KV-capacity and candidate-concurrency calculations. Reproducing the historical frontier still depends on AI Configurator performance database coverage for B200/SGLang/GLM-5-FP8 and on Replay behavior in the runtime snapshot.

The AI Configurator performance model needs the `aic-forward-pass`

binding. Dynamo’s attention-DP
