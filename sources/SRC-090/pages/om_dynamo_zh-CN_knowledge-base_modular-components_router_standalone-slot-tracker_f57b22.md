source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/modular-components/router/standalone-slot-tracker
...
; positive values enable prefill-token accounting. Duplicate request IDs return
`409`

. Unknown trackers or worker ranks return `404`
