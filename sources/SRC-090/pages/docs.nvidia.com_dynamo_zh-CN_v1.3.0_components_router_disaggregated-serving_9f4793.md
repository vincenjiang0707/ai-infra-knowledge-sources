source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/components/router/disaggregated-serving
...
For the high-level deployment matrix, see [Router Guide](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/kv-cache-aware-routing). For the router flags used in this setup, see [Configuration and Tuning](https://docs.nvidia.com/dynamo/v1.3.0/components/router/configuration-and-tuning).

If prefill and decode workers span topology domains such as zones or racks, use [Topology-Aware KV Transfer](https://docs.nvidia.com/dynamo/v1.3.0/components/router/topology-aware-kv-transfer) to constrain or bias decode routing toward workers in the selected prefill worker’s transfer domain.
...
returned by prefill. For an advanced reference, see the [Global Router](https://github.com/ai-dynamo/dynamo/tree/v1.3.0/components/src/dynamo/global_router), which composes local prefill and decode router pools explicitly.
