source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/kubernetes-deployment/deployment-guide/rolling-update
...
Managed rolling updates with namespace isolation are planned for Grove and LWS-backed deployments in a future release. See [Future Work](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/rolling-update#future-work) for details.
