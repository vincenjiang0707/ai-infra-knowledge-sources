source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/kubernetes/kubernetes-operator/disagg-communication
...
`nvcr.io/nvidia/ai-dynamo/vllm-runtime:1.4.0-efa`
...
For AWS EFA deployments, use libfabric with GDRCopy to enable GPUDirect RDMA. UCX on AWS EFA does not support GPUDirect on kernel ≥6.8 and results in severely degraded performance. See [AWS EFA Configuration](https://docs.nvidia.com/dynamo/knowledge-base/kubernetes/kubernetes-operator/disagg-communication#aws-efa-configuration) for setup instructions.
...
Use `nvidia.com/dynamo-component`
