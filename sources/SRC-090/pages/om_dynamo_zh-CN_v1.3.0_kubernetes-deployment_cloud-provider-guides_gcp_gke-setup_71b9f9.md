source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/kubernetes-deployment/cloud-provider-guides/gcp/gke-setup
...
More configurations please refer to [https://github.com/ai-dynamo/dynamo/tree/v1.3.0/examples/deployments/GKE/vllm](https://github.com/ai-dynamo/dynamo/tree/v1.3.0/examples/deployments/GKE/vllm)
...
For example, refer to [ examples/deployments/GKE/vllm/v1beta1/disagg.yaml](https://docs.nvidia.com/dynamo/examples/deployments/GKE/vllm/v1beta1/disagg.yaml):
