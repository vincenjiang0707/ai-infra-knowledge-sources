source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/user-guides/reasoning/reasoning-parsing-dynamo
...
Some models need both a reasoning parser and a tool call parser. For supported tool call parser names, see [Tool Call Parsing (Dynamo)](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/tool-calling/tool-call-parsing-dynamo).
...
(see [Reasoning Parsing (Engine Fallback)](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/reasoning/reasoning-parsing-engine-fallback)). A blank upstream
...
:`--dyn-tool-call-parser kimi_k2 --dyn-reasoning-parser kimi_k25`
