source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/backends/tensor-rt-llm/known-issues-and-mitigations
...
[Container / driver matrix](https://docs.nvidia.com/dynamo/v1.2.1/backends/tensor-rt-llm#container--driver-matrix). - Either upgrade the host driver, or pull a lower-CUDA variant (e.g.
`vllm-runtime:1.0.2`
