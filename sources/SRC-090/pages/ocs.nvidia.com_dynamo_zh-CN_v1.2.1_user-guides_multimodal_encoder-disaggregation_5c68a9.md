source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/user-guides/multimodal/encoder-disaggregation
...
See the backend-specific documentation ([vLLM](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/multimodal/multimodal-vllm.md), [TRT-LLM](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/multimodal/multimodal-trtllm.md), [SGLang](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/multimodal/multimodal-sglang.md)) for full configuration details and component flags.