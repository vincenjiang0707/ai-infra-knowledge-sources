source: https://docs.nvidia.com/dynamo/v1.3.0/recipes/deepseek-v4-pro
...
in the manifest — see [Per-rank NIC mapping](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/deepseek-v4/README.md#per-rank-nic-mapping-b200--h200-disaggregated).
...
The shared [ perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/deepseek-v4/perf/perf.yaml) replays the agentic MoonTrace (64K avg ISL / 400 OSL, 90% KV reuse) with AIPerf. Point
...
. See the[top-level README](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/deepseek-v4/README.md#per-rank-nic-mapping-b200--h200-disaggregated).- Day-0 / GB200 (vLLM + SGLang, ComputeDomain/MNNVL) variants exist in the recipe tree but are experimental (dev images) and not shown here.

## Source

- Recipe README:
[recipes/deepseek-v4/deepseek-v4-pro/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/deepseek-v4/deepseek-v4-pro/README.md) - Top-level DeepSeek-V4 README (shared workloads, NIC mapping, limitations):
[recipes/deepseek-v4/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/deepseek-v4/README.md) - Manifests:
[vllm/](https://github.com/ai-dynamo/dynamo/tree/v1.3.0/recipes/deepseek-v4/deepseek-v4-pro/vllm)and shared[perf/perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/deepseek-v4/perf/perf.yaml)