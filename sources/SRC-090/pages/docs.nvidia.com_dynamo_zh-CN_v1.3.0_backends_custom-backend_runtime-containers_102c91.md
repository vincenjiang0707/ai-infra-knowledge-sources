source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/backends/custom-backend/runtime-containers
...
Use [ container/render.py](https://docs.nvidia.com/dynamo/v1.3.0/container/render.py) to select the engine family and Docker target:
...
For the full container build reference, target matrix, and troubleshooting notes, see the repository-level [Container Development Guide](https://docs.nvidia.com/dynamo/v1.3.0/container/README.md).