source: https://docs.nvidia.com/dynamo/v1.3.0/backends/v-llm/reference-guide
...
[Priority Scheduling](https://docs.nvidia.com/dynamo/v1.3.0/components/router/priority-scheduling). For the upstream
...
See the high-level notes in [Router Design](https://docs.nvidia.com/dynamo/v1.3.0/design-docs/component-design/router-design#deterministic-event-ids) on deterministic event IDs.
...
environment variable. See [Health Checks](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/observability-local/health-checks) for the broader health check architecture.
...
: All deployment patterns with launch scripts[Examples](https://docs.nvidia.com/dynamo/v1.3.0/backends/v-llm/examples): Quick start and feature overview[vLLM README](https://docs.nvidia.com/dynamo/v1.3.0/backends/v-llm): Metrics and monitoring setup[Observability](https://docs.nvidia.com/dynamo/v1.3.0/backends/v-llm/observability): KV-aware routing configuration[Configuration and Tuning](https://docs.nvidia.com/dynamo/v1.3.0/components/router/configuration-and-tuning): Request migration, cancellation, and graceful shutdown[Fault Tolerance](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/fault-tolerance)