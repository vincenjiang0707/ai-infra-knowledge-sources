source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/components/router/standalone-indexer
...
This is distinct from the [Standalone Router](https://docs.nvidia.com/dynamo/components/src/dynamo/router/README.md), which is a full routing service. The standalone indexer provides only the indexing and query layer without routing logic.
...
counter includes
both device- and lower-tier events. See [KV Indexer Metrics](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/observability-local/metrics#kv-indexer-metrics).
...
: per-instance, per-tier breakdown aligned with[Mooncake RFC #1403](https://github.com/kvcache-ai/Mooncake/issues/1403). See[Per-instance tier breakdown](https://docs.nvidia.com/dynamo/v1.3.0/components/router/standalone-indexer#per-instance-tier-breakdown)below.
