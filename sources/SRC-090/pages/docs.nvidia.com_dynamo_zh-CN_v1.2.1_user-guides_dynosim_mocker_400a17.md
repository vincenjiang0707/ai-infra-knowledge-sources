source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/user-guides/dynosim/mocker
...
For full usage, constraints, and benchmarking guidance, see [DynoSim Runs](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/dynosim/runs).
...
The mocker’s KV block manager is now built on [ kvbm-logical::BlockManager<G1>](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/lib/kvbm-logical), the same logical block manager the real Dynamo runtime uses. The mocker wraps it in

[and translates its own](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/lib/mocker/src/kv_manager/kvbm_backend.rs)
...
in [ lib/mocker/src/common/protocols.rs](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/lib/mocker/src/common/protocols.rs):
