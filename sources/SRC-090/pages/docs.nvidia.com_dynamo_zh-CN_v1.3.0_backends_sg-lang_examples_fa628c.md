source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/backends/sg-lang/examples
lastmod: 2026-09-23T23:30:39.914Z

# Examples

Launch scripts cover aggregated, disaggregated, KV-routed, multimodal, and diffusion deployments on the SGLang backend.

For quick start instructions, see the [SGLang README](https://docs.nvidia.com/dynamo/v1.3.0/backends/sg-lang). This document provides all deployment patterns for running SGLang with Dynamo, including LLMs, multimodal, and diffusion models, and Kubernetes deployment.
...
Two workers behind a [KV-aware router](https://docs.nvidia.com/dynamo/v1.3.0/components/router) that maximizes cache reuse:
...
For details on how SGLang disaggregation works with Dynamo, including the bootstrap mechanism and RDMA transfer flow, see [SGLang Disaggregation](https://docs.nvidia.com/dynamo/v1.3.0/backends/sg-lang/disaggregation).
...
For advanced multimodal deployments with separate encoder, prefill, and decode workers (E/PD and E/P/D patterns), see the dedicated [SGLang Multimodal](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/multimodal/sg-lang-multimodal) documentation.
...
For full details on all diffusion worker types (LLM, image, video), see [Diffusion](https://docs.nvidia.com/dynamo/v1.3.0/backends/sg-lang/diffusion).
...
: Quick start and feature overview[SGLang README](https://docs.nvidia.com/dynamo/v1.3.0/backends/sg-lang): Architecture, configuration, and operational details[Reference Guide](https://docs.nvidia.com/dynamo/v1.3.0/backends/sg-lang/reference-guide): Vision model deployment patterns[SGLang Multimodal](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/multimodal/sg-lang-multimodal): Hierarchical cache integration[SGLang HiCache](https://docs.nvidia.com/dynamo/v1.3.0/integrations/kv-cache-integrations/hi-cache): Performance benchmarking tools[Benchmarking](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/benchmarking): P/D tuning guide[Tuning Disaggregated Performance](https://docs.nvidia.com/dynamo/v1.3.0/additional-resources/tuning-disaggregated-performance)