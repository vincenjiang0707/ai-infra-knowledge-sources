source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/user-guides/lo-ra-adapters
...
See the [Feature Matrix](https://docs.nvidia.com/dynamo/v1.1.1/resources/feature-matrix) for full compatibility details.
...
[Feature Matrix](https://docs.nvidia.com/dynamo/v1.1.1/resources/feature-matrix)- Backend compatibility overview[vLLM Backend](https://docs.nvidia.com/dynamo/v1.1.1/backends/v-llm)- vLLM-specific configuration[Dynamo Operator](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/dynamo-operator)- Kubernetes operator overview[Routing Concepts](https://docs.nvidia.com/dynamo/v1.1.1/components/router/routing-concepts)- LoRA-aware request routing[KV Events for Custom Engines](https://docs.nvidia.com/dynamo/v1.1.1/integrations/kv-events-for-custom-engines)- Publishing LoRA-aware KV events