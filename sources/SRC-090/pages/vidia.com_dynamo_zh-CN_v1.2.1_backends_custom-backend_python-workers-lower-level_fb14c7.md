source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/backends/custom-backend/python-workers-lower-level
...
For more information about how request migration works, see the [Request Migration Architecture](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/fault-tolerance/request-migration) documentation.
...
For detailed information about request cancellation, including async cancellation monitoring and context propagation patterns, see the [Request Cancellation Architecture](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/fault-tolerance/request-cancellation) documentation.