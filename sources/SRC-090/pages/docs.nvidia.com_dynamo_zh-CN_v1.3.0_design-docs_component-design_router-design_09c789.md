source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/design-docs/component-design/router-design
...
: Quick start guide for the KV Router[Router README](https://docs.nvidia.com/dynamo/v1.3.0/components/router): Router flags, tuning, and production setup[Configuration and Tuning](https://docs.nvidia.com/dynamo/v1.3.0/components/router/configuration-and-tuning): Python API usage and custom routing patterns[Router Examples](https://docs.nvidia.com/dynamo/v1.3.0/components/router/router-examples): Integrate custom inference engines with KV-aware routing[KV Event Publishing for Custom Engines](https://docs.nvidia.com/dynamo/v1.3.0/integrations/kv-cache-integrations/kv-events-for-custom-engines)