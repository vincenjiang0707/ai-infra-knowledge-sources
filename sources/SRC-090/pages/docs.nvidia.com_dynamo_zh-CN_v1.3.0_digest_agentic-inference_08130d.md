source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/digest/agentic-inference
...
; see the [NVIDIA Request Extensions reference](https://docs.nvidia.com/dynamo/components/frontend/nvext.md#agent-hints).
