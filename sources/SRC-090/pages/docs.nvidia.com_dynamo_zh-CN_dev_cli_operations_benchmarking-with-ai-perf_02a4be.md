source: https://docs.nvidia.com/dynamo/zh-CN/dev/cli/operations/benchmarking-with-ai-perf
...
[Agent Skills](https://docs.nvidia.com/dynamo/dev/agent-skills/overview) for the inventory and example prompts.

## Prerequisites

Start a local deployment by following [Model Deployment](https://docs.nvidia.com/dynamo/dev/cli/model-deployment/introduction). Confirm that the frontend is
...
- Use
[Sizing with AIConfigurator](https://docs.nvidia.com/dynamo/dev/cli/disaggregated-serving/sizing-with-ai-configurator)to select additional configurations. - Use the full
[Dynamo Benchmarking guide](https://docs.nvidia.com/dynamo/dev/recipes/benchmarks/benchmarking)for concurrency sweeps, arrival patterns, trace replay, visualization, and GPU telemetry.