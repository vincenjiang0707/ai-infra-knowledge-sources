source: https://docs.nvidia.com/dynamo/v1.2.1/getting-started/quickstart
...
For container versions and tags, see [Release Artifacts](https://docs.nvidia.com/dynamo/v1.2.1/resources/release-artifacts#container-images).
...
Connection refused? The frontend takes a few seconds to start — retry. For production liveness and readiness probes, see [Health Checks](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/observability-local/health-checks).

## From the Digest

## Dive Deeper

Pick a full install path from the [four options above](https://docs.nvidia.com/dynamo/v1.2.1/getting-started/quickstart#choose-your-path), or explore how Dynamo works under the hood: