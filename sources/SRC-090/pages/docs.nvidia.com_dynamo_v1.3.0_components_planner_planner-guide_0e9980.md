source: https://docs.nvidia.com/dynamo/v1.3.0/components/planner/planner-guide
...
For a quick overview, see the [Planner overview](https://docs.nvidia.com/dynamo/v1.3.0/components/planner). For architecture internals, see [Planner Design](https://docs.nvidia.com/dynamo/v1.3.0/design-docs/component-design/planner-design).
...
See the [Profiler Guide](https://docs.nvidia.com/dynamo/v1.3.0/components/profiler/profiler-guide) for the full profiling workflow and how to configure pre-deployment sweeping.
...
In the current workflow, run profiling independently for each intended pool, then compose the final control DGD plus pool DGDs manually. See the [Global Planner Guide](https://docs.nvidia.com/dynamo/v1.3.0/components/planner/global-planner-guide).

## See Also

[Planner overview](https://docs.nvidia.com/dynamo/v1.3.0/components/planner)— Why LLM inference needs a different autoscaler[Planner Design](https://docs.nvidia.com/dynamo/v1.3.0/design-docs/component-design/planner-design)— Architecture and algorithm internals[Planner Examples](https://docs.nvidia.com/dynamo/v1.3.0/components/planner/planner-examples)— Planner-specific configuration examples[DGDR Examples](https://docs.nvidia.com/dynamo/v1.3.0/kubernetes-deployment/deploy-models/dgdr-examples)— DGDR YAML examples, sample configurations, advanced patterns[Global Planner Guide](https://docs.nvidia.com/dynamo/v1.3.0/components/planner/global-planner-guide)— Multi-DGD coordination, shared GPU budgets, single-endpoint multi-pool deployments[Profiler Guide](https://docs.nvidia.com/dynamo/v1.3.0/components/profiler/profiler-guide)— How profiling data is generated