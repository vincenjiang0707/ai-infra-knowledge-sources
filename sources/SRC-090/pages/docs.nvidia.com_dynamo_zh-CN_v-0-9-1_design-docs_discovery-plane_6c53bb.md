source: https://docs.nvidia.com/dynamo/zh-CN/v-0-9-1/design-docs/discovery-plane
...
Note:The runtime always defaults to etcd (`kv_store`

). Kubernetes discovery must be explicitly enabled — the Dynamo operator handles this automatically.
...
[Event Plane](https://docs.nvidia.com/dynamo/v-0-9-1/design-docs/event-plane)— Pub/sub for KV cache events and worker metrics[Distributed Runtime](https://docs.nvidia.com/dynamo/v-0-9-1/design-docs/distributed-runtime)— Runtime architecture[Request Plane](https://docs.nvidia.com/dynamo/v-0-9-1/design-docs/request-plane)— Request transport configuration[Fault Tolerance](https://docs.nvidia.com/dynamo/v-0-9-1/user-guides/fault-tolerance)— Failure handling