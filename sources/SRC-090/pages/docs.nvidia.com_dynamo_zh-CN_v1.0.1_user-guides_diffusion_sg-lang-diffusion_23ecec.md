source: https://docs.nvidia.com/dynamo/zh-CN/v1.0.1/user-guides/diffusion/sg-lang-diffusion
...
See the [launch script](https://github.com/ai-dynamo/dynamo/tree/v1.0.1/examples/backends/sglang/launch/diffusion_llada.sh) for configuration options.
...
: Launch scripts for all deployment patterns[Examples](https://docs.nvidia.com/dynamo/v1.0.1/backends/sg-lang/examples): Worker types and argument reference[Reference Guide](https://docs.nvidia.com/dynamo/v1.0.1/backends/sg-lang/reference-guide): SGLang diffusion documentation[SGLang Diffusion LMs (upstream)](https://github.com/sgl-project/sglang/blob/main/docs/supported_models/text_generation/diffusion_language_models.md)