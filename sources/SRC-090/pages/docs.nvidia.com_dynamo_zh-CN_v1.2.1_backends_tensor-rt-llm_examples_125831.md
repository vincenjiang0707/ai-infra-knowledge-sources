source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/backends/tensor-rt-llm/examples
lastmod: 2026-09-23T23:30:39.914Z

# Examples

For quick start instructions, see the [TensorRT-LLM README](https://docs.nvidia.com/dynamo/v1.2.1/backends/tensor-rt-llm). This document provides all deployment patterns for running TensorRT-LLM with Dynamo, including single-node, multi-node, and Kubernetes deployments.
...
For detailed information about KV-aware routing behavior, see [Routing Concepts](https://docs.nvidia.com/dynamo/v1.2.1/components/router/routing-concepts). For deployment modes, see the [Router Guide](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/kv-cache-aware-routing).
...
For comprehensive instructions on multinode serving, see the [Multinode Examples](https://docs.nvidia.com/dynamo/v1.2.1/additional-resources/tensor-rt-llm-details/multinode-examples) guide. It provides step-by-step deployment examples and configuration tips for running Dynamo with TensorRT-LLM across multiple nodes. While the walkthrough uses DeepSeek-R1 as the model, you can easily adapt the process for any supported model by updating the relevant configuration files. You can see the [Llama4 + Eagle](https://docs.nvidia.com/dynamo/v1.2.1/additional-resources/tensor-rt-llm-details/llama-4-eagle) guide to learn how to use these scripts when a single worker fits on a single node.

### Speculative Decoding

### Model-Specific Guides

[Gemma3 with Sliding Window Attention](https://docs.nvidia.com/dynamo/v1.2.1/additional-resources/tensor-rt-llm-details/gemma-3-sliding-window)— Reasoning model with tool calling support[GPT-OSS-120b](https://docs.nvidia.com/dynamo/v1.2.1/additional-resources/tensor-rt-llm-details/gpt-oss)
...
See the [client](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang#testing-the-deployment) section to learn how to send requests to the deployment.
