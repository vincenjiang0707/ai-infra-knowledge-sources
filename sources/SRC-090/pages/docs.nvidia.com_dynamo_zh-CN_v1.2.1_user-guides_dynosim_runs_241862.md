source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/user-guides/dynosim/runs
...
See [ lib/mocker/src/replay/offline/README.md](https://docs.nvidia.com/dynamo/v1.2.1/lib/mocker/src/replay/offline/README.md) for offline-harness internals (logical clock, event queue, worker model) and

[Live Simulation with Mocker](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/dynosim/mocker)for engine-core details (scheduler, KV block manager).
...
(unsigned queue tier; larger values run first)
...
. Dependency fields are optional.
...
marks the first row in a trajectory.

Use `agent_trace_to_mooncake --agentic`

to create this format from Dynamo agent traces:
...
Use [Dynamo Benchmarking](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/benchmarking) when:
