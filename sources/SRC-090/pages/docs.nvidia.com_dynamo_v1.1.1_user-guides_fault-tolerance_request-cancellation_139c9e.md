source: https://docs.nvidia.com/dynamo/v1.1.1/user-guides/fault-tolerance/request-cancellation
...
) and terminate processing accordingly. For details on implementing cancellation handling in a backend worker, see the [Backend Development Guide](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/writing-python-workers#request-cancellation).
