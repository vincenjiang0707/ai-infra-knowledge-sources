source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/user-guides/diffusion/v-llm-omni
...
This guide assumes familiarity with deploying Dynamo with vLLM as described in the [vLLM backend guide](https://docs.nvidia.com/dynamo/v1.1.1/backends/v-llm).
...
) that configures the thinker stage for text generation. See [Stage Configuration](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/diffusion/v-llm-omni#stage-configuration) for details.
