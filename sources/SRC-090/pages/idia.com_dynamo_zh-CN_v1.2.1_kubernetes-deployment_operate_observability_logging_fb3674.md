source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/kubernetes-deployment/operate/observability/logging
...
This guide assumes you have installed Dynamo Kubernetes Platform. For more information, see [Dynamo Kubernetes Platform](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/start-here/kubernetes-quickstart).
