source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/user-guides/multimodal/embedding-cache
...
See the backend-specific documentation ([vLLM](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/docs/features/multimodal/multimodal-vllm.md#embedding-cache), [TRT-LLM](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/docs/features/multimodal/multimodal-trtllm.md#embedding-cache)) for more details.