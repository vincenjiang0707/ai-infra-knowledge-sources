source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/recipes/qwen3-235b-a22b-fp8
...
- Source README:
[recipes/qwen3-235b-a22b-fp8/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/README.md) - Aggregated Blackwell:
[deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/trtllm/agg/blackwell/deploy.yaml)and[perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/trtllm/agg/blackwell/perf.yaml) - Disaggregated Blackwell:
[deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/trtllm/disagg/blackwell/deploy.yaml)and[perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/trtllm/disagg/blackwell/perf.yaml) - Aggregated Hopper:
[deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/trtllm/agg/hopper/deploy.yaml)and[perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/trtllm/agg/hopper/perf.yaml) - Disaggregated Hopper:
[deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/trtllm/disagg/hopper/deploy.yaml)and[perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/trtllm/disagg/hopper/perf.yaml) - Setup assets:
[model-cache/model-cache.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/model-cache/model-cache.yaml)and[model-cache/model-download.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-235b-a22b-fp8/model-cache/model-download.yaml)