source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/backends/v-llm/v-llm-omni
...
This guide assumes familiarity with deploying Dynamo with vLLM as described in the [vLLM backend guide](https://docs.nvidia.com/dynamo/v1.2.1/backends/v-llm).
