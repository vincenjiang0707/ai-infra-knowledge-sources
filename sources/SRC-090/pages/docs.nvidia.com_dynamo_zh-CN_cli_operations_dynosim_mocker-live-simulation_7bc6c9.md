source: https://docs.nvidia.com/dynamo/zh-CN/cli/operations/dynosim/mocker-live-simulation
...
registration, or runtime services, see [Run a DynoSim Simulation](https://docs.nvidia.com/dynamo/cli/operations/dynosim/simulation-runs).

This tutorial uses file-based discovery so that the frontend and worker can run without etcd or
NATS. For Kubernetes, see [Simulate a Kubernetes Deployment](https://docs.nvidia.com/dynamo/kubernetes/operations/dynosim/live-simulation-with-mocker). For every available flag,
see the [Mocker CLI Reference](https://docs.nvidia.com/dynamo/reference/components/mocker-cli-reference).

## Prerequisites

Install Dynamo by following [Install Dynamo](https://docs.nvidia.com/dynamo/cli/installation/install-dynamo). Verify that
...
Use the [Mocker CLI Reference](https://docs.nvidia.com/dynamo/reference/components/mocker-cli-reference) for scheduling,
KV-cache, timing, AIC, and transport settings. Use [Run a DynoSim Simulation](https://docs.nvidia.com/dynamo/cli/operations/dynosim/simulation-runs) when you want
