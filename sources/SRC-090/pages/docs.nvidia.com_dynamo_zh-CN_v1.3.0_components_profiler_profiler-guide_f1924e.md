source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/components/profiler/profiler-guide
...
), SLA targets verified, and gate checks applied (see[Gate Checks](https://docs.nvidia.com/dynamo/v1.3.0/components/profiler/profiler-guide#gate-checks-and-constraints)). -
...
-
**Picking**: The profiler selects the best configuration using one of three modes, determined automatically from the DGDR spec (see[Picking Modes](https://docs.nvidia.com/dynamo/v1.3.0/components/profiler/profiler-guide#picking-modes)). -
...
is unaffected (easy-mode keeps load scaling enabled). See the [Planner Guide](https://docs.nvidia.com/dynamo/v1.3.0/components/planner/planner-guide#optimization-target) for the full explanation of each `optimization_target`
...
See the [Planner Guide](https://docs.nvidia.com/dynamo/v1.3.0/components/planner/planner-guide) for the full `PlannerConfig`
...
The recommended deployment method is through DGDRs. See [Profiler Examples](https://docs.nvidia.com/dynamo/v1.3.0/components/profiler/profiler-examples) for complete DGDR YAML examples covering rapid, thorough, MoE, custom SLA, and override use cases.
...
[Generated DGD Overrides](https://docs.nvidia.com/dynamo/v1.3.0/kubernetes-deployment/deploy-models/dgdr-reference#generated-dgd-overrides).
...
field names consumed by the planner service. See [SLA Planner documentation](https://docs.nvidia.com/dynamo/v1.3.0/components/planner/planner-guide) for full list.
...
[Profiler README](https://docs.nvidia.com/dynamo/v1.3.0/components/profiler)— Quick overview and feature matrix[Profiler Examples](https://docs.nvidia.com/dynamo/v1.3.0/components/profiler/profiler-examples)— Complete DGDR YAML examples[Planner Guide](https://docs.nvidia.com/dynamo/v1.3.0/components/planner/planner-guide)— PlannerConfig reference and scaling modes[DGDR API Reference](https://docs.nvidia.com/dynamo/v1.3.0/additional-resources/api-reference-k-8-s)— Full DGDR specification