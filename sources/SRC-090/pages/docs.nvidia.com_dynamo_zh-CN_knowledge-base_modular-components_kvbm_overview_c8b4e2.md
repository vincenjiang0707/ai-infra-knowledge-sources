source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/modular-components/kvbm/overview
...
— 安装、配置和部署说明[KVBM 指南](https://docs.nvidia.com/dynamo/v1.4.2/knowledge-base/modular-components/kvbm/kvbm-guide)— 架构深入解析、组件和数据流[KVBM 设计](https://docs.nvidia.com/dynamo/v1.4.2/knowledge-base/modular-components/kvbm/kvbm-design)— 将 LMCache 与 Dynamo vLLM 后端配合使用[LMCache 集成](https://docs.nvidia.com/dynamo/v1.4.2/cli/kv-cache-offloading/overview)— 使用 FlexKV 进行 KV cache 管理[FlexKV 集成](https://docs.nvidia.com/dynamo/v1.4.2/cli/kv-cache-offloading/overview)— 通过 NIXL 启用 SGLang 的分层缓存[SGLang HiCache](https://docs.nvidia.com/dynamo/v1.4.2/knowledge-base/modular-components/backends/sg-lang/hi-cache)— NIXL 通信库详细信息[NIXL Documentation](https://github.com/ai-dynamo/nixl/blob/main/docs/nixl.md)