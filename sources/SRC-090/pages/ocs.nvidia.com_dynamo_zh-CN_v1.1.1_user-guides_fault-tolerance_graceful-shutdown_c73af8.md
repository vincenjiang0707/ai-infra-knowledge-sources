source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/user-guides/fault-tolerance/graceful-shutdown
...
- See
[Request Migration Architecture](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/fault-tolerance/request-migration)for details on how migration works
...
to complete (default: 30s) - If not terminated, Kubernetes sends
`SIGKILL`
