source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/user-guides/fault-tolerance/testing
lastmod: 2026-09-23T23:30:39.914Z

# Testing

Pytest framework for validating Dynamo’s cancellation, migration, etcd HA, and hardware fault-injection paths under induced failures.
...
after each test run. See [ tests/fault_tolerance/hardware/fault_injection_service/README.md](https://docs.nvidia.com/dynamo/v1.3.0/tests/fault_tolerance/hardware/fault_injection_service/README.md) for the full security posture.
...
[Request Migration](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/fault-tolerance/request-migration)- Migration implementation details[Request Cancellation](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/fault-tolerance/request-cancellation)- Cancellation implementation[Health Checks](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/observability-local/health-checks)- Health monitoring[Metrics](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/observability-local/metrics)- Available metrics for monitoring