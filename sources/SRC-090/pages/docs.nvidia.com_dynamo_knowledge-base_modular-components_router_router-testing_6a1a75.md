source: https://docs.nvidia.com/dynamo/knowledge-base/modular-components/router/router-testing
...
[test_router_e2e_with_mockers.py](https://docs.nvidia.com/dynamo/tests/router/test_router_e2e_with_mockers.py)[test_router_e2e_with_vllm.py](https://docs.nvidia.com/dynamo/tests/router/test_router_e2e_with_vllm.py)[test_router_e2e_with_trtllm.py](https://docs.nvidia.com/dynamo/tests/router/test_router_e2e_with_trtllm.py)[test_router_e2e_with_sglang.py](https://docs.nvidia.com/dynamo/tests/router/test_router_e2e_with_sglang.py)
