source: https://docs.nvidia.com/dynamo/v1.2.1/user-guides/observability-local/metrics-developer-guide
...
method on runtime, namespace, component, and endpoint objects. See [Runtime Hierarchy](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/observability-local/metrics#runtime-hierarchy) for details on the hierarchical structure.
