source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/user-guides/parsing/parser-configuration
...
. - The
**bare**and normally go on the`--tool-call-parser`
...
reasoning tokens. Therefore, both the `--reasoning-parser`

(engine reasoning awareness)
and the `--dyn-reasoning-parser`

(frontend response parsing) flags should be set when using
...
- Tool calling:
[Tool Call Parsing (Dynamo)](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/parsing/tool-call-parsing-dynamo)(native parser names). - Reasoning:
[Reasoning Parsing (Dynamo)](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/parsing/reasoning-parsing-dynamo)(native parser names). - Engine fallback (vLLM / SGLang):
[Parser Engine Fallback](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/parsing/parser-engine-fallback). - Engine processors:
[vLLM Chat Processor](https://docs.nvidia.com/dynamo/v1.3.0/backends/v-llm/frontend-processor-fallback)and[SGLang Chat Processor](https://docs.nvidia.com/dynamo/v1.3.0/backends/sg-lang/frontend-processor-fallback). - Every frontend flag:
[Frontend Configuration Reference](https://docs.nvidia.com/dynamo/v1.3.0/components/frontend/configuration-reference).