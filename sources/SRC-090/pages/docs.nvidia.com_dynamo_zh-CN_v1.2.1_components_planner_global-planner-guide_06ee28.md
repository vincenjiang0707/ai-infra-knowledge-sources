source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/components/planner/global-planner-guide
...
[Kubernetes Quickstart](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/start-here/kubernetes-quickstart). - Prometheus deployed and scraping router metrics. The global planner examples assume cluster Prometheus is available.
...
For SLA throughput-based scaling, each pool needs either native AIC support, optional bootstrap profiling data, or enough live FPM observations to warm the fallback model. See [Profiler Guide](https://docs.nvidia.com/dynamo/v1.2.1/components/profiler/profiler-guide).
...
See [Planner Examples](https://docs.nvidia.com/dynamo/v1.2.1/components/planner/planner-examples) and [Profiler Guide](https://docs.nvidia.com/dynamo/v1.2.1/components/profiler/profiler-guide) for DGDR details.
...
The vLLM example topology is in [examples/global_planner/global-planner-vllm-test.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/examples/global_planner/global-planner-vllm-test.yaml).
...
. See [examples/global_planner/global-planner-gpu-budget.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/examples/global_planner/global-planner-gpu-budget.yaml).
...
. See the [Planner overview](https://docs.nvidia.com/dynamo/v1.2.1/components/planner#prometheus-metrics) for the exact frontend and router metric sources.
...
See [global-planner-vllm-test.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/examples/global_planner/global-planner-vllm-test.yaml).
...
For more details, see [Global Router README](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/components/src/dynamo/global_router/README.md).
...
[Planner README](https://docs.nvidia.com/dynamo/v1.2.1/components/planner)— Planner overview and quick start[Planner Guide](https://docs.nvidia.com/dynamo/v1.2.1/components/planner/planner-guide)— Planner configuration reference[Planner Examples](https://docs.nvidia.com/dynamo/v1.2.1/components/planner/planner-examples)— DGDR examples for generating per-pool configs[Profiler Guide](https://docs.nvidia.com/dynamo/v1.2.1/components/profiler/profiler-guide)— Pre-deployment profiling workflow[Global Planner README](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/components/src/dynamo/global_planner/README.md)— Centralized scale execution[Global Router README](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/components/src/dynamo/global_router/README.md)— Cross-pool request routing[vLLM global planner example](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/examples/global_planner/global-planner-vllm-test.yaml)— End-to-end reference manifest