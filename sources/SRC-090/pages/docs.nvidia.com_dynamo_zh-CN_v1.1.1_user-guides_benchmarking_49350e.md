source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/user-guides/benchmarking
...
→ [Go to Client-Side Benchmarking (Local)](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/benchmarking#client-side-benchmarking-local)
...
→ [Go to Server-Side Benchmarking (In-Cluster)](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/benchmarking#server-side-benchmarking-in-cluster)
...
Set up your Kubernetes cluster with NVIDIA GPUs and install the Dynamo Kubernetes Platform following the [installation guide](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/installation-guide). Then deploy your DynamoGraphDeployments using the [deployment documentation](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends).
...
**Kubernetes cluster**with NVIDIA GPUs and Dynamo namespace setup (see[Dynamo Kubernetes Platform docs](https://docs.nvidia.com/dynamo/v1.1.1/getting-started/kubernetes-deployment))**Storage**: PersistentVolumeClaim configured with appropriate permissions (see[deploy/utils README](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/deploy/utils/README.md))**Docker image**containing AIPerf (Dynamo runtime images include it)
