source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/user-guides/fault-tolerance/graceful-shutdown
...
- See
[Request Migration Architecture](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/fault-tolerance/request-migration)for details on how migration works
