source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/backends/sg-lang/diffusion
lastmod: 2026-09-23T23:30:39.914Z

# Diffusion

SGLang supports LLM diffusion, image diffusion, and text-to-video generation through dedicated worker flags.
...
without needing a separate flag. For more details on diffusion algorithms, see the [SGLang Diffusion Language Models documentation](https://github.com/sgl-project/sglang/blob/main/docs_new/docs/supported-models/diffusion_language_models.mdx).

### Launch

See the [launch script](https://github.com/ai-dynamo/dynamo/tree/v1.3.0/examples/backends/sglang/launch/diffusion_llada.sh) for configuration options.
...
: Launch scripts for all deployment patterns[Examples](https://docs.nvidia.com/dynamo/v1.3.0/backends/sg-lang/examples): Worker types and argument reference[Reference Guide](https://docs.nvidia.com/dynamo/v1.3.0/backends/sg-lang/reference-guide): SGLang diffusion documentation[SGLang Diffusion LMs (upstream)](https://github.com/sgl-project/sglang/blob/main/docs_new/docs/supported-models/diffusion_language_models.mdx)