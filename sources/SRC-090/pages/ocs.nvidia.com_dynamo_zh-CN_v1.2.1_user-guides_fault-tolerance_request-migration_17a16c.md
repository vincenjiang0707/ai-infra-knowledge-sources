source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/user-guides/fault-tolerance/request-migration
...
For more information on Dynamo metrics, see the [Metrics documentation](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/observability-local/metrics).
