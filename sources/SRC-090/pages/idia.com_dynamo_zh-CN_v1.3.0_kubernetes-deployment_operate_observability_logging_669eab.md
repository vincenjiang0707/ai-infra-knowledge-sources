source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/kubernetes-deployment/operate/observability/logging
lastmod: 2026-09-23T23:30:39.914Z

# Logging

Aggregates Dynamo logs on Kubernetes with Grafana Loki and Alloy for cluster-wide log querying.
...
This guide assumes you have installed Dynamo Kubernetes Platform. For more information, see [Dynamo Kubernetes Platform](https://docs.nvidia.com/dynamo/v1.3.0/kubernetes-deployment/start-here/kubernetes-quickstart).
