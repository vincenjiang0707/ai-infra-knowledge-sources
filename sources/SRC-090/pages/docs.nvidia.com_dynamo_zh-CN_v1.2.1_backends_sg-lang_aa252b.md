source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/backends/sg-lang
...
). See[CUDA Requirements](https://docs.nvidia.com/dynamo/v1.2.1/getting-started/local-installation#system-requirements). Not required when running the pre-built`sglang-runtime`
...
image from NGC. See [release artifacts](https://docs.nvidia.com/dynamo/v1.2.1/resources/release-artifacts) for the current tag and CUDA variants.
...
. For a Kubernetes deployment example, see [ disagg-multinode.yaml](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/examples/backends/sglang/deploy/disagg-multinode.yaml).

### Kubernetes Deployment

You can deploy SGLang with Dynamo on Kubernetes using a `DynamoGraphDeployment`

. For more details, see the [SGLang Kubernetes Deployment Guide](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/examples/backends/sglang/deploy).

## Next Steps

: Worker types, architecture, and configuration[Reference Guide](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/reference-guide): All deployment patterns with launch scripts[Examples](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/examples): P/D architecture and KV transfer details[Disaggregation](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/disaggregation): LLM, image, and video diffusion models[Diffusion](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/diffusion): Metrics, tracing, and Grafana dashboards[Observability](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/observability): Kubernetes deployment guide[Deploying SGLang with Dynamo on Kubernetes](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/examples/backends/sglang/deploy)