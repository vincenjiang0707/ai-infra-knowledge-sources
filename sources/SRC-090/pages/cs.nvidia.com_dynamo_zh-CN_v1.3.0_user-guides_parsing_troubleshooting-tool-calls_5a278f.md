source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/user-guides/parsing/troubleshooting-tool-calls
...
[Tool Call Parsing (Dynamo)](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/parsing/tool-call-parsing-dynamo)— Dynamo-native parser names and request examples[Parser Engine Fallback](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/parsing/parser-engine-fallback)—`--dyn-chat-processor`

fallback path to vLLM and SGLang parsers[Frontend Configuration Reference](https://docs.nvidia.com/dynamo/v1.3.0/components/frontend/configuration-reference)— full CLI flag reference for the frontend and worker