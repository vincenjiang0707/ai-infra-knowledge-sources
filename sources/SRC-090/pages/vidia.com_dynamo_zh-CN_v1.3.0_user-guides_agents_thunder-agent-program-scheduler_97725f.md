source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/user-guides/agents/thunder-agent-program-scheduler
...
For per-request tracing (token counts, cache hits, worker placement), the router also integrates with [Agent Tracing](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/agents/agent-tracing#enable-output): set `DYN_REQUEST_TRACE=1`
...
[Router Guide](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/kv-cache-aware-routing) [Session IDs](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/agents/session-i-ds),[Agent Tracing](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/agents/agent-tracing), and[Agent Hints](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/agents/agent-hints)