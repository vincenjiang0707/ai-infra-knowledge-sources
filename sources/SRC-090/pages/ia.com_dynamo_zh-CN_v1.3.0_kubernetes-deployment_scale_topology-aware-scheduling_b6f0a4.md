source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/kubernetes-deployment/scale/topology-aware-scheduling
...
TAS controls pod placement. To constrain or bias the Dynamo router’s prefill-to-decode handoff after pods are already running, see [Topology-Aware KV Transfer](https://docs.nvidia.com/dynamo/v1.3.0/kubernetes-deployment/operate/topology-aware-kv-transfer).
