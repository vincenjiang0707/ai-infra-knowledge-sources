source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/modular-components/backends/sg-lang/chat-processor
...
: General tool calling guide[Tool Calling](https://docs.nvidia.com/dynamo/parsing/tool-call-parsing): Full SGLang backend reference[Reference Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/backends/sg-lang/reference-guide): Priority scheduling and KV cache tuning[Agentic Workloads](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/backends/sg-lang/agents-on-sg-lang)