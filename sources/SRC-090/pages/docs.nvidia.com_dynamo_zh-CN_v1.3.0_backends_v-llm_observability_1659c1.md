source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/backends/v-llm/observability
...
**For LMCache metrics and integration**, see the [LMCache Integration Guide](https://docs.nvidia.com/dynamo/v1.3.0/integrations/kv-cache-integrations/lm-cache).
...
[LMCache Integration Guide](https://docs.nvidia.com/dynamo/v1.3.0/integrations/kv-cache-integrations/lm-cache)- Setup and configuration[LMCache Observability Documentation](https://docs.lmcache.ai/mp/observability.html)- Complete metrics reference
