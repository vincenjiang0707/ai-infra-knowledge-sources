source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/kubernetes-deployment/cloud-provider-guides/aws/eks-setup
...
Follow the [EFS setup guide](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/cloud-provider-guides/aws/efs) to create an EFS file system and make it available as shared storage for Dynamo workloads.
...
instances, which support GPUDirect RDMA, and uses the Dynamo EFA-enabled vLLM container `nvcr.io/nvidia/ai-dynamo/vllm-runtime:1.2.0-efa-amd64`
...
Cleanup EFS related resources, follow the [EFS setup guide](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/cloud-provider-guides/aws/efs#cleanup) cleanup section
