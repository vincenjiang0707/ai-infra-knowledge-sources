source: https://docs.nvidia.com/dynamo/zh-CN/dev/knowledge-base/concepts/simulation/kubernetes-mocker
...
[Simulate a Local Deployment](https://docs.nvidia.com/dynamo/dev/knowledge-base/concepts/simulation/local-mocker). For configuration details, see the
[Mocker CLI Reference](https://docs.nvidia.com/dynamo/dev/reference/components/mocker-cli-reference). For implementation details,
see [Mocker Engine Architecture](https://docs.nvidia.com/dynamo/dev/knowledge-base/modular-components/backends/mocker/mocker-engine-architecture).
...
[Mocker CLI Reference](https://docs.nvidia.com/dynamo/dev/reference/components/mocker-cli-reference). - Enable the Planner to test scaling behavior with simulated workers.
- Compare the simulation with a real-GPU deployment by using
[Benchmarking with AIPerf](https://docs.nvidia.com/dynamo/dev/kubernetes/operations/benchmarking-with-ai-perf).
