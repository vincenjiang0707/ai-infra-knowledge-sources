source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/kubernetes-deployment/cloud-provider-guides/aws/efs
...
[EKS guide](https://docs.nvidia.com/dynamo/v1.3.0/kubernetes-deployment/cloud-provider-guides/aws/eks-setup) - Environment variables set:
