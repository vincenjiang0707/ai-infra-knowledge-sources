source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/modular-components/profiler/profiler-examples
...
No DGDR override is required. The operator injects the Secret’s `HF_TOKEN`
