source: https://docs.nvidia.com/dynamo/zh-CN/kubernetes/installation/model-storage/efs
...
[EKS guide](https://docs.nvidia.com/dynamo/kubernetes/installation/managed-kubernetes/eks/eks-setup) - Environment variables set:
