source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/user-guides/disaggregated-serving/sizing-with-ai-configurator
...
and deployment-path overview, start with [Disaggregated Serving](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/disaggregated-serving).
...
tuning replica counts. See [Disaggregated Serving](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/disaggregated-serving#deploying-disaggregated-with-rdma)
...
[per-system CSV files](https://github.com/ai-dynamo/aiconfigurator/tree/main/aic-core/src/aiconfigurator_core/systems/support_matrix), which are automatically generated and tested to ensure accuracy across all supported configurations.
...
- See
[Dynamo Kubernetes Guide](https://docs.nvidia.com/dynamo/v1.3.0/kubernetes-deployment/start-here/kubernetes-quickstart)for platform setup
...
[Disaggregated Serving](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/disaggregated-serving#deploying-disaggregated-with-rdma)for the deployment pattern and verification steps.
