source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/user-guides/fault-tolerance
...
See [Request Migration](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/fault-tolerance/request-migration) for details.
...
See [Request Cancellation](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/fault-tolerance/request-cancellation) for details.
...
See [Graceful Shutdown](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/fault-tolerance/graceful-shutdown) for details.
...
See [Request Rejection](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/fault-tolerance/request-rejection) for details.
...
See [Fault Tolerance Testing](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/fault-tolerance/testing) for details.

## Related Documentation

[Observability](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/observability-local)- Metrics and monitoring[Shadow Engine Failover](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/shadow-engine-failover)- Same-node active/passive engine failover for Kubernetes deployments[Distributed Runtime](https://docs.nvidia.com/dynamo/v1.1.1/design-docs/distributed-runtime)- Service discovery architecture[Event Plane](https://docs.nvidia.com/dynamo/v1.1.1/design-docs/communication-planes/event-plane)- Pub/sub for KV cache events and worker metrics[Discovery Plane](https://docs.nvidia.com/dynamo/v1.1.1/design-docs/communication-planes/discovery-plane)- Service discovery and coordination