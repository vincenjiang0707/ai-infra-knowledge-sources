source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/kubernetes-deployment/start-here/minikube-setup
...
Once your local environment is set up, you can proceed with the [Dynamo Kubernetes Platform installation guide](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/start-here/installation-guide) to deploy the platform to your local cluster.