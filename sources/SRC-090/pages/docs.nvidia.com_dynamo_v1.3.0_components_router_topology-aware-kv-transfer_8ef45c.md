source: https://docs.nvidia.com/dynamo/v1.3.0/components/router/topology-aware-kv-transfer
...
For deployment examples, see [Kubernetes Topology-Aware KV Transfer](https://docs.nvidia.com/dynamo/v1.3.0/kubernetes-deployment/operate/topology-aware-kv-transfer).
...
[Verify the Deployment](https://docs.nvidia.com/dynamo/v1.3.0/kubernetes-deployment/operate/topology-aware-kv-transfer#verify-the-deployment).