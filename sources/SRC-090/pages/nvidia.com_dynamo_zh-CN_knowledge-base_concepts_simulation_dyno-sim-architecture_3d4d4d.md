source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/concepts/simulation/dyno-sim-architecture
...
For task-oriented instructions, see [Run a DynoSim Simulation](https://docs.nvidia.com/dynamo/cli/operations/dynosim/simulation-runs),
[Sweep DynoSim Configurations](https://docs.nvidia.com/dynamo/cli/operations/dynosim/simulation-sweeps), and
[Benchmark Planner Decisions](https://docs.nvidia.com/dynamo/kubernetes/operations/dynosim/planner-simulation-benchmarking). For engine-core details, see
[Mocker Engine Architecture](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/backends/mocker/mocker-engine-architecture).
...
, the loader reconstructs session dependencies and tool waits. It rejects mixed traces
...
explicitly when cumulative GPU-hours are
