source: https://docs.nvidia.com/dynamo/zh-CN/kubernetes/installation/managed-kubernetes/eks/ecs
...
### EC2 Cluster Setup (for vLLM workloads)
...
### Fargate Cluster Setup (for ETCD/NATS services)
...
### ETCD/NATS Task Definitions Setup
