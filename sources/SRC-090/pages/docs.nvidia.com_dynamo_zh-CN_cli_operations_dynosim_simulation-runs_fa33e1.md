source: https://docs.nvidia.com/dynamo/zh-CN/cli/operations/dynosim/simulation-runs
...
[Sweep DynoSim Configurations](https://docs.nvidia.com/dynamo/cli/operations/dynosim/simulation-sweeps) to search more worker and topology combinations.
