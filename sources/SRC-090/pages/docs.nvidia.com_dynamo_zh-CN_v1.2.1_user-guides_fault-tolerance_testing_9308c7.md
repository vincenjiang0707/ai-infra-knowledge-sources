source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/user-guides/fault-tolerance/testing
...
after each test run. See [ tests/fault_tolerance/hardware/fault_injection_service/README.md](https://docs.nvidia.com/dynamo/v1.2.1/tests/fault_tolerance/hardware/fault_injection_service/README.md) for the full security posture.
