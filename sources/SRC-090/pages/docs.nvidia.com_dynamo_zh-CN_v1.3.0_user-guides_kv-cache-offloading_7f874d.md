source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/user-guides/kv-cache-offloading
...
For installation from source or custom builds, see [Local Installation](https://docs.nvidia.com/dynamo/v1.3.0/getting-started/local-installation) and [Release Artifacts](https://docs.nvidia.com/dynamo/v1.3.0/resources/release-artifacts).

## Run KVBM Standalone

KVBM can be used independently without using the rest of the Dynamo stack:

See the [support matrix](https://docs.nvidia.com/dynamo/v1.3.0/resources/support-matrix) for version compatibility.
...
See the [Local Installation Guide](https://docs.nvidia.com/dynamo/v1.3.0/getting-started/local-installation) for full setup instructions and [Release Artifacts](https://docs.nvidia.com/dynamo/v1.3.0/resources/release-artifacts#container-images) for available versions.
...
[KVBM Overview](https://docs.nvidia.com/dynamo/v1.3.0/components/kvbm)for a quick overview of KV Caching, KVBM and its architecture[KVBM Design](https://docs.nvidia.com/dynamo/v1.3.0/design-docs/component-design/kvbm-design)for a deep dive into KVBM architecture[LMCache Integration](https://docs.nvidia.com/dynamo/v1.3.0/integrations/kv-cache-integrations/lm-cache)[FlexKV Integration](https://docs.nvidia.com/dynamo/v1.3.0/integrations/kv-cache-integrations/flex-kv)[SGLang HiCache](https://docs.nvidia.com/dynamo/v1.3.0/integrations/kv-cache-integrations/hi-cache)