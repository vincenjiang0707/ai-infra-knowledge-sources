source: https://docs.nvidia.com/dynamo/cli/installation/install-dynamo
...
For production multi-node clusters, see the [Kubernetes Deployment Guide](https://docs.nvidia.com/dynamo/kubernetes/getting-started/quickstart). To build from source for development, see [Building from Source](https://docs.nvidia.com/dynamo/advanced-customizations/building-from-source).

## System Requirements

TensorRT-LLM does not support Python 3.11.

For the full compatibility matrix including backend framework versions, see the [Support Matrix](https://docs.nvidia.com/dynamo/reference/general/compatibility.mdx).
...
See [Release Artifacts](https://docs.nvidia.com/dynamo/reference/general/release-artifacts.mdx) for the complete artifact inventory.
...
mode nor a standalone etcd is used. See the [Discovery Plane](https://docs.nvidia.com/dynamo/knowledge-base/concepts/communication-planes/discovery-plane) design doc for the full picture.
...
to check your driver version. Dynamo requires driver 575.51.03+ for CUDA 12 or 580.00.03+ for CUDA 13. B300/GB300 GPUs require CUDA 13. See the [Support Matrix](https://docs.nvidia.com/dynamo/reference/general/compatibility.mdx) for full requirements.
...
[Backend Guides](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/backends/sg-lang/overview)— Backend-specific configuration and features[Disaggregated Serving](https://docs.nvidia.com/dynamo/kubernetes/disaggregated-serving/overview)— Scale prefill and decode independently[KV Cache Aware Routing](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/router/router-guide)— Smart request routing[Kubernetes Deployment](https://docs.nvidia.com/dynamo/kubernetes/getting-started/quickstart)— Production multi-node deployments