source: https://docs.nvidia.com/dynamo/zh-CN/cli/operations/dynosim/simulation-sweeps
...
local CLI deployment. Use a sweep after a single [DynoSim run](https://docs.nvidia.com/dynamo/cli/operations/dynosim/simulation-runs) works and you want to identify
...
[Run a DynoSim Simulation](https://docs.nvidia.com/dynamo/cli/operations/dynosim/simulation-runs). - Exercise the live frontend and router with
