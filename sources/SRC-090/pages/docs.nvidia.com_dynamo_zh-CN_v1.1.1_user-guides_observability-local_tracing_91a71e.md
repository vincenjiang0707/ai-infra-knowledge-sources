source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/user-guides/observability-local/tracing
...
; otherwise it defaults to the traces endpoint. See [Logging](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/observability-local/logging#otlp-log-export) for details.

This guide covers single GPU demo setup using Docker Compose. For Kubernetes deployments, see [Kubernetes Deployment](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/observability-local/tracing#kubernetes-deployment).

**Note:** This section has overlap with [Logging of OpenTelemetry Tracing](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/observability-local/logging) since OpenTelemetry has aspects of both logging and tracing. The tracing approach documented here is for persistent trace visualization and analysis. For short debugging sessions examining trace context directly in logs, see the [Logging](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/observability-local/logging) guide.
...
Start the observability stack (Prometheus, Grafana, Tempo, exporters). See [Observability Getting Started](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/observability-local#getting-started-quickly) for instructions.
...
When done, stop the observability stack. See [Observability Getting Started](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/observability-local#getting-started-quickly) for Docker Compose commands.
...
These add the [Environment Variables](https://docs.nvidia.com/dynamo/v1.1.1/user-guides/observability-local/tracing#environment-variables) to the base `agg.yaml`
