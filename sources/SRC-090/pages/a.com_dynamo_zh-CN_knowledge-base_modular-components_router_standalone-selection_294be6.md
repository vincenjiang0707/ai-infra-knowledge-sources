source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/modular-components/router/standalone-selection
...
remains available for compatibility and panics on
...
[per-instance tier breakdown](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/router/standalone-indexer#per-instance-tier-breakdown).
...
string. It defaults to absent. The built-in selector ignores it:
...
is an input to policy, not an affinity mechanism in itself. The
...
this API; see [Configuration and Tuning](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/router/configuration-and-tuning).
...
pending-selection cache, so a `POST /reservations`
