source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/components/kvbm
...
— Installation, configuration, and deployment instructions[KVBM Guide](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/kv-cache-offloading)— Architecture deep dive, components, and data flows[KVBM Design](https://docs.nvidia.com/dynamo/v1.2.1/design-docs/component-design/kvbm-design)— Use LMCache with Dynamo vLLM backend[LMCache Integration](https://docs.nvidia.com/dynamo/v1.2.1/integrations/kv-cache-integrations/lm-cache)— Use FlexKV for KV cache management[FlexKV Integration](https://docs.nvidia.com/dynamo/v1.2.1/integrations/kv-cache-integrations/flex-kv)— Enable SGLang’s hierarchical cache with NIXL[SGLang HiCache](https://docs.nvidia.com/dynamo/v1.2.1/integrations/kv-cache-integrations/hi-cache)— NIXL communication library details[NIXL Documentation](https://github.com/ai-dynamo/nixl/blob/main/docs/nixl.md)