source: https://docs.nvidia.com/dynamo/knowledge-base/modular-components/kvbm/overview
...
— Installation, configuration, and deployment instructions[KVBM Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/kvbm/kvbm-guide)— Architecture deep dive, components, and data flows[KVBM Design](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/kvbm/kvbm-design)— Compare KVBM with LMCache, FlexKV, and HiCache[KV Cache Offloading](https://docs.nvidia.com/dynamo/cli/kv-cache-offloading/overview)— Enable SGLang’s hierarchical cache with NIXL[SGLang HiCache](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/backends/sg-lang/hi-cache)— NIXL communication library details[NIXL Documentation](https://github.com/ai-dynamo/nixl/blob/main/docs/nixl.md)