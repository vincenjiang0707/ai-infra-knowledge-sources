source: https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/planner-guide
...
For a quick overview, see the [Planner overview](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/overview). For architecture internals, see [Planner Design](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/planner-design).
...
JSON/YAML object. When using the
profiler, place this under `spec.features.planner`

in the DGDR spec. Any
PlannerConfig field listed below can be set there; DGDR passes that object to
the Planner service for validation.

This section covers the most common fields. For every field, sub-object, default, and validation rule, see the [Planner Configuration reference](https://docs.nvidia.com/dynamo/reference/components/planner-configuration).
...
See the [Profiler Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/profiler/profiler-guide) for the full profiling workflow and how to configure pre-deployment sweeping.
...
In the current workflow, run profiling independently for each intended pool, then compose the final control DGD plus pool DGDs manually. See the [Global Planner Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/global-planner-guide).

## See Also

[Planner overview](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/overview)— Why LLM inference needs a different autoscaler[Planner Design](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/planner-design)— Architecture and algorithm internals[Planner Examples](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/planner-examples)— Planner-specific configuration examples[DGDR Templates](https://docs.nvidia.com/dynamo/recipes/kubernetes-templates/dgdr)— DGDR YAML examples, sample configurations, advanced patterns[Global Planner Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/global-planner-guide)— Multi-DGD coordination, shared GPU budgets, single-endpoint multi-pool deployments[Profiler Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/profiler/profiler-guide)— How profiling data is generated