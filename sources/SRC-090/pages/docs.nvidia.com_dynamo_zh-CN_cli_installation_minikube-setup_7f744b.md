source: https://docs.nvidia.com/dynamo/zh-CN/cli/installation/minikube-setup
...
Once your local environment is set up, you can proceed with the [Dynamo Kubernetes Platform installation guide](https://docs.nvidia.com/dynamo/kubernetes/installation/install-dynamo) to deploy the platform to your local cluster.