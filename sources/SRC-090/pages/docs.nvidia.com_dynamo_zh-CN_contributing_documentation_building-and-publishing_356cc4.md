source: https://docs.nvidia.com/dynamo/zh-CN/contributing/documentation/building-and-publishing
...
[Documentation Style Guide](https://docs.nvidia.com/dynamo/contributing/documentation/style-guide).
...
[Branch Architecture](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#branch-architecture)[Directory Layout](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#directory-layout)[Configuration Files](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#configuration-files)[GitHub Workflows](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#github-workflows)[Content Authoring](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#content-authoring)[Callout Conversion](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#callout-conversion)[Running Locally](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#running-locally)[Version Management](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#version-management)[How Publishing Works](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#how-publishing-works)[Common Tasks](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#common-tasks)[Claude Code Skills](https://docs.nvidia.com/dynamo/contributing/documentation/building-and-publishing#claude-code-skills)
...
the navigation in `docs/fern/index.yml`
...
directory is an immutable snapshot built from `docs/fern/pages/`

at
the corresponding Git tag. The matching `versions/vX.Y.Z.yml`

is built from
that tag’s `docs/fern/index.yml`
...
The product selector uses Fern’s `toggle`

theme to render Home, Docs, Blog, and
Community as a pill-shaped top-level navigation. Home, Blog, and Community each
use an unversioned config under `products/`

; only Docs has navigation tabs and a
version selector.

**Important:** On `main`

, the Docs product only lists the `dev`
...
Defines the tab and sidebar structure within the Docs product. Each entry maps a page title to a Markdown file path:

Paths are relative to the `docs/fern/`

directory and authored pages begin with `pages/`

. Sections can be nested. Pages can
...
and transforms paths (for example, `pages/cli/getting-started/X`

→
`../pages-dev/cli/getting-started/X`
...
**Triggers:** Pull requests that modify `docs/fern/**`
...
- Syncs assets, Digest posts, the Home page, and
`products/*.yml`
...
, and`scripts/convert_callouts.py`

) - Runs
`scripts/convert_callouts.py`
...
while preserving the Docs product’s release-managed path and versions from`docs-website`
...
from the tag’s`docs/fern/pages/`

tree - Rewrites GitHub links in the snapshot:
`github.com/ai-dynamo/dynamo/tree/v1.4.2`

→`tree/vX.Y.Z`

`github.com/ai-dynamo/dynamo/blob/v1.4.2`
...
from the tag’s`docs/fern/index.yml`
...
Place images in `docs/fern/assets/`
...
React components in `docs/fern/components/`
...
The `docs/fern/scripts/convert_callouts.py`
...
to validate that `docs/fern/docs.yml`
...
branch).**An entry in**— tells Fern about the version’s display name, slug, and config path.`docs/fern/docs.yml`
...
(for example,`docs/fern/pages/new-section/`

). - Add markdown files for each page.
- Add a new
`- section:`

block in`docs/fern/index.yml`
...
.**Invalid YAML:**Check`docs/fern/docs.yml`

or`docs/fern/index.yml`
