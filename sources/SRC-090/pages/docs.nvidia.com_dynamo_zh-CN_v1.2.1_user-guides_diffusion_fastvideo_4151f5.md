source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/user-guides/diffusion/fastvideo
...
Dynamo also supports diffusion through built-in backends: [SGLang Diffusion](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/diffusion) (LLM diffusion, image, video), [vLLM-Omni](https://docs.nvidia.com/dynamo/v1.2.1/backends/v-llm/v-llm-omni) (text-to-image, text-to-video), and [TRT-LLM Diffusion](https://docs.nvidia.com/dynamo/v1.2.1/backends/tensor-rt-llm/diffusion-experimental) (text-to-image, text-to-video). See the [Diffusion Overview](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/diffusion) for the full support matrix.
...
When using Kubernetes, mount a shared Hugging Face cache PVC (see [Kubernetes Deployment](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/diffusion/fastvideo#kubernetes-deployment)) so model weights are downloaded once and reused across pod restarts.
...
. See the [Docker Image Build](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/diffusion/fastvideo#docker-image-build) section for build time expectations.
...
If this is the first request after startup, expect it to take longer while warmup completes. See [Warmup Time](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/diffusion/fastvideo#warmup-time) for details.
...
[vLLM-Omni Text-to-Video](https://docs.nvidia.com/dynamo/v1.2.1/backends/v-llm/v-llm-omni#text-to-video)— vLLM-Omni video generation via`/v1/videos`

[vLLM-Omni Text-to-Image](https://docs.nvidia.com/dynamo/v1.2.1/backends/v-llm/v-llm-omni#text-to-image)— vLLM-Omni image generation[SGLang Video Generation](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/diffusion#video-generation)— SGLang video generation worker[SGLang Image Diffusion](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/diffusion#image-diffusion)— SGLang image diffusion worker[TRT-LLM Diffusion](https://docs.nvidia.com/dynamo/v1.2.1/backends/tensor-rt-llm/diffusion-experimental#quick-start)— TensorRT-LLM diffusion quick start[Diffusion Overview](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/diffusion)— Full backend support matrix