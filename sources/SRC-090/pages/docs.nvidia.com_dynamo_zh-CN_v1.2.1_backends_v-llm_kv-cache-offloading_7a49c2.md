source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/backends/v-llm/kv-cache-offloading
...
[KVBM](https://docs.nvidia.com/dynamo/v1.2.1/components/kvbm) (KV Block Manager) is Dynamo’s built-in KV cache offloading system. It provides a three-layer architecture (LLM runtime, logical block management, NIXL transport) with support for CPU and disk cache tiers, and integrates natively with Dynamo’s KV-aware routing and disaggregated serving.

For configuration details, see the [KVBM Guide](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/kv-cache-offloading).
...
For configuration details, see the [LMCache Integration Guide](https://docs.nvidia.com/dynamo/v1.2.1/integrations/kv-cache-integrations/lm-cache).
...
For configuration details, see the [FlexKV Integration Guide](https://docs.nvidia.com/dynamo/v1.2.1/integrations/kv-cache-integrations/flex-kv).

## See Also

: Architecture and design of Dynamo’s built-in KV cache offloading[KVBM Design](https://docs.nvidia.com/dynamo/v1.2.1/design-docs/component-design/kvbm-design): Routing requests based on KV cache state[Routing Concepts](https://docs.nvidia.com/dynamo/v1.2.1/components/router/routing-concepts): Prefill/decode separation architecture[Disaggregated Serving](https://docs.nvidia.com/dynamo/v1.2.1/design-docs/disaggregated-serving)