source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/kubernetes-deployment/observability-k-8-s/operator-metrics
...
The operator metrics feature requires the same monitoring infrastructure as application metrics. For detailed setup instructions, see the [Kubernetes Metrics Guide](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/observability-k-8-s/metrics#prerequisites).
...
For instructions on accessing Prometheus and Grafana, see the [Kubernetes Metrics Guide](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/observability-k-8-s/metrics#viewing-the-metrics).
...
[Kubernetes Metrics Guide](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/observability-k-8-s/metrics)- Application metrics for frontends and workers[Dynamo Operator Guide](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/dynamo-operator)- Operator architecture and deployment modes[Operator Webhooks](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/webhooks)- Webhook validation details