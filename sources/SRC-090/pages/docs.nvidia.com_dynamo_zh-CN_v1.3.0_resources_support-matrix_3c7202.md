source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/resources/support-matrix
lastmod: 2026-09-23T23:30:39.914Z

# Support Matrix

**See also:** [Release Artifacts](https://docs.nvidia.com/dynamo/v1.3.0/resources/release-artifacts) for container images, wheels, Helm charts, and crates | [Feature Matrix](https://docs.nvidia.com/dynamo/v1.3.0/resources/feature-matrix) for backend feature support

## At a Glance

**Latest stable release:** [v1.3.0](https://github.com/ai-dynamo/dynamo/releases/tag/v1.3.0) — SGLang `0.5.14`
...
) are listed in [Model Early Access Builds](https://docs.nvidia.com/dynamo/v1.3.0/resources/model-early-access-builds); platform previews under [Early Access Artifacts](https://docs.nvidia.com/dynamo/v1.3.0/resources/release-artifacts#early-access-artifacts).

**On this page:** [Backend Dependencies](https://docs.nvidia.com/dynamo/v1.3.0/resources/support-matrix#backend-dependencies) | [CUDA and Drivers](https://docs.nvidia.com/dynamo/v1.3.0/resources/support-matrix#cuda-and-driver-requirements) | [Hardware](https://docs.nvidia.com/dynamo/v1.3.0/resources/support-matrix#hardware-compatibility) | [Platform](https://docs.nvidia.com/dynamo/v1.3.0/resources/support-matrix#platform-architecture-compatibility) | [Cloud](https://docs.nvidia.com/dynamo/v1.3.0/resources/support-matrix#cloud-service-provider-compatibility) | [Build Support](https://docs.nvidia.com/dynamo/v1.3.0/resources/support-matrix#build-support)
...
on the corresponding release branch (pins used to build images). Those lines are **early access builds with partial coverage**: not every backend has a published Dynamo runtime container for that tag. See [Early Access Artifacts](https://docs.nvidia.com/dynamo/v1.3.0/resources/release-artifacts#early-access-artifacts) and [Model Early Access Builds](https://docs.nvidia.com/dynamo/v1.3.0/resources/model-early-access-builds) for what actually shipped. The `v1.2.0-deepseek-v4-dev.2`
...
*(early access, partial)*are early access builds: the table shows branch build pins, which may include backends with no NGC image for that dev tag yet. - Releases marked
...
Experimental CUDA 13 images are not published for all versions. Check [Release Artifacts](https://docs.nvidia.com/dynamo/v1.3.0/resources/release-artifacts) for availability.

For detailed artifact versions and NGC links (including container images, Python wheels, Helm charts, and Rust crates), see the [Release Artifacts](https://docs.nvidia.com/dynamo/v1.3.0/resources/release-artifacts) page.
...
Dynamo provides multi-arch container images supporting both AMD64 (x86_64) and ARM64 architectures. See [Release Artifacts](https://docs.nvidia.com/dynamo/v1.3.0/resources/release-artifacts) for available images.
...
For version-specific artifact details, installation commands, and release history, see [Release Artifacts](https://docs.nvidia.com/dynamo/v1.3.0/resources/release-artifacts).
...
-
**Rust Crates**:[dynamo-runtime](https://docs.rs/dynamo-runtime/)[dynamo-llm](https://docs.rs/dynamo-llm/)[dynamo-protocols](https://docs.rs/dynamo-protocols/)[dynamo-parsers](https://docs.rs/dynamo-parsers/)[dynamo-config](https://docs.rs/dynamo-config/)*(New in v0.8.0)*[dynamo-memory](https://docs.rs/dynamo-memory/)*(New in v0.8.0)*[dynamo-tokens](https://docs.rs/dynamo-tokens/)*(New in v0.9.0)*[dynamo-mocker](https://docs.rs/dynamo-mocker/)*(New in v1.0.0)*[dynamo-kv-router](https://docs.rs/dynamo-kv-router/)*(New in v1.0.0)*
