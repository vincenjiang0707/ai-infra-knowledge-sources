source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/user-guides/observability-local/logging
...
The local observability stack (see [Getting Started](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/observability-local#getting-started-quickly)) includes an OpenTelemetry Collector that receives OTLP on `localhost:4317`
