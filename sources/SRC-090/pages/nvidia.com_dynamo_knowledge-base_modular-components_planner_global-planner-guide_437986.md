source: https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/global-planner-guide
...
[Kubernetes Quickstart](https://docs.nvidia.com/dynamo/kubernetes/getting-started/quickstart). - Prometheus deployed and scraping router metrics. The global planner examples assume cluster Prometheus is available.
...
For SLA throughput-based scaling, each pool needs either native AIC support, optional bootstrap profiling data, or enough live FPM observations to warm the fallback model. See [Profiler Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/profiler/profiler-guide).
...
See [DGDR Templates](https://docs.nvidia.com/dynamo/recipes/kubernetes-templates/dgdr) and [Profiler Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/profiler/profiler-guide) for DGDR details.
...
. See [examples/global_planner/global-planner-gpu-budget.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/examples/global_planner/global-planner-gpu-budget.yaml).
...
. See the [Planner overview](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/overview#prometheus-metrics) for the exact frontend and router metric sources.
...
[Planner README](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/overview)— Planner overview and quick start[Planner Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/planner/planner-guide)— Planner configuration reference[DGDR Templates](https://docs.nvidia.com/dynamo/recipes/kubernetes-templates/dgdr)— DGDR examples for generating per-pool configs[Profiler Guide](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/profiler/profiler-guide)— Pre-deployment profiling workflow[Global Planner README](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/components/src/dynamo/global_planner/README.md)— Centralized scale execution[Global Router README](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/components/src/dynamo/global_router/README.md)— Cross-pool request routing[vLLM global planner example](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/examples/global_planner/global-planner-vllm-test.yaml)— End-to-end reference manifest