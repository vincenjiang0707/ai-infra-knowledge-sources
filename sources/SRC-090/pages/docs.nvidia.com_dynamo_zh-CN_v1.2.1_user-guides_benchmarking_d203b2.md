source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/user-guides/benchmarking
...
→ [Go to Client-Side Benchmarking (Local)](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/benchmarking#client-side-benchmarking-local)
...
→ [Go to Server-Side Benchmarking (In-Cluster)](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/benchmarking#server-side-benchmarking-in-cluster)
...
Set up your Kubernetes cluster with NVIDIA GPUs and install the Dynamo Kubernetes Platform following the [installation guide](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/start-here/installation-guide). Then deploy your `DynamoGraphDeployment`
...
[Deployment Overview](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/deploy-models/model-deployment-guide) or the backend
...
**Kubernetes cluster**with NVIDIA GPUs and Dynamo namespace setup (see[Dynamo Kubernetes Platform docs](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/start-here/kubernetes-quickstart))**Storage**: PersistentVolumeClaim configured with appropriate permissions (see[deploy/utils README](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/deploy/utils/README.md))**Docker image**containing AIPerf (Dynamo runtime images include it)
...
Mocker is the live simulated engine in DynoSim: it mimics the API and behavior of real backends (SGLang, TensorRT-LLM, vLLM) but generates mock responses instead of running actual inference. Use [DynoSim Runs](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/dynosim/runs) for one simulated workload/config trial and [DynoSim Sweeps](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/dynosim/sweeps) when you want to search across many candidate configurations.

See [Live Simulation with Mocker](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/dynosim/mocker) for usage examples and configuration options.
