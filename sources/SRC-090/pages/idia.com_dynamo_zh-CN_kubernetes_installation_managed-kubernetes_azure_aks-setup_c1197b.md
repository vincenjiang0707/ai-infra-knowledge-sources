source: https://docs.nvidia.com/dynamo/zh-CN/kubernetes/installation/managed-kubernetes/azure/aks-setup
...
Add a GPU-enabled node pool with driver installation skipped. The `--gpu-driver None`
...
. See the [RDMA / InfiniBand guide](https://docs.nvidia.com/dynamo/kubernetes/installation/rdma-setup/infiniband-on-azure) for the additional setup required on those nodes.
...
If you need RDMA / InfiniBand for disaggregated inference, **do not install the GPU Operator yet** — the RDMA setup requires different Helm values. See [RDMA / InfiniBand](https://docs.nvidia.com/dynamo/kubernetes/installation/rdma-setup/infiniband-on-azure) for the full setup, which includes the correct GPU Operator install command.

### Install Dynamo

Follow the [Installation Guide](https://docs.nvidia.com/dynamo/kubernetes/installation/install-dynamo) to install the Dynamo Platform and deploy your first model.

## Additional Guides

[RDMA / InfiniBand](https://docs.nvidia.com/dynamo/kubernetes/installation/rdma-setup/infiniband-on-azure)
...
[Storage for Model Caching](https://docs.nvidia.com/dynamo/kubernetes/installation/model-storage/aks-storage)
...
[Azure Lustre CSI Driver](https://docs.nvidia.com/dynamo/kubernetes/installation/model-storage/azure-lustre-csi-driver)
...
[Spot VMs](https://docs.nvidia.com/dynamo/kubernetes/installation/managed-kubernetes/azure/spot-vms)
