source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/kubernetes-deployment/deployment-guide/managing-models-with-dynamo-model
...
For complete setup including DGD configuration, see [Integration with DynamoGraphDeployment](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/managing-models-with-dynamo-model#integration-with-dynamographdeployment).
...
For detailed status monitoring, see [Monitoring & Operations](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/managing-models-with-dynamo-model#monitoring--operations).
...
📖 [DynamoModel API Reference](https://docs.nvidia.com/dynamo/v1.1.1/additional-resources/api-reference-k-8-s#dynamomodel)
...
For detailed status usage, see the [Monitoring & Operations](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/managing-models-with-dynamo-model#monitoring--operations) section below
...
- Try the
[Quick Start](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/managing-models-with-dynamo-model#quick-start)example - Explore
[Common Use Cases](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/managing-models-with-dynamo-model#common-use-cases) - Check the
[API Reference](https://docs.nvidia.com/dynamo/v1.1.1/additional-resources/api-reference-k-8-s#dynamomodel)for advanced configuration