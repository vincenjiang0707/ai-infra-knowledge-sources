source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/backends/sg-lang/observability
...
**For Dynamo runtime metrics**, see the [Dynamo Metrics Guide](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/observability-local/metrics).
...
The Planner subscribes to FPM via the NATS event plane. See the [Planner Guide](https://docs.nvidia.com/dynamo/v1.3.0/components/planner/planner-guide) for configuration (`load_adjustment_interval`
...
For the full motivation and design rationale, see the [Forward Pass Metrics RFC](https://docs.nvidia.com/dynamo/v1.3.0/proposals/vllm-rfc-forward-pass-metrics.md).
...
For more details on the Tempo/Grafana tracing infrastructure, see the [Dynamo Tracing Guide](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/observability-local/tracing).
...
[Dynamo Metrics Guide](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/observability-local/metrics)- Complete documentation on Dynamo runtime metrics[Dynamo Tracing Guide](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/observability-local/tracing)- Distributed tracing with OpenTelemetry and Tempo[Prometheus and Grafana Setup](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/observability-local/prometheus-grafana-setup)- Visualization setup instructions- Dynamo runtime metrics (prefixed with
`dynamo_*`
