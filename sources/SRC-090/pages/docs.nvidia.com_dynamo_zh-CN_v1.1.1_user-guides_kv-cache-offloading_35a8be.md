source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/user-guides/kv-cache-offloading
...
See the [support matrix](https://docs.nvidia.com/dynamo/v1.1.1/resources/support-matrix) for version compatibility.

### Build from Source

To build KVBM from source, see the detailed instructions in the [KVBM bindings README](https://github.com/ai-dynamo/dynamo/tree/v1.1.1/lib/bindings/kvbm/README.md#build-from-source).
...
See the [Local Installation Guide](https://docs.nvidia.com/dynamo/v1.1.1/getting-started/local-installation) for full setup instructions and [Release Artifacts](https://docs.nvidia.com/dynamo/v1.1.1/resources/release-artifacts#container-images) for available versions.
...
[KVBM Overview](https://docs.nvidia.com/dynamo/v1.1.1/components/kvbm)for a quick overview of KV Caching, KVBM and its architecture[KVBM Design](https://docs.nvidia.com/dynamo/v1.1.1/design-docs/component-design/kvbm-design)for a deep dive into KVBM architecture[LMCache Integration](https://docs.nvidia.com/dynamo/v1.1.1/integrations/lm-cache)[FlexKV Integration](https://docs.nvidia.com/dynamo/v1.1.1/integrations/flex-kv)[SGLang HiCache](https://docs.nvidia.com/dynamo/v1.1.1/integrations/sg-lang-hi-cache)