source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/kubernetes-deployment/advanced-platform/shadow-engine-failover
...
This is separate from [Dynamo Snapshot](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/advanced-platform/snapshot). Snapshot captures and
...
See the [API reference](https://docs.nvidia.com/dynamo/v1.2.1/additional-resources/api-reference-k-8-s) for the exact schema supported by your
CRD version.
...
See the [vLLM failover example](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/examples/backends/vllm/deploy/agg_failover.yaml)
