source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/backends/tensor-rt-llm/observability
...
Additional performance metrics are available via non-Prometheus APIs (see [Non-Prometheus Performance Metrics](https://docs.nvidia.com/dynamo/v1.3.0/backends/tensor-rt-llm/observability#non-prometheus-performance-metrics) below).
