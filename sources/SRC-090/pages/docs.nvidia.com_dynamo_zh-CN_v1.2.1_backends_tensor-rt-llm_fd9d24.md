source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/backends/tensor-rt-llm
...
Source of truth: [ docs/reference/support-matrix.md](https://docs.nvidia.com/dynamo/v1.2.1/resources/support-matrix#cuda-and-driver-requirements) and

[. If those differ from the values above, the source-of-truth files win.](https://docs.nvidia.com/dynamo/v1.2.1/resources/release-artifacts)
...
: Features, configuration, and operational details[Reference Guide](https://docs.nvidia.com/dynamo/v1.2.1/backends/tensor-rt-llm/reference-guide): All deployment patterns with launch scripts[Examples](https://docs.nvidia.com/dynamo/v1.2.1/backends/tensor-rt-llm/examples): KV cache transfer methods for disaggregated serving[KV Cache Transfer](https://docs.nvidia.com/dynamo/v1.2.1/additional-resources/tensor-rt-llm-details/kv-cache-transfer): Metrics and monitoring[Observability](https://docs.nvidia.com/dynamo/v1.2.1/backends/tensor-rt-llm/observability): Multi-node deployment with SLURM[Multinode Examples](https://docs.nvidia.com/dynamo/v1.2.1/additional-resources/tensor-rt-llm-details/multinode-examples): Kubernetes deployment guide[Deploying TensorRT-LLM with Dynamo on Kubernetes](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/examples/backends/trtllm/deploy/README.md)