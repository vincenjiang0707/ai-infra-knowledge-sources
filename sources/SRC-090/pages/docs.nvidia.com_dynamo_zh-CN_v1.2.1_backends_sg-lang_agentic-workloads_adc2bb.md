source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/backends/sg-lang/agentic-workloads
...
This guide covers SGLang-specific configuration for agentic serving with Dynamo. It explains which SGLang engine flags to enable, how Dynamo’s [agent hints](https://docs.nvidia.com/dynamo/v1.2.1/additional-resources/nvidia-request-extensions-nvext#agent-hints) map to SGLang behavior, and how to use session control to manage KV cache for multi-turn agent conversations.
...
Dynamo’s agent hints give the router per-request metadata. SGLang’s engine flags control how that metadata affects scheduling and eviction on the worker. For the cross-layer Dynamo priority semantics, see [Priority Scheduling](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/agents/priority-scheduling).
...
; see
[Router Configuration and Tuning](https://docs.nvidia.com/dynamo/v1.2.1/components/router/configuration-and-tuning#routing-behavior).
...
: Full[NVIDIA Request Extensions (nvext)](https://docs.nvidia.com/dynamo/v1.2.1/additional-resources/nvidia-request-extensions-nvext)`nvext`
