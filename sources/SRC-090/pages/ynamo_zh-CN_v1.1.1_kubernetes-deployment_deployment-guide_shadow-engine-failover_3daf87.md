source: https://docs.nvidia.com/dynamo/zh-CN/v1.1.1/kubernetes-deployment/deployment-guide/shadow-engine-failover
...
This is separate from [Dynamo Snapshot](https://docs.nvidia.com/dynamo/v1.1.1/kubernetes-deployment/deployment-guide/snapshot). Snapshot captures and
...
See the [API reference](https://docs.nvidia.com/dynamo/v1.1.1/additional-resources/api-reference-k-8-s) for the exact schema supported by your
CRD version.
...
See the [vLLM failover example](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/deploy/agg_failover.yaml)
