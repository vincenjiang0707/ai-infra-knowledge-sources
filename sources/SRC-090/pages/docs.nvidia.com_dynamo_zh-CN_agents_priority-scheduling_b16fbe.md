source: https://docs.nvidia.com/dynamo/zh-CN/agents/priority-scheduling
...
For the flag-level semantics, default value, and backend caveats, see [Router Configuration and Tuning](https://docs.nvidia.com/dynamo/knowledge-base/modular-components/router/configuration-and-tuning#routing-behavior).
