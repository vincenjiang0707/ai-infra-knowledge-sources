source: https://docs.nvidia.com/dynamo/zh-CN/v1.3.0/user-guides/dynosim/planner-benchmarking
...
For the general mechanics of DynoSim runs (input format, arrival speedup, router modes, synthetic workloads), see [DynoSim Runs](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/dynosim/runs). This guide focuses on the `--planner-config`
...
Other fields follow the standard mocker engine protocol (see [DynoSim Runs](https://docs.nvidia.com/dynamo/v1.3.0/user-guides/dynosim/runs)).
