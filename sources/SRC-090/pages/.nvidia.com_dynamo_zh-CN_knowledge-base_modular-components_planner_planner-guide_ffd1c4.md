source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/modular-components/planner/planner-guide
...
如需快速概览，请参阅 [Planner overview](https://docs.nvidia.com/dynamo/v1.4.2/knowledge-base/modular-components/planner/overview)。如需了解架构内部机制，请参阅 [Planner 设计](https://docs.nvidia.com/dynamo/zh-CN/v1.4.2/knowledge-base/modular-components/planner/planner-design)。
...
- 当你希望使用原生 AIC 估算、可选的部署前 profiling 数据或在线 FPM warmup，以特定 TTFT/ITL 值为目标时，请使用
。`sla`
...
JSON/YAML 对象进行配置。使用 profiler 时，该对象位于 DGDR 规范的 `spec.features.planner`
...
请参阅 [Profiler Guide](https://docs.nvidia.com/dynamo/v1.4.2/knowledge-base/modular-components/profiler/profiler-guide)，了解完整 profiling 工作流以及如何配置部署前扫描。
...
在当前工作流中，请为每个目标 pool 独立运行 profiling，然后手动组合最终的 control DGD 和 pool DGD。请参阅 [Global Planner Guide](https://docs.nvidia.com/dynamo/v1.4.2/knowledge-base/modular-components/planner/global-planner-guide)。

## 另请参阅

[Planner overview](https://docs.nvidia.com/dynamo/v1.4.2/knowledge-base/modular-components/planner/overview)— 为什么 LLM 推理需要不同的 autoscaler[Planner 设计](https://docs.nvidia.com/dynamo/zh-CN/v1.4.2/knowledge-base/modular-components/planner/planner-design)— 架构和算法内部机制[DGDR Templates](https://docs.nvidia.com/dynamo/v1.4.2/recipes/kubernetes-templates/dgdr)— DGDR YAML 示例、样例配置、高级模式[Global Planner Guide](https://docs.nvidia.com/dynamo/v1.4.2/knowledge-base/modular-components/planner/global-planner-guide)— 多 DGD 协调、共享 GPU 预算、单端点多 pool 部署[Profiler Guide](https://docs.nvidia.com/dynamo/v1.4.2/knowledge-base/modular-components/profiler/profiler-guide)— profiling 数据的生成方式