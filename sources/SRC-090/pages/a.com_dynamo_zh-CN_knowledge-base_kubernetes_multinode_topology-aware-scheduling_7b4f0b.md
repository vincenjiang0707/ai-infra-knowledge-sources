source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/kubernetes/multinode/topology-aware-scheduling
lastmod: 2026-09-23T23:30:39.914Z

# Topology Aware Scheduling

Packs prefill, decode, and routing pods within the same rack or zone to reduce inter-node latency.
...
TAS controls pod placement. To constrain or bias the Dynamo router’s prefill-to-decode handoff after pods are already running, see [Topology-Aware KV Transfer](https://docs.nvidia.com/dynamo/knowledge-base/kubernetes/multinode/topology-aware-kv-transfer).
