source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/backends/sg-lang/frontend-processor-fallback
...
: General tool calling guide[Tool Calling](https://docs.nvidia.com/dynamo/v1.2.1/user-guides/parsing/tool-call-parsing-dynamo): Full SGLang backend reference[Reference Guide](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/reference-guide): Priority scheduling and session control for agents[Agentic Workloads](https://docs.nvidia.com/dynamo/v1.2.1/backends/sg-lang/agentic-workloads)