source: https://docs.nvidia.com/dynamo/zh-CN/knowledge-base/modular-components/profiler/overview
...
[Installation Guide](https://docs.nvidia.com/dynamo/kubernetes/installation/install-dynamo)) - Kubernetes cluster with GPU nodes (for DGDR-based profiling)
