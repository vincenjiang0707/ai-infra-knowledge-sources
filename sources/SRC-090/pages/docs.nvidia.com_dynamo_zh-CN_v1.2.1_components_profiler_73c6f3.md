source: https://docs.nvidia.com/dynamo/zh-CN/v1.2.1/components/profiler
...
[Installation Guide](https://docs.nvidia.com/dynamo/v1.2.1/kubernetes-deployment/start-here/installation-guide)) - Kubernetes cluster with GPU nodes (for DGDR-based profiling)
