source: https://docs.nvidia.com/dynamo/zh-CN/v-0-9-1/user-guides/writing-python-workers-in-dynamo
...
and must return a response dict of type[OpenAI Chat Completion](https://platform.openai.com/docs/api-reference/chat). - ModelType.Completions. Your
`generate`

method receives a`request`

and must return a response dict of the older[Completions](https://platform.openai.com/docs/api-reference/completions).
...
: Size of a KV block for the engine, in tokens. Defaults to 16.`migration_limit`

: Maximum number of times a request may be[migrated to another Instance](https://docs.nvidia.com/dynamo/v-0-9-1/user-guides/fault-tolerance/request-migration). Defaults to 0.`user_data`
...
For more information about how request migration works, see the [Request Migration Architecture](https://docs.nvidia.com/dynamo/v-0-9-1/user-guides/fault-tolerance/request-migration) documentation.
...
For detailed information about request cancellation, including async cancellation monitoring and context propagation patterns, see the [Request Cancellation Architecture](https://docs.nvidia.com/dynamo/v-0-9-1/user-guides/fault-tolerance/request-cancellation) documentation.