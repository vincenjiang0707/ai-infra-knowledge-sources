source: https://docs.nvidia.com/dynamo/zh-CN/dev/recipes/qwen3-32b
...
[Qwen3-32B KV routing A/B](https://docs.nvidia.com/dynamo/dev/recipes/benchmarks/qwen3-32b-kv-routing)— the evidence behind this recipe: this configuration vs. aggregated round-robin on the same trace.
...
[Qwen3-32B FP8 recipe](https://docs.nvidia.com/dynamo/dev/recipes/qwen3-32b-fp8)— BF16 weights are ~64 GB and leave little KV headroom.

## Source

- Source README:
[recipes/qwen3-32b/README.md](https://github.com/ai-dynamo/dynamo/blob/main/recipes/qwen3-32b/README.md) - Deploy and benchmark:
[deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/main/recipes/qwen3-32b/vllm/disagg-kv-router/deploy.yaml)and[perf.yaml](https://github.com/ai-dynamo/dynamo/blob/main/recipes/qwen3-32b/vllm/disagg-kv-router/perf.yaml) - Setup assets:
[model-cache/cache.yaml](https://github.com/ai-dynamo/dynamo/blob/main/recipes/qwen3-32b/model-cache/cache.yaml)and[model-cache/model-download.yaml](https://github.com/ai-dynamo/dynamo/blob/main/recipes/qwen3-32b/model-cache/model-download.yaml)