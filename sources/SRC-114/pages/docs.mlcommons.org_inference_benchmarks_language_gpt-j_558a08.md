source: https://docs.mlcommons.org/inference/benchmarks/language/gpt-j/

# Text Summarization using GPT-J[¶](https://docs.mlcommons.org#text-summarization-using-gpt-j)
...
In the datacenter category, gptj-99 has Offline, Server scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the edge category, gptj-99 has Offline, SingleStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the datacenter category, gptj-99.9 has Offline, Server scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the edge category, gptj-99.9 has Offline, SingleStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
- If you want to download the official MLPerf model and dataset for gptj-99.9 you can follow
[this README](https://docs.mlcommons.org/get-gptj-data/).
...
is the desired batch size. This option works only if the implementation in use is supporting the given batch size. Example:`--batch_size.gptj:192`
