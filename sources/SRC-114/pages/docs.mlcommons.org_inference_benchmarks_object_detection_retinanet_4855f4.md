source: https://docs.mlcommons.org/inference/benchmarks/object_detection/retinanet/

# Object Detection using Retinanet[¶](https://docs.mlcommons.org#object-detection-using-retinanet)
...
#### Onnxruntime framework[¶](https://docs.mlcommons.org#onnxruntime-framework_1)
...
###### # Setup a virtual environment for Python[¶](https://docs.mlcommons.org#setup-a-virtual-environment-for-python_7)
...
###### # Setup a virtual environment for Python[¶](https://docs.mlcommons.org#setup-a-virtual-environment-for-python_8)
...
###### # Setup a virtual environment for Python[¶](https://docs.mlcommons.org#setup-a-virtual-environment-for-python_9)
...
###### # Docker Container Build and Performance Estimation for Offline Scenario[¶](https://docs.mlcommons.org#docker-container-build-and-performance-estimation-for-offline-scenario_7)
...
###### # Setup a virtual environment for Python[¶](https://docs.mlcommons.org#setup-a-virtual-environment-for-python_10)
...
###### # Setup a virtual environment for Python[¶](https://docs.mlcommons.org#setup-a-virtual-environment-for-python_11)
...
###### performance-only[¶](https://docs.mlcommons.org#performance-only_48)
...
###### accuracy-only[¶](https://docs.mlcommons.org#accuracy-only_48)
...
###### performance-only[¶](https://docs.mlcommons.org#performance-only_49)
...
###### accuracy-only[¶](https://docs.mlcommons.org#accuracy-only_49)
...
- If you want to download the official MLPerf model and dataset for retinanet you can follow
[this README](https://docs.mlcommons.org/get-retinanet-data/).
...
###### # Docker Container Build and Performance Estimation for Offline Scenario[¶](https://docs.mlcommons.org#docker-container-build-and-performance-estimation-for-offline-scenario_8)
...
is the desired batch size. This option works only if the implementation in use is supporting the given batch size. Example:`--batch_size.retinanet:8`
...
###### performance-only[¶](https://docs.mlcommons.org#performance-only_50)
...
###### accuracy-only[¶](https://docs.mlcommons.org#accuracy-only_50)
...
###### performance-only[¶](https://docs.mlcommons.org#performance-only_51)
...
###### accuracy-only[¶](https://docs.mlcommons.org#accuracy-only_51)
...
###### # Docker Container Build and Performance Estimation for Offline Scenario[¶](https://docs.mlcommons.org#docker-container-build-and-performance-estimation-for-offline-scenario_9)
...
###### performance-only[¶](https://docs.mlcommons.org#performance-only_52)
...
###### accuracy-only[¶](https://docs.mlcommons.org#accuracy-only_52)
...
###### performance-only[¶](https://docs.mlcommons.org#performance-only_53)
...
###### accuracy-only[¶](https://docs.mlcommons.org#accuracy-only_53)
...
###### performance-only[¶](https://docs.mlcommons.org#performance-only_54)
...
###### accuracy-only[¶](https://docs.mlcommons.org#accuracy-only_54)
