source: https://docs.mlcommons.org/inference/benchmarks/language/llama3_1-8b/

# Text Summarization using LLAMA3_1-8b[¶](https://docs.mlcommons.org#text-summarization-using-llama3_1-8b)
...
In the datacenter category, llama3_1-8b has Offline, Server scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the edge category, llama3_1-8b-edge has Offline, SingleStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
- If you want to download the official MLPerf model and dataset for llama3_1-8b-edge you can follow
[this README](https://docs.mlcommons.org/get-llama3_1-8b-edge-data.md).