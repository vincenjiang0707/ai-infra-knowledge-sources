source: https://docs.mlcommons.org/inference/benchmarks/object_detection/yolo/

# Detection using YOLO v11[¶](https://docs.mlcommons.org#detection-using-yolo-v11)
...
In the edge category, yolo-95 has Offline, SingleStream, MultiStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
```
mlcr run-mlperf,inference,_find-performance,_full,_r6.0-dev \
--model=yolo-95 \
...
```
mlcr run-mlperf,inference,_full,_r6.0-dev,_performance-only \
--model=yolo-95 \
--implementation=reference \
--framework=pytorch \
--category=edge \
...
```
mlcr run-mlperf,inference,_full,_r6.0-dev,_accuracy-only \
--model=yolo-95 \
--implementation=reference \
--framework=pytorch \
--category=edge \
...
```
mlcr run-mlperf,inference,_full,_r6.0-dev,_all-scenarios \
--model=yolo-95 \
--implementation=reference \
--framework=pytorch \
--category=edge \
...
- If you want to download the official MLPerf model and dataset for yolo-95 you can follow
[this README](https://docs.mlcommons.org/get-yolo-data/).

YOLO-99

### Edge category[¶](https://docs.mlcommons.org#edge-category_1)

In the edge category, yolo-99 has Offline, SingleStream, MultiStream scenarios and all of the scenarios are mandatory for a closed division submission.
