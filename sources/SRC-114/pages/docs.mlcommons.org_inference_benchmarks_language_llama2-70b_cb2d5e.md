source: https://docs.mlcommons.org/inference/benchmarks/language/llama2-70b/

# Text Summarization using LLAMA2-70b[¶](https://docs.mlcommons.org#text-summarization-using-llama2-70b)
...
In the datacenter category, llama2-70b-99 has Offline, Server scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the edge category, llama2-70b-99 has Offline, SingleStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the datacenter category, llama2-70b-99.9 has Offline, Server scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the edge category, llama2-70b-99.9 has Offline, SingleStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
- If you want to download the official MLPerf model and dataset for llama2-70b-99.9 you can follow
[this README](https://docs.mlcommons.org/get-llama2-70b-data/).