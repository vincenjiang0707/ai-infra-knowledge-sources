source: https://docs.mlcommons.org/inference/benchmarks/language/bert/

# Question Answering using Bert-Large[¶](https://docs.mlcommons.org#question-answering-using-bert-large)
...
In the edge category, bert-99.9 has Offline, SingleStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
#### Deepsparse framework[¶](https://docs.mlcommons.org#deepsparse-framework_1)
...
###### SingleStream[¶](https://docs.mlcommons.org#singlestream_13)
...
- If you want to download the official MLPerf model and dataset for bert-99.9 you can follow
[this README](https://docs.mlcommons.org/get-bert-data/).
...
###### SingleStream[¶](https://docs.mlcommons.org#singlestream_14)
