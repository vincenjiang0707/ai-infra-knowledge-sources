source: https://docs.mlcommons.org/inference/benchmarks/language/mixtral-8x7b/

# Question Answering, Math, and Code Generation using Mixtral-8x7B[¶](https://docs.mlcommons.org#question-answering-math-and-code-generation-using-mixtral-8x7b)
...
In the datacenter category, mixtral-8x7b has Offline, Server scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the edge category, mixtral-8x7b has Offline, SingleStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
- If you want to download the official MLPerf model and dataset for mixtral-8x7b you can follow
[this README](https://docs.mlcommons.org/get-mixtral-8x7b-data/).