source: https://docs.mlcommons.org/inference/benchmarks/recommendation/dlrm-v2/

# Recommendation using DLRM v2[¶](https://docs.mlcommons.org#recommendation-using-dlrm-v2)
...
In the datacenter category, dlrm-v2-99 has Offline, Server scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the edge category, dlrm-v2-99 has Offline, SingleStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the datacenter category, dlrm-v2-99.9 has Offline, Server scenarios and all of the scenarios are mandatory for a closed division submission.
...
In the edge category, dlrm-v2-99.9 has Offline, SingleStream scenarios and all of the scenarios are mandatory for a closed division submission.
...
- If you want to download the official MLPerf model and dataset for dlrm-v2-99.9 you can follow
[this README](https://docs.mlcommons.org/get-dlrm-v2-data/).
...
is the desired batch size. This option works only if the implementation in use is supporting the given batch size. Example:`--batch_size.dlrm-v2:600000`
