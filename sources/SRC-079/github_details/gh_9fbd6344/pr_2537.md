# [PR #2537] feat(quantization): run a calibration plan, one mode per stage [4/4]

source: https://github.com/NVIDIA/Model-Optimizer/pull/2537
state: open | updated: 2026-09-23T22:43:33Z
labels: 
...
activations cost N forward passes** over the calibration set. Invisible on a toy model, not
