# [PR #2299] [ring-hce-bd] Hierarchical CE: Ring implementation for better scalability. 

source: https://github.com/NVIDIA/nccl/pull/2299
state: closed | updated: 2026-08-19T16:18:50Z
labels: 
...
The initial ncclHierCEAllGather version provided at commit id 8a074116f105b7febdc6761115a46e5673dbf045 does not meet expectations when scaling the number of (remote) nodes. There is a heavy performance regression when comparing against the traditional CPU proxy (+ SM-based kernel). 
...
This was merged: https://github.com/NVIDIA/nccl/commit/8c5065744b8e7d2f94bd9263d62e2d4aea3db059 Will be part of the next release. Closing. 
