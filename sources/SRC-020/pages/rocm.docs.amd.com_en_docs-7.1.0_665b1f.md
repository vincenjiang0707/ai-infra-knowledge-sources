source: https://rocm.docs.amd.com/en/docs-7.1.0/
...
[HIP (Heterogeneous-Compute Interface for Portability)](https://rocm.docs.amd.com/projects/HIP/en/docs-7.1.0/index.html), OpenCL,
