source: https://rocm.docs.amd.com/en/docs-7.2.4/conceptual/cmake-packages.html

# Using CMake[#](https://rocm.docs.amd.com#using-cmake)
...
## Finding dependencies[#](https://rocm.docs.amd.com#finding-dependencies)
...
## Using HIP in CMake[#](https://rocm.docs.amd.com#using-hip-in-cmake)
...
### Using the HIP single-source programming model[#](https://rocm.docs.amd.com#using-the-hip-single-source-programming-model)
...
### Consuming ROCm C/C++ libraries[#](https://rocm.docs.amd.com#consuming-rocm-c-c-libraries)
...
### Consuming the HIP API in C++ code[#](https://rocm.docs.amd.com#consuming-the-hip-api-in-c-code)
...
.### Compiling device code in C++ language mode[#](https://rocm.docs.amd.com#compiling-device-code-in-c-language-mode)
...
### ROCm CMake packages[#](https://rocm.docs.amd.com#rocm-cmake-packages)
...
## Using CMake presets[#](https://rocm.docs.amd.com#using-cmake-presets)
...
### Using HIP with presets[#](https://rocm.docs.amd.com#using-hip-with-presets)
