source: https://rocm.docs.amd.com/en/docs-7.2.3/
...
[HIP](https://rocm.docs.amd.com/projects/HIP/en/docs-7.2.3/index.html), OpenCL, and OpenMP, as explained in the [Programming guide](https://rocm.docs.amd.com/how-to/programming_guide.html).
