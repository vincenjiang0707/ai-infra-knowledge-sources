source: https://rocm.docs.amd.com/en/docs-7.2.4/how-to/rocm-for-ai/inference-optimization/optimizing-with-composable-kernel.html

# Optimizing with Composable Kernel[#](https://rocm.docs.amd.com#optimizing-with-composable-kernel)
...
## High-level overview: a CK GEMM instance[#](https://rocm.docs.amd.com#high-level-overview-a-ck-gemm-instance)
...
### Template parameter definition[#](https://rocm.docs.amd.com#template-parameter-definition)

The template parameters of the instance are grouped into four parameter types:

#### Matrix data precision[#](https://rocm.docs.amd.com#matrix-data-precision)
...
#### Matrix data layout[#](https://rocm.docs.amd.com#matrix-data-layout)
...
#### Matrix element operation[#](https://rocm.docs.amd.com#matrix-element-operation)
...
#### Tunable parameters[#](https://rocm.docs.amd.com#tunable-parameters)
...
### Instantiating and running the templated kernel[#](https://rocm.docs.amd.com#instantiating-and-running-the-templated-kernel)
...
## Developing fused INT8 kernels for SmoothQuant models[#](https://rocm.docs.amd.com#developing-fused-int8-kernels-for-smoothquant-models)
...
### Developing the complete function[#](https://rocm.docs.amd.com#developing-the-complete-function)
...
is a struct denoting if an operation is applied to the tensor it binds to. To fuse the operations between E1, E2, and E introduced in section [Operation flow analysis](https://rocm.docs.amd.com#operation-flow-analysis), we define a custom C++ struct, `ScaleScaleAddRelu`
...
The template parameters of the target fundamental instance are initialized with the above parameters and includes default tunable parameters. For specific tuning methods, see [Tunable parameters](https://rocm.docs.amd.com#tunable-parameters).
...
### Binding to Python[#](https://rocm.docs.amd.com#binding-to-python)
...
### INT8 model inference and performance[#](https://rocm.docs.amd.com#int8-model-inference-and-performance)
...
## Conclusion[#](https://rocm.docs.amd.com#conclusion)
