source: https://rocm.docs.amd.com/projects/llvm-project/en/latest/conceptual/openmp.html

# ROCm OpenMP support[#](https://rocm.docs.amd.com#rocm-openmp-support)
...
## Usage[#](https://rocm.docs.amd.com#usage)
...
### Asynchronous behavior in OpenMP target regions[#](https://rocm.docs.amd.com#asynchronous-behavior-in-openmp-target-regions)
...
. See the [Environment Variables](https://rocm.docs.amd.com#environment-variables) table for details.
...
### OMPT target support[#](https://rocm.docs.amd.com#ompt-target-support)
...
### Floating point atomic operations[#](https://rocm.docs.amd.com#floating-point-atomic-operations)
...
### Using AddressSanitizer tool with OpenMP applications[#](https://rocm.docs.amd.com#using-addresssanitizer-tool-with-openmp-applications)
...
capability. See the section on [Unified Shared Memory](https://rocm.docs.amd.com#unified-shared-memory)
...
### Clang compiler option for kernel optimization[#](https://rocm.docs.amd.com#clang-compiler-option-for-kernel-optimization)
...
### Specialized kernels[#](https://rocm.docs.amd.com#specialized-kernels)
...
#### No-loop kernel generation[#](https://rocm.docs.amd.com#no-loop-kernel-generation)
...
#### Big-jump-loop kernel generation[#](https://rocm.docs.amd.com#big-jump-loop-kernel-generation)
...
#### Cross-team optimized reduction kernel generation[#](https://rocm.docs.amd.com#cross-team-optimized-reduction-kernel-generation)
...
## OpenMP release updates[#](https://rocm.docs.amd.com#openmp-release-updates)
