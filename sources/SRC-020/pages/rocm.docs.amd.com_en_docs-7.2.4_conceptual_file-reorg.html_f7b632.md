source: https://rocm.docs.amd.com/en/docs-7.2.4/conceptual/file-reorg.html

# ROCm Linux Filesystem Hierarchy Standard reorganization[#](https://rocm.docs.amd.com#rocm-linux-filesystem-hierarchy-standard-reorganization)

2026-02-19

5 min read time

## Introduction[#](https://rocm.docs.amd.com#introduction)
...
## Adopting the FHS[#](https://rocm.docs.amd.com#adopting-the-fhs)
...
## Changes from earlier ROCm versions[#](https://rocm.docs.amd.com#changes-from-earlier-rocm-versions)
...
## ROCm FHS reorganization: backward compatibility[#](https://rocm.docs.amd.com#rocm-fhs-reorganization-backward-compatibility)
...
### Wrapper header files[#](https://rocm.docs.amd.com#wrapper-header-files)
...
### Executable files[#](https://rocm.docs.amd.com#executable-files)
...
### Library files[#](https://rocm.docs.amd.com#library-files)
...
### CMake config files[#](https://rocm.docs.amd.com#cmake-config-files)
...
## Changes required in applications using ROCm[#](https://rocm.docs.amd.com#changes-required-in-applications-using-rocm)
...
## Changes in versioning specifications[#](https://rocm.docs.amd.com#changes-in-versioning-specifications)
