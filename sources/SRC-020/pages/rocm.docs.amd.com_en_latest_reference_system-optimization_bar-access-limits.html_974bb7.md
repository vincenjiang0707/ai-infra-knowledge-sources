source: https://rocm.docs.amd.com/en/latest/reference/system-optimization/bar-access-limits.html

# BAR access limits and physical addressing for AMD GPUs[#](https://rocm.docs.amd.com#bar-access-limits-and-physical-addressing-for-amd-gpus)
