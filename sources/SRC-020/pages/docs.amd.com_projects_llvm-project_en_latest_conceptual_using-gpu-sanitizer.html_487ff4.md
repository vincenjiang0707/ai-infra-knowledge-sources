source: https://rocm.docs.amd.com/projects/llvm-project/en/latest/conceptual/using-gpu-sanitizer.html

# Using the AddressSanitizer on a GPU[#](https://rocm.docs.amd.com#using-the-addresssanitizer-on-a-gpu)
...
## GPU Address Sanitizer release updates (ASan)[#](https://rocm.docs.amd.com#gpu-address-sanitizer-release-updates-asan)
...
## Compiling for ASan[#](https://rocm.docs.amd.com#compiling-for-asan)
...
### About compilation time[#](https://rocm.docs.amd.com#about-compilation-time)
...
## Installing ROCm GPU ASan packages[#](https://rocm.docs.amd.com#installing-rocm-gpu-asan-packages)
...
## Using AMD-supplied ASan instrumented libraries[#](https://rocm.docs.amd.com#using-amd-supplied-asan-instrumented-libraries)
...
## Running ASan instrumented applications[#](https://rocm.docs.amd.com#running-asan-instrumented-applications)

### Preparing to run an instrumented application[#](https://rocm.docs.amd.com#preparing-to-run-an-instrumented-application)
...
## Runtime overhead[#](https://rocm.docs.amd.com#runtime-overhead)
...
### Higher execution time[#](https://rocm.docs.amd.com#higher-execution-time)
...
### Higher memory use[#](https://rocm.docs.amd.com#higher-memory-use)
...
## Runtime reporting[#](https://rocm.docs.amd.com#runtime-reporting)
...
[#](https://rocm.docs.amd.com#running-asan-with-rocgdb)
...
## Using ASan with a short HIP application[#](https://rocm.docs.amd.com#using-asan-with-a-short-hip-application)
...
## Known issues with using GPU sanitizer[#](https://rocm.docs.amd.com#known-issues-with-using-gpu-sanitizer)
