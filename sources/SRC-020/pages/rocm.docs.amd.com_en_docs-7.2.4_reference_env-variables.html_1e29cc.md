source: https://rocm.docs.amd.com/en/docs-7.2.4/reference/env-variables.html
...
more information, check [setting the number of CUs page](https://rocm.docs.amd.com/en/docs-7.2.4/how-to/setting-cus.html).
...
more information, check [Logging HIP activity](https://rocm.docs.amd.com/projects/HIP/en/docs-7.2.4/how-to/logging.html), [Debugging with HIP](https://rocm.docs.amd.com/projects/HIP/en/docs-7.2.4/how-to/debugging.html)
and [GPU isolation](https://rocm.docs.amd.com/en/docs-7.2.4/conceptual/gpu-isolation.html).
...
The following table lists the [ROCR-Runtime](https://rocm.docs.amd.com/projects/ROCR-Runtime/en/docs-7.2.4/index.html)
