...
see [HIP API 7.0 changes](https://rocm.docs.amd.com/hip-7-changes.html).
...
To contribute to the documentation, refer to [Contributing to ROCm docs](https://rocm.docs.amd.com/en/docs-7.2.4/contribute/contributing.html) page.
