source: https://rocm.docs.amd.com/en/docs-6.2.2/
...
compatibility with industry software frameworks. For more information, see [What is ROCm?](https://rocm.docs.amd.com/what-is-rocm.html)

If you’re using AMD Radeon™ PRO or Radeon GPUs in a workstation setting with a display connected, review Radeon-specific ROCm documentation.
