source: https://rocm.docs.amd.com/en/docs-6.4.3/
...
[HIP (Heterogeneous-Compute Interface for Portability)](https://rocm.docs.amd.com/projects/HIP/en/docs-6.4.3/index.html), OpenCL,
and OpenMP, as explained in the [Programming guide](https://rocm.docs.amd.com/how-to/programming_guide.html).

If you’re using AMD Radeon™ PRO or Radeon GPUs in a workstation setting with a display connected, review [Radeon-specific ROCm documentation](https://rocm.docs.amd.com/projects/radeon-ryzen/en/docs-6.4.2/index.html).
