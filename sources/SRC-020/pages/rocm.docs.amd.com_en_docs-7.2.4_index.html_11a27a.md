source: https://rocm.docs.amd.com/en/docs-7.2.4/index.html
...
[HIP](https://rocm.docs.amd.com/projects/HIP/en/docs-7.2.4/index.html), OpenCL, and OpenMP, as explained in the [Programming guide](https://rocm.docs.amd.com/how-to/programming_guide.html).

If you’re using AMD Radeon™ GPUs or Ryzen™ APUs for graphics workloads, see the [ROCm on Radeon and Ryzen](https://rocm.docs.amd.com/projects/radeon-ryzen/en/docs-6.4.4/index.html) documentation.
