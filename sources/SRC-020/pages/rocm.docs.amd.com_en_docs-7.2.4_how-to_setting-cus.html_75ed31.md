source: https://rocm.docs.amd.com/en/docs-7.2.4/how-to/setting-cus.html

# Setting the number of compute units[#](https://rocm.docs.amd.com#setting-the-number-of-compute-units)
