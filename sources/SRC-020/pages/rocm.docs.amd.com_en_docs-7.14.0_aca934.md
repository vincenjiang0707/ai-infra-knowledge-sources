source: https://rocm.docs.amd.com/en/docs-7.14.0

# AMD ROCm[#](https://rocm.docs.amd.com#amd-rocm)
...
Open-source collections of ROCm-accelerated libraries for building high-performance domain-specific applications.