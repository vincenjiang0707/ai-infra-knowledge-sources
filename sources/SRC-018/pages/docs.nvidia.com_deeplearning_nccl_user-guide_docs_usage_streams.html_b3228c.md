...
# CUDA Stream Semantics[](https://docs.nvidia.com#cuda-stream-semantics)
...
## Mixing Multiple Streams within the same ncclGroupStart/End() group[](https://docs.nvidia.com#mixing-multiple-streams-within-the-same-ncclgroupstart-end-group)
