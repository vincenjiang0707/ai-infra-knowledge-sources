...
# NCCL and MPI[](https://docs.nvidia.com#nccl-and-mpi)

## API[](https://docs.nvidia.com#api)
...
### Using multiple devices per process[](https://docs.nvidia.com#using-multiple-devices-per-process)
...
### ReduceScatter operation[](https://docs.nvidia.com#reducescatter-operation)
...
### Send and Receive counts[](https://docs.nvidia.com#send-and-receive-counts)
...
### Other collectives and point-to-point operations[](https://docs.nvidia.com#other-collectives-and-point-to-point-operations)
...
### In-place operations[](https://docs.nvidia.com#in-place-operations)

For more information, see [In-place Operations](https://docs.nvidia.com/usage/inplace.html#in-place-operations).

## Using NCCL within an MPI Program[](https://docs.nvidia.com#using-nccl-within-an-mpi-program)
...
### MPI Progress[](https://docs.nvidia.com#mpi-progress)
...
### Inter-GPU Communication with CUDA-aware MPI[](https://docs.nvidia.com#inter-gpu-communication-with-cuda-aware-mpi)
