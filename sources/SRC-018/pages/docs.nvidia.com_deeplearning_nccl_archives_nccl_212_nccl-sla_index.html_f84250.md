source: https://docs.nvidia.com/deeplearning/nccl/archives/nccl_212/nccl-sla/index.html
...
[1. NVIDIA SOFTWARE LICENSE AGREEMENT](https://docs.nvidia.com#overview)
...
[2. SOFTWARE LICENSE AGREEMENT](https://docs.nvidia.com#license-agreement)


[2.1. License](https://docs.nvidia.com#license)


[2.1.1. License Grant](https://docs.nvidia.com#license-grant)
...
[2.1.2. Limited Purpose Licenses](https://docs.nvidia.com#limit-purpose-license)

[License Grant](https://docs.nvidia.com/index.html#license-grant)or in a Supplement, such licenses are for internal use and do not include any right or license to sub-license and distribute the Licensed Software or its output in any way in any public release, however limited, and/or in any manner that provides third parties with use of or access to the Licensed Software or its functionality or output, including (but not limited to) external alpha or beta testing or development phases. Further:
...
[2.1.3. Pre-Release Licenses](https://docs.nvidia.com#pre-release-license)
...
[2.1.4. Enterprise and Contractor Usage](https://docs.nvidia.com#enterprise)
...
[2.1.5. Services](https://docs.nvidia.com#services)
...
[2.2. Limitations](https://docs.nvidia.com#limitations)


[2.2.1. License Restrictions](https://docs.nvidia.com#license-restrictions)
...
[2.2.2. Third Party License Obligations](https://docs.nvidia.com#third-party)
...
[2.2.3. Limited Rights](https://docs.nvidia.com#limited-rights)
...
[2.3. CONFIDENTIALITY](https://docs.nvidia.com#confidential)
...
[2.4. OWNERSHIP](https://docs.nvidia.com#ownership)
...
[2.5. FEEDBACK](https://docs.nvidia.com#feedback)
...
[2.6. NO WARRANTIES](https://docs.nvidia.com#warranty)
...
[2.7. LIMITATION OF LIABILITY](https://docs.nvidia.com#limitation)
...
[2.8. TERM AND TERMINATION](https://docs.nvidia.com#term)


[2.8.1. AGREEMENT, Licenses and Services](https://docs.nvidia.com#agreement)
...
[2.8.2. Termination and Effect of Expiration or Termination](https://docs.nvidia.com#expire)
...
rights provided under the AGREEMENT for the affected Licensed Software, in
addition to any other remedies NVIDIA may have at law or equity. Upon any
...
[2.9. CONSENT TO COLLECTION AND USE OF INFORMATION](https://docs.nvidia.com#consent)
...
policy, available at URL [http://www.nvidia.com/object/privacy_policy.html](http://www.nvidia.com/object/privacy_policy.html).


[2.10. GENERAL](https://docs.nvidia.com#general)
...
[3. NCCL BINARY SUPPLEMENT TO SOFTWARE LICENSE AGREEMENT ](https://docs.nvidia.com#supplement)
...
[3.1. LICENSE TERMS](https://docs.nvidia.com#license-terms)

NCCL Licensed Software is licensed to you hereunder for use in Systems containing less than eight (8) NVIDIA GPUs. For the purpose of this Supplement, “System” means a logically single server, computer or appliance having one or more NVIDIA GPUs and one or more CPUs.


[3.2. NCCL DISTRIBUTION](https://docs.nvidia.com#distribution)
...
[3.3. LICENSE DURATION](https://docs.nvidia.com#duration)
...
[3.4. AUDIT](https://docs.nvidia.com#audit)
...
[3.5. EXPIRATION OF TERMINATION OF THIS SUPPLEMENT](https://docs.nvidia.com#terminate)
...
[4. GLOSSARY OF TERMS](https://docs.nvidia.com#glossary)
...
Enterprise’s Contractors, subject to the terms of the
[Enterprise and Contractor Usage](https://docs.nvidia.com/index.html#enterprise)section. - Confidential Information
...
disclosed by NVIDIA to you which, at the time of disclosure, is designated
in writing as confidential or proprietary (or like written designation), or
...
- Open Source License
- Open Source License includes, without limitation, a software license that
requires as a condition of use, modification, and/or distribution of such
software that the Software be
