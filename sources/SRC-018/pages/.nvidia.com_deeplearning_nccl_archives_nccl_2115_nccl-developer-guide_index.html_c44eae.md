source: https://docs.nvidia.com/deeplearning/nccl/archives/nccl_2115/nccl-developer-guide/index.html
...
`NCCL_IB_RETRY_CNT`(since 2.1.15)[InfiniBand](https://docs.nvidia.com/index.html#infiniband).`7`.`NCCL_IB_GID_INDEX`(since 2.1.4)
...
[InfiniBand](https://docs.nvidia.com/index.html#infiniband).`1`.`NCCL_IB_TC`(since 2.1.15)

[InfiniBand](https://docs.nvidia.com/index.html#infiniband).`0`.`NCCL_IB_CUDA_SUPPORT``NCCL_IB_CUDA_SUPPORT`variable is used to disable GPU Direct RDMA.Define and set to `0` to disable
GPU Direct RDMA.
