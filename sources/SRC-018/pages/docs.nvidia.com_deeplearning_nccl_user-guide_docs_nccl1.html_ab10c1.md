...
# Migrating from NCCL 1 to NCCL 2[](https://docs.nvidia.com#migrating-from-nccl-1-to-nccl-2)
...
## Initialization[](https://docs.nvidia.com#initialization)
...
## Communication[](https://docs.nvidia.com#communication)
...
## Counts[](https://docs.nvidia.com#counts)

Counts provided as arguments are now of type size_t instead of integer.

## In-place usage for AllGather and ReduceScatter[](https://docs.nvidia.com#in-place-usage-for-allgather-and-reducescatter)

For more information, see “In-place Operations”.

## AllGather arguments order[](https://docs.nvidia.com#allgather-arguments-order)
