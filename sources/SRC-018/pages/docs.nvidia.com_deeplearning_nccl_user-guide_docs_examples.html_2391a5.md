...
## Communicator Creation and Destruction Examples[](https://docs.nvidia.com#communicator-creation-and-destruction-examples)

The following examples demonstrate common use cases for NCCL initialization.

### Example 1: Single Process, Single Thread, Multiple Devices[](https://docs.nvidia.com#example-1-single-process-single-thread-multiple-devices)
...
### Example 2: One Device per Process or Thread[](https://docs.nvidia.com#example-2-one-device-per-process-or-thread)
...
### Example 3: Multiple Devices per Thread[](https://docs.nvidia.com#example-3-multiple-devices-per-thread)
...
### Example 4: Multiple communicators per device[](https://docs.nvidia.com#example-4-multiple-communicators-per-device)
...
checkTimeout() should be a user-defined function. For more nonblocking communicator usage, please check [Fault Tolerance](https://docs.nvidia.com/usage/communicators.html#ft).
In addition, if you want to split communicators instead of creating a new one, please check [ ncclCommSplit()](https://docs.nvidia.com/api/comms.html#c.ncclCommSplit).

## Communication Examples[](https://docs.nvidia.com#communication-examples)

The following examples demonstrate common patterns for executing NCCL collectives.

### Example 1: One Device per Process or Thread[](https://docs.nvidia.com#example-1-one-device-per-process-or-thread)
...
### Example 2: Multiple Devices per Thread[](https://docs.nvidia.com#example-2-multiple-devices-per-thread)
...
For a complete working example with MPI and multiple devices per MPI process, see [Example 3: Multiple Devices per Thread](https://docs.nvidia.com#ex3).