source: http://docs.nvidia.com/cuda/turing-compatibility-guide/index.html
...
#
1. Turing Compatibility[](http://docs.nvidia.com#turing-compatibility)

##
1.1. About this Document[](http://docs.nvidia.com#about-this-document)
...
##
1.2. Application Compatibility on Turing[](http://docs.nvidia.com#application-compatibility-on-turing)
...
##
1.3. Compatibility between Volta and Turing[](http://docs.nvidia.com#compatibility-between-volta-and-turing)
...
##
1.4. Verifying Turing Compatibility for Existing Applications[](http://docs.nvidia.com#verifying-turing-compatibility-for-existing-applications)
...
###
1.4.1. Applications Using CUDA Toolkit 8.0 or Earlier[](http://docs.nvidia.com#applications-using-cuda-toolkit-8-0-or-earlier)
...
###
1.4.2. Applications Using CUDA Toolkit 9.x[](http://docs.nvidia.com#applications-using-cuda-toolkit-9-x)

CUDA applications built using CUDA Toolkit 9.x are compatible with Turing as long as they are built to include kernels in either Volta-native cubin format (see [Compatibility between Volta and Turing](http://docs.nvidia.com#turing-volta-compatibility)) or PTX format (see [Applications Using CUDA Toolkit 8.0 or Earlier](http://docs.nvidia.com#verifying-turing-compatibility-using-cuda-8-0)) or both.

###
1.4.3. Applications Using CUDA Toolkit 10.0[](http://docs.nvidia.com#applications-using-cuda-toolkit-10-0)

CUDA applications built using CUDA Toolkit 10.0 are compatible with Turing as long as they are built to include kernels in Volta-native or Turing-native cubin format (see [Compatibility between Volta and Turing](http://docs.nvidia.com#turing-volta-compatibility)), or PTX format (see [Applications Using CUDA Toolkit 8.0 or Earlier](http://docs.nvidia.com#verifying-turing-compatibility-using-cuda-8-0)), or both.

##
1.5. Building Applications with Turing Support[](http://docs.nvidia.com#building-applications-with-turing-support)
...
###
1.5.1. Applications Using CUDA Toolkit 8.0 or Earlier[](http://docs.nvidia.com#building-turing-compatible-apps-using-cuda-8-0)
...
###
1.5.2. Applications Using CUDA Toolkit 9.x[](http://docs.nvidia.com#building-turing-compatible-apps-using-cuda-9-0)
...
###
1.5.3. Applications Using CUDA Toolkit 10.0[](http://docs.nvidia.com#building-turing-compatible-apps-using-cuda-10-0)
...
###
1.5.4. Independent Thread Scheduling Compatibility[](http://docs.nvidia.com#independent-thread-scheduling-compatibility)

The Volta and Turing architectures feature Independent Thread Scheduling among threads in a warp. If the developer made assumptions about warp-synchronicity, [1](http://docs.nvidia.com#fn1) this feature can alter the set of threads participating in the executed code compared to previous architectures. Please see Compute Capability 7.0 in the *CUDA Programming Guide* for details and corrective actions. To aid migration Volta and Turing developers can opt-in to the Pascal scheduling model with the following combination of compiler options.
...
#
2. Revision History[](http://docs.nvidia.com#revision-history)
...
#
3. Notices[](http://docs.nvidia.com#notices)

##
3.1. Notice[](http://docs.nvidia.com#notice)
...
##
3.2. OpenCL[](http://docs.nvidia.com#opencl)

OpenCL is a trademark of Apple Inc. used under license to the Khronos Group Inc.

##
3.3. Trademarks[](http://docs.nvidia.com#trademarks)

NVIDIA and the NVIDIA logo are trademarks or registered trademarks of NVIDIA Corporation in the U.S. and other countries. Other company and product names may be trademarks of the respective companies with which they are associated.

[1](http://docs.nvidia.com#id9)-
