source: http://docs.nvidia.com/cuda/cuda-compiler-driver-nvcc/index.html
...
#
1. Introduction[](http://docs.nvidia.com#introduction)

##
1.1. Overview[](http://docs.nvidia.com#overview)

###
1.1.1. CUDA Programming Model[](http://docs.nvidia.com#cuda-programming-model)
...
###
1.1.2. CUDA Sources[](http://docs.nvidia.com#cuda-sources)
...
###
1.1.3. Purpose of NVCC[](http://docs.nvidia.com#purpose-of-nvcc)
...
##
1.2. Supported Host Compilers[](http://docs.nvidia.com#supported-host-compilers)
...
[The CUDA Compilation Trajectory](http://docs.nvidia.com#cuda-compilation-trajectory)).
...
on Windows) found in the current execution search path will be used, unless specified otherwise with appropriate options (see [File and Path Specifications](http://docs.nvidia.com#file-and-path-specifications)).
...
#
2. Compilation Phases[](http://docs.nvidia.com#compilation-phases)

##
2.1. NVCC Identification Macro[](http://docs.nvidia.com#nvcc-identification-macro)
...
[NVCC Options for Separate Compilation](http://docs.nvidia.com#nvcc-options-for-separate-compilation)). `__CUDACC_EWP__`

-
Defined when compiling CUDA source files in extensible whole program mode (see

[Options for Specifying Behavior of Compiler/Linker](http://docs.nvidia.com#options-for-altering-compiler-linker-behavior)). `__CUDACC_TILE__`
...
[Options for Specifying Behavior of Compiler/Linker](http://docs.nvidia.com#options-for-altering-compiler-linker-behavior)). `__CUDACC_RELAXED_CONSTEXPR__`
...
##
2.2. NVCC Phases[](http://docs.nvidia.com#nvcc-phases)
...
command line options can be found in [NVCC Command Options](http://docs.nvidia.com#nvcc-command-options).

##
2.3. Supported Input File Suffixes[](http://docs.nvidia.com#supported-input-file-suffixes)
...
##
2.4. Supported Phases[](http://docs.nvidia.com#supported-phases)
...
#
3. The CUDA Compilation Trajectory[](http://docs.nvidia.com#the-cuda-compilation-trajectory)
...
CUDA programs are compiled in the whole program compilation mode by default, i.e., the device code cannot reference an entity from a separate file. In the whole program compilation mode, device link steps have no effect. For more information on the separate compilation and the whole program compilation, refer to [Using Separate Compilation in CUDA](http://docs.nvidia.com#using-separate-compilation-in-cuda).

#
4. NVCC Command Options[](http://docs.nvidia.com#nvcc-command-options)

##
4.1. Command Option Types and Notation[](http://docs.nvidia.com#command-option-types-and-notation)
...
##
4.2. Command Option Description[](http://docs.nvidia.com#command-option-description)
...
###
4.2.1. File and Path Specifications[](http://docs.nvidia.com#file-and-path-specifications)
...
)[](http://docs.nvidia.com#output-file-file-o)
...
)[](http://docs.nvidia.com#objdir-as-tempdir-objtemp)
...
)[](http://docs.nvidia.com#pre-include-file-include)
...
)[](http://docs.nvidia.com#library-library-l)
...
(see [Libraries](http://docs.nvidia.com#libraries)).
...
)[](http://docs.nvidia.com#define-macro-def-d)
...
)[](http://docs.nvidia.com#undefine-macro-def-u)
...
)[](http://docs.nvidia.com#include-path-path-i)
...
)[](http://docs.nvidia.com#system-include-path-isystem)
...
)[](http://docs.nvidia.com#library-path-path-l)

Specify library search paths (see [Libraries](http://docs.nvidia.com#libraries)).
...
)[](http://docs.nvidia.com#output-directory-directory-odir)
...
)[](http://docs.nvidia.com#dependency-output-file-mf)
...
)[](http://docs.nvidia.com#generate-dependency-targets-mp)
...
)[](http://docs.nvidia.com#compiler-bindir-directory-ccbin)
...
)[](http://docs.nvidia.com#allow-unsupported-compiler-allow-unsupported-compiler)
...
)[](http://docs.nvidia.com#archiver-binary-executable-arbin)
...
)[](http://docs.nvidia.com#cudadevrt-none-static-cudadevrt)
...
)[](http://docs.nvidia.com#libdevice-directory-directory-ldir)
...
)[](http://docs.nvidia.com#target-directory-string-target-dir)
...
)[](http://docs.nvidia.com#apply-controls-apply-controls)
...
###
4.2.2. Options for Specifying the Compilation Phase[](http://docs.nvidia.com#options-for-specifying-the-compilation-phase)
...
)[](http://docs.nvidia.com#link-link)
...
)[](http://docs.nvidia.com#device-link-dlink)
...
)[](http://docs.nvidia.com#device-c-dc)
...
)[](http://docs.nvidia.com#device-w-dw)
...
)[](http://docs.nvidia.com#compile-c)
...
)[](http://docs.nvidia.com#fatbin-fatbin)
...
)[](http://docs.nvidia.com#cubin-cubin)
...
)[](http://docs.nvidia.com#tilefatbin-tilefatbin)
...
)[](http://docs.nvidia.com#tilecubin-tilecubin)
...
)[](http://docs.nvidia.com#tilebc-tilebc)
...
)[](http://docs.nvidia.com#preprocess-e)
...
)[](http://docs.nvidia.com#generate-dependencies-m)
...
)[](http://docs.nvidia.com#generate-nonsystem-dependencies-mm)
...
)[](http://docs.nvidia.com#generate-dependencies-with-compile-md)
...
)[](http://docs.nvidia.com#generate-nonsystem-dependencies-with-compile-mmd)
...
)[](http://docs.nvidia.com#optix-ir-optix-ir)
...
)[](http://docs.nvidia.com#ltoir-ltoir)
...
###
4.2.3. Options for Specifying Behavior of Compiler/Linker[](http://docs.nvidia.com#options-for-specifying-behavior-of-compiler-linker)
...
)[](http://docs.nvidia.com#enable-tile-enable-tile)
...
)[](http://docs.nvidia.com#tile-only-tile-only)
...
)[](http://docs.nvidia.com#simt-only-simt-only)
...
)[](http://docs.nvidia.com#profile-pg)
...
)[](http://docs.nvidia.com#device-debug-g)
...
)[](http://docs.nvidia.com#extensible-whole-program-ewp)
...
)[](http://docs.nvidia.com#no-compress-no-compress)
...
)[](http://docs.nvidia.com#compress-mode-default-size-speed-balance-none-compress-mode)
...
)[](http://docs.nvidia.com#concat-concat)
...
)[](http://docs.nvidia.com#relocatable-ptx-reloc-ptx)
...
)[](http://docs.nvidia.com#generate-line-info-lineinfo)
...
)[](http://docs.nvidia.com#optimization-info-kind-opt-info)
...
)[](http://docs.nvidia.com#optimize-level-o)
...
)[](http://docs.nvidia.com#ofast-compile-level-ofc)
...
)[](http://docs.nvidia.com#dopt-kind-dopt)
...
)[](http://docs.nvidia.com#dlink-time-opt-dlto)
...
)[](http://docs.nvidia.com#gen-opt-lto-gen-opt-lto)
...
)[](http://docs.nvidia.com#split-compile-number-split-compile)
...
)[](http://docs.nvidia.com#split-compile-extended-number-split-compile-extended)
...
)[](http://docs.nvidia.com#jobserver-jobserver)
...
)[](http://docs.nvidia.com#skip-ptx-semantics-check-skip-ptx-semantics-check)
...
)[](http://docs.nvidia.com#ftemplate-backtrace-limit-limit-ftemplate-backtrace-limit)
...
)[](http://docs.nvidia.com#ftemplate-depth-limit-ftemplate-depth)
...
)[](http://docs.nvidia.com#no-exceptions-noeh)
...
)[](http://docs.nvidia.com#x-c-c-cu-x)
...
)[](http://docs.nvidia.com#std-c-03-c-11-c-14-c-17-c-20-c-23-std)
...
)[](http://docs.nvidia.com#no-host-device-initializer-list-nohdinitlist)
...
)[](http://docs.nvidia.com#expt-relaxed-constexpr-expt-relaxed-constexpr)
...
)[](http://docs.nvidia.com#extended-lambda-extended-lambda)
...
)[](http://docs.nvidia.com#expt-extended-lambda-expt-extended-lambda)
...
)[](http://docs.nvidia.com#machine-64-m)
...
)[](http://docs.nvidia.com#host-linker-script-use-lcs-gen-lcs-hls)
...
)[](http://docs.nvidia.com#augment-host-linker-script-aug-hls)
...
)[](http://docs.nvidia.com#relocatable-link-r)
...
)[](http://docs.nvidia.com#frandom-seed-frandom-seed)
...
###
4.2.4. Options for Passing Specific Phase Options[](http://docs.nvidia.com#options-for-passing-specific-phase-options)
...
)[](http://docs.nvidia.com#compiler-options-options-xcompiler)
...
)[](http://docs.nvidia.com#linker-options-options-xlinker)
...
)[](http://docs.nvidia.com#archive-options-options-xarchive)
...
)[](http://docs.nvidia.com#ptxas-options-options-xptxas)
...
)[](http://docs.nvidia.com#nvlink-options-options-xnvlink)
...
)[](http://docs.nvidia.com#nvprune-options-options-xnvprune)
...
)[](http://docs.nvidia.com#tileiras-options-options-xtileiras)
...
###
4.2.5. Options for Guiding the Compiler Driver[](http://docs.nvidia.com#options-for-guiding-the-compiler-driver)
...
)[](http://docs.nvidia.com#static-global-template-stub-true-false-static-global-template-stub)
...
)[](http://docs.nvidia.com#forward-unknown-to-host-compiler-forward-unknown-to-host-compiler)
...
)[](http://docs.nvidia.com#forward-unknown-to-host-linker-forward-unknown-to-host-linker)
...
)[](http://docs.nvidia.com#forward-unknown-opts-forward-unknown-opts)
...
)[](http://docs.nvidia.com#forward-slash-prefix-opts-forward-slash-prefix-opts)
...
)[](http://docs.nvidia.com#dont-use-profile-noprof)
...
)[](http://docs.nvidia.com#threads-number-t)
...
)[](http://docs.nvidia.com#dryrun-dryrun)
...
)[](http://docs.nvidia.com#verbose-v)
...
)[](http://docs.nvidia.com#keep-keep)
...
)[](http://docs.nvidia.com#keep-dir-directory-keep-dir)
...
)[](http://docs.nvidia.com#save-temps-save-temps)
...
)[](http://docs.nvidia.com#clean-targets-clean)
...
)[](http://docs.nvidia.com#run-args-arguments-run-args)
...
)[](http://docs.nvidia.com#use-local-env-use-local-env)
...
)[](http://docs.nvidia.com#force-cl-env-setup-force-cl-env-setup)
...
)[](http://docs.nvidia.com#input-drive-prefix-prefix-idp)
...
)[](http://docs.nvidia.com#dependency-drive-prefix-prefix-ddp)
...
)[](http://docs.nvidia.com#drive-prefix-prefix-dp)
...
)[](http://docs.nvidia.com#dependency-target-name-target-mt)
...
[](http://docs.nvidia.com#no-align-double)
...
)[](http://docs.nvidia.com#no-device-link-nodlink)
...
)[](http://docs.nvidia.com#prune-prune)
...
)[](http://docs.nvidia.com#options-for-guiding-compiler-driver-allow-unsupported-compiler)
...
###
4.2.6. Options for Steering CUDA Compilation[](http://docs.nvidia.com#options-for-steering-cuda-compilation)
...
)[](http://docs.nvidia.com#default-stream-legacy-null-per-thread-default-stream)
...
###
4.2.7. Options for Steering GPU Code Generation[](http://docs.nvidia.com#options-for-steering-gpu-code-generation)
...
)[](http://docs.nvidia.com#gpu-architecture-arch)
...
See [Virtual Architecture Feature List](http://docs.nvidia.com#virtual-architecture-feature-list) for the list of supported *virtual* architectures and [GPU Feature List](http://docs.nvidia.com#gpu-feature-list) for the list of supported *real* architectures.
...
)[](http://docs.nvidia.com#gpu-code-code-code)
...
)[](http://docs.nvidia.com#generate-code-specification-gencode)
...
)[](http://docs.nvidia.com#relocatable-device-code-true-false-rdc)
...
)[](http://docs.nvidia.com#entries-entry-e)
...
)[](http://docs.nvidia.com#maxrregcount-amount-maxrregcount)
...
)[](http://docs.nvidia.com#use-fast-math-use-fast-math)
...
)[](http://docs.nvidia.com#ftz-true-false-ftz)
...
)[](http://docs.nvidia.com#prec-div-true-false-prec-div)
...
)[](http://docs.nvidia.com#prec-sqrt-true-false-prec-sqrt)
...
)[](http://docs.nvidia.com#fmad-true-false-fmad)
...
)[](http://docs.nvidia.com#extra-device-vectorization-extra-device-vectorization)
...
)[](http://docs.nvidia.com#compile-as-tools-patch-astoolspatch)

Compile patch code for CUDA tools. Implies [–keep-device-functions](http://docs.nvidia.com#options-for-steering-gpu-code-generation-keep-device-functions).
...
)[](http://docs.nvidia.com#keep-device-functions-keep-device-functions)
...
)[](http://docs.nvidia.com#jump-table-density-percentage-jtd)
...
###
4.2.8. Generic Tool Options[](http://docs.nvidia.com#generic-tool-options)
...
)[](http://docs.nvidia.com#disable-warnings-w)
...
)[](http://docs.nvidia.com#source-in-ptx-src-in-ptx)
...
)[](http://docs.nvidia.com#restrict-restrict)
...
)[](http://docs.nvidia.com#wno-deprecated-gpu-targets-wno-deprecated-gpu-targets)
...
)[](http://docs.nvidia.com#wno-deprecated-declarations-wno-deprecated-declarations)
...
)[](http://docs.nvidia.com#wreorder-wreorder)
...
)[](http://docs.nvidia.com#fmax-errors-number-fmax-errors)
...
)[](http://docs.nvidia.com#wdefault-stream-launch-wdefault-stream-launch)
...
)[](http://docs.nvidia.com#wmissing-launch-bounds-wmissing-launch-bounds)
...
)[](http://docs.nvidia.com#wext-lambda-captures-this-wext-lambda-captures-this)
...
)[](http://docs.nvidia.com#wconversion-wconversion)
...
)[](http://docs.nvidia.com#werror-kind-werror)
...
)[](http://docs.nvidia.com#display-error-number-err-no)
...
)[](http://docs.nvidia.com#no-display-error-number-no-err-no)
...
)[](http://docs.nvidia.com#diag-error-errnum-diag-error)
...
)[](http://docs.nvidia.com#diag-suppress-errnum-diag-suppress)
...
)[](http://docs.nvidia.com#diag-warn-errnum-diag-warn)
...
)[](http://docs.nvidia.com#resource-usage-res-usage)
...
)[](http://docs.nvidia.com#device-stack-protector-true-false-device-stack-protector)
...
)[](http://docs.nvidia.com#utf-8-utf-8)
...
)[](http://docs.nvidia.com#version-v)
...
)[](http://docs.nvidia.com#options-file-file-optf)
...
)[](http://docs.nvidia.com#time-filename-time)
...
)[](http://docs.nvidia.com#qpp-config-config-qpp-config)
...
)[](http://docs.nvidia.com#list-gpu-code-code-ls)

List the non-architecture-specific gpu architectures (sm_XX) supported by the tool and exit.

If both [–list-gpu-code](http://docs.nvidia.com#generic-tool-options-list-gpu-code) and [–list-gpu-arch](http://docs.nvidia.com#generic-tool-options-list-gpu-arch) are set, the list is displayed using the same format as the [–generate-code](http://docs.nvidia.com#options-for-steering-gpu-code-generation) value.
...
)[](http://docs.nvidia.com#list-gpu-arch-arch-ls)

List the non-architecture-specific virtual device architectures (compute_XX) supported by the tool and exit.

If both [–list-gpu-arch](http://docs.nvidia.com#generic-tool-options-list-gpu-arch) and [–list-gpu-code](http://docs.nvidia.com#generic-tool-options-list-gpu-code) are set, the list is displayed using the same format as the [–generate-code](http://docs.nvidia.com#options-for-steering-gpu-code-generation) value.
...
)[](http://docs.nvidia.com#fdevice-time-trace-fdevice-time-trace)

Enables the time profiler, outputting a JSON file based on given file name. If file name is ‘-’, the JSON file will have the same name as the user provided output file [-o](http://docs.nvidia.com#file-and-path-specifications-output-file), otherwise it will be set to ‘trace.json’.
...
)[](http://docs.nvidia.com#fdevice-sanitize-fdevice-sanitize)
...
###
4.2.9. Phase Options[](http://docs.nvidia.com#phase-options)

The following sections lists some useful options to lower level compilation tools.

####
4.2.9.1. Ptxas Options[](http://docs.nvidia.com#ptxas-options)
...
)[](http://docs.nvidia.com#allow-expensive-optimizations-allow-expensive-optimizations)
...
)[](http://docs.nvidia.com#ptxas-options-apply-controls)

Semantics same as `nvcc`

option [–apply-controls](http://docs.nvidia.com#file-and-path-specifications-apply-controls).
...
)[](http://docs.nvidia.com#compile-only-c)
...
)[](http://docs.nvidia.com#compiler-annotations-annotate)
...
)[](http://docs.nvidia.com#def-load-cache-dlcm)
...
)[](http://docs.nvidia.com#def-store-cache-dscm)
...
)[](http://docs.nvidia.com#ptxas-options-device-debug)
...
)[](http://docs.nvidia.com#disable-optimizer-constants-disable-optimizer-consts)
...
)[](http://docs.nvidia.com#entry-entry-e)
...
)[](http://docs.nvidia.com#fmad-fmad)
...
)[](http://docs.nvidia.com#force-load-cache-flcm)
...
)[](http://docs.nvidia.com#force-store-cache-fscm)
...
)[](http://docs.nvidia.com#ptxas-options-generate-line-info)
...
)[](http://docs.nvidia.com#gpu-name-gpuname-arch)
...
)[](http://docs.nvidia.com#ptxas-options-help)
...
)[](http://docs.nvidia.com#machine-m)
...
)[](http://docs.nvidia.com#ptxas-options-maxrregcount)
...
)[](http://docs.nvidia.com#opt-level-n-o)
...
)[](http://docs.nvidia.com#ptxas-options-options-file)
...
)[](http://docs.nvidia.com#position-independent-code-pic)
...
)[](http://docs.nvidia.com#preserve-relocs-preserve-relocs)
...
)[](http://docs.nvidia.com#sp-bounds-check-sp-bounds-check)
...
)[](http://docs.nvidia.com#suppress-async-bulk-multicast-advisory-warning-suppress-async-bulk-multicast-advisory-warning)
...
)[](http://docs.nvidia.com#suppress-sparse-mma-advisory-info-suppress-sparse-mma-advisory-info)
...
)[](http://docs.nvidia.com#ptxas-options-verbose)
...
)[](http://docs.nvidia.com#ptxas-options-version)
...
)[](http://docs.nvidia.com#warning-as-error-werror)
...
)[](http://docs.nvidia.com#warn-on-double-precision-use-warn-double-usage)
...
)[](http://docs.nvidia.com#warn-on-local-memory-usage-warn-lmem-usage)
...
)[](http://docs.nvidia.com#warn-on-spills-warn-spills)
...
)[](http://docs.nvidia.com#ptxas-options-compile-as-tools-patch)
...
)[](http://docs.nvidia.com#maxntid-maxntid)
...
)[](http://docs.nvidia.com#minnctapersm-minnctapersm)
...
)[](http://docs.nvidia.com#override-directive-values-override-directive-values)
...
)[](http://docs.nvidia.com#make-errors-visible-at-exit-make-errors-visible-at-exit)
...
)[](http://docs.nvidia.com#ptxas-options-ofast-compile)
...
)[](http://docs.nvidia.com#device-stack-protector-device-stack-protector)
...
)[](http://docs.nvidia.com#g-tensor-memory-access-check-g-tmem-access-check)
...
)[](http://docs.nvidia.com#gno-tensor-memory-access-check-gno-tmem-access-check)
...
)[](http://docs.nvidia.com#split-compile-split-compile)
...
)[](http://docs.nvidia.com#ptxas-options-jobserver)
...
)[](http://docs.nvidia.com#sanitize-sanitize)
...
####
4.2.9.3. NVLINK Options[](http://docs.nvidia.com#nvlink-options)
...
)[](http://docs.nvidia.com#nvlink-options-disable-warnings)
...
)[](http://docs.nvidia.com#nvlink-options-preserve-relocs)
...
)[](http://docs.nvidia.com#nvlink-options-verbose)
...
)[](http://docs.nvidia.com#nvlink-options-warning-as-error)
...
)[](http://docs.nvidia.com#suppress-arch-warning-suppress-arch-warning)
...
)[](http://docs.nvidia.com#suppress-stack-size-warning-suppress-stack-size-warning)
...
)[](http://docs.nvidia.com#dump-callgraph-dump-callgraph)
...
)[](http://docs.nvidia.com#dump-callgraph-no-demangle-dump-callgraph-no-demangle)
...
)[](http://docs.nvidia.com#xptxas-xptxas)
...
)[](http://docs.nvidia.com#cpu-arch-cpu-arch)
...
)[](http://docs.nvidia.com#extra-warnings-extrawarn)
...
)[](http://docs.nvidia.com#gen-host-linker-script-ghls)
...
)[](http://docs.nvidia.com#ignore-host-info-ignore-host-info)
...
)[](http://docs.nvidia.com#keep-system-libraries-keep-system-libraries)
...
)[](http://docs.nvidia.com#kernels-used-kernels-used)
...
)[](http://docs.nvidia.com#options-file-optf)
...
)[](http://docs.nvidia.com#report-arch-report-arch)
...
)[](http://docs.nvidia.com#suppress-debug-info-suppress-debug-info)
...
)[](http://docs.nvidia.com#variables-used-variables-used)
...
)[](http://docs.nvidia.com#nvlink-options-device-stack-protector)
...
##
4.3. NVCC Environment Variables[](http://docs.nvidia.com#nvcc-environment-variables)
...
#
5. GPU Compilation[](http://docs.nvidia.com#gpu-compilation)
...
##
5.1. GPU Generations[](http://docs.nvidia.com#gpu-generations)
...
##
5.2. GPU Feature List[](http://docs.nvidia.com#gpu-feature-list)
...
##
5.3. Application Compatibility[](http://docs.nvidia.com#application-compatibility)
...
##
5.4. Virtual Architectures[](http://docs.nvidia.com#virtual-architectures)
...
##
5.5. Virtual Architecture Feature List[](http://docs.nvidia.com#virtual-architecture-feature-list)
...
The above table lists the currently defined virtual architectures. The virtual architecture naming scheme is the same as the real architecture naming scheme shown in Section [GPU Feature List](http://docs.nvidia.com#gpu-feature-list).

##
5.6. Further Mechanisms[](http://docs.nvidia.com#further-mechanisms)
...
###
5.6.1. Just-in-Time Compilation[](http://docs.nvidia.com#just-in-time-compilation)
...
###
5.6.2. Fatbinaries[](http://docs.nvidia.com#fatbinaries)
...
##
5.7. NVCC Examples[](http://docs.nvidia.com#nvcc-examples)

###
5.7.1. Base Notation[](http://docs.nvidia.com#base-notation)
...
###
5.7.2. Shorthand[](http://docs.nvidia.com#shorthand)
...
####
5.7.2.1. Shorthand 1[](http://docs.nvidia.com#shorthand-1)
...
####
5.7.2.2. Shorthand 2[](http://docs.nvidia.com#shorthand-2)
...
####
5.7.2.3. Shorthand 3[](http://docs.nvidia.com#shorthand-3)
...
###
5.7.3. GPU Code Generation in CUDA[](http://docs.nvidia.com#gpu-code-generation-in-cuda)

####
5.7.3.1. List of Supported GPU Codes[](http://docs.nvidia.com#list-of-supported-gpu-codes)
...
####
5.7.3.2. Extended Notation[](http://docs.nvidia.com#id55)
...
####
5.7.3.3. Using Code Generation Options[](http://docs.nvidia.com#using-code-generation-options)
...
###
5.7.4. Virtual Architecture Macros[](http://docs.nvidia.com#virtual-architecture-macros)
...
#
6. Using Separate Compilation in CUDA[](http://docs.nvidia.com#using-separate-compilation-in-cuda)
...
##
6.1. Code Changes for Separate Compilation[](http://docs.nvidia.com#code-changes-for-separate-compilation)
...
##
6.2. NVCC Options for Separate Compilation[](http://docs.nvidia.com#nvcc-options-for-separate-compilation)
...
##
6.3. Libraries[](http://docs.nvidia.com#libraries)
...
##
6.4. Examples[](http://docs.nvidia.com#examples)
...
##
6.5. Optimization Of Separate Compilation[](http://docs.nvidia.com#optimization-of-separate-compilation)
...
##
6.6. Potential Separate Compilation Issues[](http://docs.nvidia.com#potential-separate-compilation-issues)

###
6.6.1. Object Compatibility[](http://docs.nvidia.com#object-compatibility)
...
###
6.6.2. JIT Linking Support[](http://docs.nvidia.com#jit-linking-support)
...
###
6.6.3. Implicit CUDA Host Code[](http://docs.nvidia.com#implicit-cuda-host-code)
...
###
6.6.4. Using __CUDA_ARCH__[](http://docs.nvidia.com#using-cuda-arch)
...
###
6.6.5. Device Code in Libraries[](http://docs.nvidia.com#device-code-in-libraries)
...
###
6.6.6. Tile Support In Separate Compilation[](http://docs.nvidia.com#tile-support-in-separate-compilation)
...
#
7. Tile Compilation in CUDA[](http://docs.nvidia.com#tile-compilation-in-cuda)

Beginning in CUDA 13.3, CUDA C++ supports both Tile and SIMT code in the same translation unit [1](http://docs.nvidia.com#id67). Tile compilation support
...
[1](http://docs.nvidia.com#id66)-
Refer to the CUDA Programming Guide for details on Tile and SIMT programming.


#
8. Miscellaneous NVCC Usage[](http://docs.nvidia.com#miscellaneous-nvcc-usage)

##
8.1. Cross Compilation[](http://docs.nvidia.com#cross-compilation)
...
##
8.2. Keeping Intermediate Phase Files[](http://docs.nvidia.com#keeping-intermediate-phase-files)
...
instead, with names as described in [Supported Phases](http://docs.nvidia.com#supported-phases).

##
8.3. Cleaning Up Generated Files[](http://docs.nvidia.com#cleaning-up-generated-files)
...
##
8.4. Printing Code Generation Statistics[](http://docs.nvidia.com#printing-code-generation-statistics)
...
#
9. Notices[](http://docs.nvidia.com#notices)

##
9.1. Notice[](http://docs.nvidia.com#notice)
...
##
9.2. OpenCL[](http://docs.nvidia.com#opencl)

OpenCL is a trademark of Apple Inc. used under license to the Khronos Group Inc.

##
9.3. Trademarks[](http://docs.nvidia.com#trademarks)
