source: https://docs.nvidia.com/compute-sanitizer/SanitizerApi/table-of-contents.html

# Sanitizer API[#](https://docs.nvidia.com#sanitizer-api)

The reference guide for the NVIDIA Compute Sanitizer API.

The NVIDIA Compute Sanitizer API.
