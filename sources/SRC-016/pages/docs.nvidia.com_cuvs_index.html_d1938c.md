source: https://docs.nvidia.com/cuvs/index.html
...
[Example Notebooks](https://github.com/nvidia/cuvs/tree/HEAD/notebooks): Example notebooks[Code Examples](https://github.com/nvidia/cuvs/tree/HEAD/examples): Self-contained code examples[RAPIDS Community](https://rapids.ai/community.html): Get help, contribute, and collaborate.[GitHub repository](https://github.com/nvidia/cuvs): Download the NVIDIA cuVS source code.[Issue tracker](https://github.com/nvidia/cuvs/issues): Report issues or request features.
...
[Parameter tuning](https://docs.nvidia.com/cuvs/getting-started/introduction/tuning-indexes)- Cost savings
