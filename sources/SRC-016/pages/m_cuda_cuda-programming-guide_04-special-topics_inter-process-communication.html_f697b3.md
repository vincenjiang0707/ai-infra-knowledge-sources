source: https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/inter-process-communication.html

# 4.16. Interprocess Communication[#](https://docs.nvidia.com#interprocess-communication)
...
## 4.16.1. IPC using the Legacy Interprocess Communication API[#](https://docs.nvidia.com#ipc-using-the-legacy-interprocess-communication-api)
...
uses the IPC handle to retrieve a valid device pointer that can be used within the other process.
...
Note that the IPC API is not supported for `cudaMallocManaged`
...
Allocations made by `cudaMalloc()`
...
## 4.16.2. IPC using the Virtual Memory Management API[#](https://docs.nvidia.com#ipc-using-the-virtual-memory-management-api)
