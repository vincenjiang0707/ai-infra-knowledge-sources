...
# CUDA Programming Guide[#](https://docs.nvidia.com#cuda-programming-guide)
...
This guide starts with a chapter on the [CUDA programming model](https://docs.nvidia.com/01-introduction/programming-model.html#programming-model) outside of any specific programming language which is applicable to anyone interested in understanding how CUDA works, even non-developers.
...
[tour of the features covered in part 4](https://docs.nvidia.com/03-advanced/feature-survey.html#tour-of-features)with a brief introduction to the purpose and function of each, sorted by when and why a developer may find each feature useful.
