...
**up to 65% reduction in Time-to-First-Token (TTFT)****22% improvement in Time-Per-Output-Token (TPOT)**
...
These optimizations are not just experimental — they have already been deployed and validated in

[Novita AI's]production inference service.
