...
source: https://rocm.blogs.amd.com/ecosystems-and-partners/cdna5-helios/README.html

# Introducing AMD CDNA™ 5 and the AMD Helios™ Rackscale Solution[#](https://rocm.blogs.amd.com#introducing-amd-cdna-5-and-the-amd-helios-rackscale-solution)
...
## AI Infrastructure Must Evolve Beyond the GPU[#](https://rocm.blogs.amd.com#ai-infrastructure-must-evolve-beyond-the-gpu)
...
## Reimagining AI Compute[#](https://rocm.blogs.amd.com#reimagining-ai-compute)
...
**4x greater AI compute throughput**for key low-precision formatsMI400-006**432 GB HBM4**memory**2.91x memory bandwidth**MI400-008Larger caches and local memories
...
## Memory Designed for Large Models[#](https://rocm.blogs.amd.com#memory-designed-for-large-models)
...
## From Eight GPUs to an Entire Rack[#](https://rocm.blogs.amd.com#from-eight-gpus-to-an-entire-rack)
...
## Built on Open Networking[#](https://rocm.blogs.amd.com#built-on-open-networking)
...
## AI Infrastructure Beyond Silicon[#](https://rocm.blogs.amd.com#ai-infrastructure-beyond-silicon)
...
**31 TB of HBM4**GPU memory**18**AMD EPYC™ “Venice” processors, each with up to 256 cores**Up to 36 TB of DDR5 memory****260 TB/s**high-bandwidth scale-up switchingOpen Ethernet scale-out networking
...
## Architected for Rack-Scale Resiliency[#](https://rocm.blogs.amd.com#architected-for-rack-scale-resiliency)
...
## Software Completes the Solution[#](https://rocm.blogs.amd.com#software-completes-the-solution)
...
## Looking Ahead[#](https://rocm.blogs.amd.com#looking-ahead)
...
## Endnotes[#](https://rocm.blogs.amd.com#endnotes)
