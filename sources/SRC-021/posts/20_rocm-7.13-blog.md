...
source: https://rocm.blogs.amd.com/ecosystems-and-partners/rocm-7.13-blog/README.html

# ROCm 7.13: Expanding Hardware, Tools, and Reach[#](https://rocm.blogs.amd.com#rocm-7-13-expanding-hardware-tools-and-reach)
...
## TheRock Powers the ROCm Core SDK[#](https://rocm.blogs.amd.com#therock-powers-the-rocm-core-sdk)
...
## Expanded Hardware & Platform Enablement[#](https://rocm.blogs.amd.com#expanded-hardware-platform-enablement)
...
## GPU Virtualization Across KVM and VMware ESXi[#](https://rocm.blogs.amd.com#gpu-virtualization-across-kvm-and-vmware-esxi)
...
## Multi-Node Communication Strix Halo[#](https://rocm.blogs.amd.com#multi-node-communication-strix-halo)
...
### Streamlined Profiling with rocprofiler-systems[#](https://rocm.blogs.amd.com#streamlined-profiling-with-rocprofiler-systems)
...
### AI Development on Radeon[#](https://rocm.blogs.amd.com#ai-development-on-radeon)
...
## Major Tool Enhancements[#](https://rocm.blogs.amd.com#major-tool-enhancements)
...
### Open Source ROCprof Trace Decoder[#](https://rocm.blogs.amd.com#open-source-rocprof-trace-decoder)
...
### Live Attach/Detach Profiling[#](https://rocm.blogs.amd.com#live-attach-detach-profiling)
...
### Visualization with ROCm Optiq[#](https://rocm.blogs.amd.com#visualization-with-rocm-optiq)
...
## Packaging and Installation with ROCm 7.13[#](https://rocm.blogs.amd.com#packaging-and-installation-with-rocm-7-13)
...
### ROCm-Extras[#](https://rocm.blogs.amd.com#rocm-extras)
...
### Supported Linux and Windows Distributions[#](https://rocm.blogs.amd.com#supported-linux-and-windows-distributions)
...
### Multi-Architecture Support[#](https://rocm.blogs.amd.com#multi-architecture-support)
...
[AMD Enterprise AI Documentation](https://enterprise-ai.docs.amd.com/en/latest/workbench/overview.html)to learn more about the AMD Enterprise AI Suite.To learn more about TheRock, see

[TheRock Blog Post](https://rocm.blogs.amd.com/software-tools-optimization/therock/README.html).For more technical information on the latest ROCm release, see the

[ROCm 7.13 Release Notes](https://rocm.docs.amd.com/en/7.13.0-preview/about/release-notes.html).For information on the AMDGPU Driver (amdgpu) release, see the

[AMDGPU Driver 31.30.0 Release Notes](https://instinct.docs.amd.com/projects/amdgpu-docs/en/31.30.0-preview/documentation/release-notes.html).For more information on the AMD GPU Virtualization (GIM) release, see the

[GIM 9.0.0.K Release Notes](https://github.com/amd/MxGPU-Virtualization/releases).
