...
source: https://rocm.blogs.amd.com/software-tools-optimization/rocm7.2/README.html

# ROCm 7.2: Smarter, Faster, and More Scalable for Modern AI Workloads[#](https://rocm.blogs.amd.com#rocm-7-2-smarter-faster-and-more-scalable-for-modern-ai-workloads)
...
## hipBLASLt Optimization and Enhancements[#](https://rocm.blogs.amd.com#hipblaslt-optimization-and-enhancements)
...
## Single Root IO Virtualization (SR-IOV)/RAS Features for MI350X/MI355X[#](https://rocm.blogs.amd.com#single-root-io-virtualization-sr-iov-ras-features-for-mi350x-mi355x)
...
## Performance Boost with GEMM Tuning[#](https://rocm.blogs.amd.com#performance-boost-with-gemm-tuning)
...
## rocMLIR and MIGraphX New Data Types (FP8/FP4) Enablement[#](https://rocm.blogs.amd.com#rocmlir-and-migraphx-new-data-types-fp8-fp4-enablement)
...
## End-to-End Communication Enhancements in ROCm: From GDA to Smart Collectives[#](https://rocm.blogs.amd.com#end-to-end-communication-enhancements-in-rocm-from-gda-to-smart-collectives)
...
## Compiler Enhancements with ThinLTO Support[#](https://rocm.blogs.amd.com#compiler-enhancements-with-thinlto-support)
...
## Optimizing AI Models for AMD Instinct MI300X and MI350 GPUs[#](https://rocm.blogs.amd.com#optimizing-ai-models-for-amd-instinct-mi300x-and-mi350-gpus)
...
## Node Power Management for Multi-GPU Nodes[#](https://rocm.blogs.amd.com#node-power-management-for-multi-gpu-nodes)
