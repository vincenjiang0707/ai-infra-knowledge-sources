...
source: https://rocm.blogs.amd.com/software-tools-optimization/tracelens/README.html

# TraceLens: Democratizing AI Performance Analysis[#](https://rocm.blogs.amd.com#tracelens-democratizing-ai-performance-analysis)
...
## Trace2Tree: Building a Tree Data Structure from Traces[#](https://rocm.blogs.amd.com#trace2tree-building-a-tree-data-structure-from-traces)
...
## Hierarchical Performance Breakdowns: Find the Bottleneck Fast[#](https://rocm.blogs.amd.com#hierarchical-performance-breakdowns-find-the-bottleneck-fast)
...
### The 10,000-Foot View: GPU Timeline[#](https://rocm.blogs.amd.com#the-10-000-foot-view-gpu-timeline)
...
### Finding Hotspots: Ops Summary by Category[#](https://rocm.blogs.amd.com#finding-hotspots-ops-summary-by-category)
...
### The Root Cause: Ops Summary and Input Shapes[#](https://rocm.blogs.amd.com#the-root-cause-ops-summary-and-input-shapes)
...
### Breaking Down Operations by Type and Unique Input Shape[#](https://rocm.blogs.amd.com#breaking-down-operations-by-type-and-unique-input-shape)
...
## Compute Modeling: Are Your Kernels Using the Hardware Efficiently?[#](https://rocm.blogs.amd.com#compute-modeling-are-your-kernels-using-the-hardware-efficiently)
...
## Multi-GPU Communication Analysis: Finding True Scaling Bottlenecks[#](https://rocm.blogs.amd.com#multi-gpu-communication-analysis-finding-true-scaling-bottlenecks)
...
## Trace Comparison: Quantify the Impact of Your Changes[#](https://rocm.blogs.amd.com#trace-comparison-quantify-the-impact-of-your-changes)
...
## Event Replay: Isolate and Debug Operations[#](https://rocm.blogs.amd.com#event-replay-isolate-and-debug-operations)
...
## Try It[#](https://rocm.blogs.amd.com#try-it)
