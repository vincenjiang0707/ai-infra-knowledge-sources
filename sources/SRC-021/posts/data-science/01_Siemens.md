...
source: https://rocm.blogs.amd.com/ecosystems-and-partners/Siemens/README.html

# Siemens taps AMD Instinct™ GPUs to expand high-performance hardware options for Simcenter STAR-CCM+[#](https://rocm.blogs.amd.com#siemens-taps-amd-instinct-gpus-to-expand-high-performance-hardware-options-for-simcenter-star-ccm)
...
## GPUs accelerate bottom lines[#](https://rocm.blogs.amd.com#gpus-accelerate-bottom-lines)
...
## AMD Instinct MI200 GPUs stand apart[#](https://rocm.blogs.amd.com#amd-instinct-mi200-gpus-stand-apart)
...
## AMD ROCm and HIP smooth the transition[#](https://rocm.blogs.amd.com#amd-rocm-and-hip-smooth-the-transition)
...
## Collaborating to serve the customer[#](https://rocm.blogs.amd.com#collaborating-to-serve-the-customer)
...
## Looking ahead to MI300 and beyond[#](https://rocm.blogs.amd.com#looking-ahead-to-mi300-and-beyond)
