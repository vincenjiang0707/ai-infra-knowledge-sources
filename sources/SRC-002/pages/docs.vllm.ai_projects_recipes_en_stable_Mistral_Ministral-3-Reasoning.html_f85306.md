source: https://docs.vllm.ai/projects/recipes/en/stable/Mistral/Ministral-3-Reasoning.html
lastmod: 2026-04-27

# Ministral-3 Reasoning Usage Guide[¶](https://docs.vllm.ai#ministral-3-reasoning-usage-guide)
...
## Running Ministral-3 Reasoning 3B or 8B on 1xH200[¶](https://docs.vllm.ai#running-ministral-3-reasoning-3b-or-8b-on-1xh200)

Due to their size, `Ministral-3-3B-Reasoning-2512`

and `Ministral-3-8B-Reasoning-2512`

can run on a single 1xH200 GPU.
...
## Running Ministral-3 Reasoning 14B on 2xH200[¶](https://docs.vllm.ai#running-ministral-3-reasoning-14b-on-2xh200)

To fully exploit the `Ministral-3-14B-Reasoning-2512`

we recommend using 2xH200 GPUs for deployment due to its large context. However if you don't need a large context, you can fall back to a single GPU.
...
Here we assume that the model `mistralai/Ministral-3-14B-Reasoning-2512`
