source: https://docs.vllm.ai/projects/recipes/en/stable/PaddlePaddle/PaddleOCR-VL.html
lastmod: 2026-04-27

# PaddleOCR-VL Usage Guide[¶](https://docs.vllm.ai#paddleocr-vl-usage-guide)
...
Use separate virtual environments for `vllm`

and `paddlepaddle`

to prevent dependency conflicts. If you encounter the error `The model PaddleOCR-VL-0.9B does not exist.`

, add `--served-model-name PaddleOCR-VL-0.9B`
...
[PaddleOCR-VL documentation](https://github.com/PaddlePaddle/PaddleOCR)for more details and examples of using the model for various document parsing tasks.