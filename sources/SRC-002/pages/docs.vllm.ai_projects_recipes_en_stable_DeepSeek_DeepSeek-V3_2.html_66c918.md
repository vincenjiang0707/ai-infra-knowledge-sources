source: https://docs.vllm.ai/projects/recipes/en/stable/DeepSeek/DeepSeek-V3_2.html
lastmod: 2026-04-27

# DeepSeek-V3.2 Usage Guide[¶](https://docs.vllm.ai#deepseek-v32-usage-guide)
...
## Installing DeepGEMM[¶](https://docs.vllm.ai#installing-deepgemm)

uv pip install git+https://github.com/deepseek-ai/[[email protected]](https://docs.vllm.ai/cdn-cgi/l/email-protection) --no-build-isolation
...
### AIME25[¶](https://docs.vllm.ai#aime25)
...
We used the following script to benchmark `deepseek-ai/DeepSeek-V3.2`
...
### TP8 Benchmark Output[¶](https://docs.vllm.ai#tp8-benchmark-output)
...
### EP/DP Mode[¶](https://docs.vllm.ai#epdp-mode)
...
[DeepSeek-V3_2-Exp recipe](https://docs.vllm.ai/DeepSeek-V3_2-Exp.html)and[Data Parallel Deployment documentation](https://docs.vllm.ai/en/latest/serving/data_parallel_deployment.html)to conduct related experiments and benchmark testing to select the parallel group suitable for your scenario. -
Regarding
...
, you can refer to[DeepSeek-V3_1recipe](https://docs.vllm.ai/DeepSeek-V3_1.html).

## Tool Calling Example[¶](https://docs.vllm.ai#tool-calling-example)
...
-
To enable thinking mode in vLLM, use

**extra_body = {"chat_template_kwargs": {"thinking": True}}**. In the DeepSeek official API, the method to enable thinking mode is**extra_body = {"thinking": {"type": "enabled"}}**. -
For the
...
), In contrast, the DeepSeek official API returns`None`
...
[¶](https://docs.vllm.ai#1-error-ptxas-fatal-value-sm_110a-is-not-defined-for-option-gpu-name)
