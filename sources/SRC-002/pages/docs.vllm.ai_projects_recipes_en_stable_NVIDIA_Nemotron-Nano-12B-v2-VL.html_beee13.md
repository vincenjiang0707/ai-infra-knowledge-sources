source: https://docs.vllm.ai/projects/recipes/en/stable/NVIDIA/Nemotron-Nano-12B-v2-VL.html
lastmod: 2026-04-27

# NVIDIA Nemotron-Nano-12B-v2-VL User Guide[¶](https://docs.vllm.ai#nvidia-nemotron-nano-12b-v2-vl-user-guide)
...
- vLLM 0.11.0 does not include Nemotron-Nano-12B-v2-VL, so either
[install from source](https://docs.vllm.ai/en/v0.6.0/getting_started/installation.html)or refer to[this](https://hub.docker.com/layers/vllm/vllm-openai/nightly-8bff831f0aa239006f34b721e63e1340e3472067/images/sha256-ef112680ed30e4b9d7bf794dcda4abd829e9405a73e013f9e046658cf22d0577)nightly build

For DGX Spark, container relase is avaiable https://catalog.ngc.nvidia.com/orgs/nvidia/containers/vllm?version=25.12.post1-py3

## Serving Nemotron-Nano-12B-v2-VL[¶](https://docs.vllm.ai#serving-nemotron-nano-12b-v2-vl)
...
* You can set `--max-model-len <len>`

([doc](https://docs.vllm.ai/en/latest/configuration/engine_args.html#-max-model-len)) to preserve memory. Model is trained on a context length of ~131K, but unless the use-case is long context videos, a smaller context would fit as-well.
* You can set `--allowed-local-media-path <root>`

([doc](https://docs.vllm.ai/en/latest/configuration/engine_args.html#-allowed-local-media-path)) to limit the accessibility of local files.

#### Efficient Video Sampling (EVS)[¶](https://docs.vllm.ai#efficient-video-sampling-evs)

- You can set
`--video-pruning-rate <fraction>`

to tweak video compression. Read more about EVS on[arXiv](https://arxiv.org/abs/2510.14624).
...
API[¶](https://docs.vllm.ai#vllm-llm-api)

Notes:
* Examples are using [BF16](https://huggingface.co/nvidia/NVIDIA-Nemotron-Nano-12B-v2-VL-BF16) precision model. We encourage you to try [FP8](https://huggingface.co/nvidia/NVIDIA-Nemotron-Nano-12B-v2-VL-FP8) and [NVFP4](https://huggingface.co/nvidia/NVIDIA-Nemotron-Nano-12B-v2-VL-NVFP4-QAD) as well!
* You can set `max_model_len <len>`

([doc](https://docs.vllm.ai/en/latest/configuration/engine_args.html#-max-model-len)) to preserve memory. Model is trained on a context length of ~131K, but unless the use-case is long context videos, a smaller context would fit as-well.
* You can set `allowed_local_media_path <root>`

([doc](https://docs.vllm.ai/en/latest/configuration/engine_args.html#-allowed-local-media-path)) to limit the accessibility of local files.

#### Efficient Video Sampling (EVS)[¶](https://docs.vllm.ai#efficient-video-sampling-evs_1)

- You can set
`video_pruning_rate <fraction>`
...
[import os](https://docs.vllm.ai#__codelineno-6-1)[os.environ["VLLM_VIDEO_LOADER_BACKEND"] = "opencv"](https://docs.vllm.ai#__codelineno-6-2)[from vllm import LLM, SamplingParams](https://docs.vllm.ai#__codelineno-6-4)[model_path = "nvidia/NVIDIA-Nemotron-Nano-12B-v2-VL-BF16"](https://docs.vllm.ai#__codelineno-6-6)[messages = [](https://docs.vllm.ai#__codelineno-6-8)[{](https://docs.vllm.ai#__codelineno-6-9)["role": "user",](https://docs.vllm.ai#__codelineno-6-10)["content": [](https://docs.vllm.ai#__codelineno-6-11)[{](https://docs.vllm.ai#__codelineno-6-12)["type": "text",](https://docs.vllm.ai#__codelineno-6-13)["text": "Describe the video.",](https://docs.vllm.ai#__codelineno-6-14)[},](https://docs.vllm.ai#__codelineno-6-15)[{](https://docs.vllm.ai#__codelineno-6-16)["type": "video_url",](https://docs.vllm.ai#__codelineno-6-17)["video_url": {"url": f"file:///path/to/video.mp4"},](https://docs.vllm.ai#__codelineno-6-18)[},](https://docs.vllm.ai#__codelineno-6-19)[],](https://docs.vllm.ai#__codelineno-6-20)[},](https://docs.vllm.ai#__codelineno-6-21)[]](https://docs.vllm.ai#__codelineno-6-22)[# Efficient Video Sampling (EVS): affects videos only, defines how much of the video tokens to prune](https://docs.vllm.ai#__codelineno-6-24)[# To turn EVS off, use `video_pruning_rate = 0`](https://docs.vllm.ai#__codelineno-6-25)[video_pruning_rate = 0.75](https://docs.vllm.ai#__codelineno-6-26)[llm = LLM(](https://docs.vllm.ai#__codelineno-6-28)[model_path,](https://docs.vllm.ai#__codelineno-6-29)[trust_remote_code=True,](https://docs.vllm.ai#__codelineno-6-30)[video_pruning_rate=video_pruning_rate,](https://docs.vllm.ai#__codelineno-6-31)[max_model_len=2**17, # 131,072](https://docs.vllm.ai#__codelineno-6-32)[# '/' is too permissive and used for example; use a specific directory instead](https://docs.vllm.ai#__codelineno-6-33)[allowed_local_media_path="/",](https://docs.vllm.ai#__codelineno-6-34)[media_io_kwargs=dict(video=dict(fps=2, num_frames=128)),](https://docs.vllm.ai#__codelineno-6-35)[)](https://docs.vllm.ai#__codelineno-6-36)[outputs = llm.chat(](https://docs.vllm.ai#__codelineno-6-38)[messages, sampling_params=SamplingParams(temperature=0, max_tokens=1024)](https://docs.vllm.ai#__codelineno-6-39)[)](https://docs.vllm.ai#__codelineno-6-40)[for o in outputs:](https://docs.vllm.ai#__codelineno-6-42)[print(o.outputs[0].text)](https://docs.vllm.ai#__codelineno-6-43)
