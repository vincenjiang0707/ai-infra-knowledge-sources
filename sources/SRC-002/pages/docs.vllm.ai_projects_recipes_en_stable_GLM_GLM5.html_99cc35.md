source: https://docs.vllm.ai/projects/recipes/en/stable/GLM/GLM5.html
lastmod: 2026-04-27

# GLM-5 and GLM-5.1 Series Usage[¶](https://docs.vllm.ai#glm-5-and-glm-51-series-usage)
...
## Dependencies[¶](https://docs.vllm.ai#dependencies)
...
Please use the `vllm/vllm-openai:glm51-cu130`

Docker image if your CUDA version is 13 or higher.
...
## Model Deployment[¶](https://docs.vllm.ai#model-deployment)

### Serving FP8 Model on 8xH200 (or H20) GPUs (141GB × 8)[¶](https://docs.vllm.ai#serving-fp8-model-on-8xh200-or-h20-gpus-141gb-8)
...
- When using vLLM,
**thinking mode is enabled by default when sending requests**. If you want to disable the thinking switch, you need to add the`"chat_template_kwargs": {"enable_thinking": false}`

parameter. - Support tool calling by default. Please use OpenAI-style tool description format for calls.
