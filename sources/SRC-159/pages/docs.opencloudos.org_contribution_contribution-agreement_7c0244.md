source: https://docs.opencloudos.org/contribution/contribution-agreement/

# OpenCloudOS Corporate CLA

Thank you for your interest in the OpenCloudOS Project ( the "Project") owned and managed by the OpenCloudOS Community. Please read this "Corporate Contributor License Agreement"(the "Agreement" or "CLA")completely, carefully and comprehensively. And sign the agreement if you have no objections to the terms.

In order to clarify the rights granted with Contributions from any person or entity, the Project must have an Agreement on file that has been signed by each Contributor, indicating agreement to the license terms below. This Agreement is for Your protection as a Contributor as well as the protection of the Project; it does not change Your rights to use Your own Contributions for any other purpose.

This version of the Contributor License Agreement (“CLA”) allows an entity (a “Corporation”) to submit contributions, authorize contributions from its designated employees who may have assigned rights in such contributions to the corporation, typically pursuant to their employment agreements with the Corporation and to grant copyright and patent licenses thereto.

Please read this CLA carefully before completing and signing it, and keep a copy for Your records.

The rights that You grant to us under these terms are effective on the date You and Your designated employees first submitted a Contribution to OpenCloudOS, even if Your submission took place before the date You agreed to these terms and conditions. Except for the license granted herein to the Project and recipients of the Work distributed by the Project, You reserve all rights, title, and interest in and to Your Contributions.

1.Definitions

“Project” refers to the OpenCloudOS Project accessible at the address listed in Appendix.

“Contributor” or “You” (or “Your”) shall mean the individual copyright owner or legal entity authorized by the copyright owner that is making this agreement with the OpenCloudOS Community and voluntarily submits a Contribution to the Project. For legal entities, the entity making a Contribution and all other entities that control, are controlled by, or are under common control with that entity are considered to be a single Contributor. For purposes of this definition, “control” means (i) the power, direct or indirect, to cause the direction or management of such entity, whether by contract or otherwise, or (ii) ownership of fifty percent or more of the outstanding shares of such entity, or (iii) beneficial ownership of such entity.
...
8.It is Your responsibility to notify the Project when any change is required to the Corporation's Point of Contact with the Project.

Appendix: Address of the OpenCloudOS Project [1]. https://gitee.com/OpenCloudOS [2]. https://gitee.com/opencloudos-stream