source: https://docs.opencloudos.org/en/centos_migrate/migrate_relative/
...
User Migration Guide: [CentOS8 Migration to OpenCloudOS8 User Manual](https://docs.opencloudos.org/migrate/)
