source: https://docs.opencloudos.org/en/contribution/docs-format-guide/
...
**File names are written in lowercase letters, and words are separated by**For example:`-`

.`docs-format-guide.md`

.**Add**For example:`.en`

after the file name of an English documentation.`docs-format-guide.en.md`
...
. If the code content is plain text, specify`text`

as the language. -
Refer to the

[Chinese Copywriting Guidelines](https://docs.opencloudos.org#Chinese Copywriting Guidelines)at the end of this document when writing Chinese documentations.Note

If necessary, use the tools mentionned in

[tools](https://docs.opencloudos.org#tools)section of the Copywriting Guidelines to ensure the good formatting of the text.
...
[提交一个 issue]反馈相关问题。访问我们网站的最新动态，请
