source: https://docs.opencloudos.org/OC8/install/V8_install/
...
**图形安装模式**，用户根据需要选择语言，软件源，安装磁盘，网络配置等操作。本文着重介绍图形安装的过程。- 自动探测模式，引导之后安装程序就会执行安装操作。
