source: https://docs.opencloudos.org/en/release/v9.2/
...
-
- Unicode encodings are supported up to 14.0.0, with a wider range of encodings supported

-
- Provide new tunable environment variables for flexible use of functions and performance, specifically:
