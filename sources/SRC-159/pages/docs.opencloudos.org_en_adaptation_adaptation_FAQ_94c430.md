source: https://docs.opencloudos.org/en/adaptation/adaptation_FAQ/
...
Q2：在使用`yum install kernel-devel-$(uname -r)`

安装kernel devel包时提示找不到对应内核devel包
