...
source: https://huggingface.co/blog/vibegame
published: Mon, 29 Sep 2025 00:00:00 GMT

Text Generation • 81B • Updated • 309k • 1.05k

#
[
](https://huggingface.co#vibegame-exploring-vibe-coding-games)
VibeGame: Exploring Vibe Coding Games

[Update on GitHub](https://github.com/huggingface/blog/blob/main/vibegame.md)
...
##
[
](https://huggingface.co#what-is-vibe-coding)
What Is "Vibe Coding"?
...
##
[
](https://huggingface.co#context-management)
Context Management
...
to load context at the beginning of a conversation`/nourish`
...
##
[
](https://huggingface.co#initial-exploration)
Initial Exploration
...
###
[
](https://huggingface.co#attempt-1-roblox-mcp)
...
###
[
](https://huggingface.co#attempt-2-unity-mcp)
Attempt 2: Unity MCP
...
- Requires significant domain knowledge to tell the AI
*how*to do things, rather than*what*to do - AI performance was inconsistent and unreliable
...
###
[
](https://huggingface.co#attempt-3-web-stack)
Attempt 3: Web Stack
...
###
[
](https://huggingface.co#comparison-summary)
Comparison Summary
...
##
[
](https://huggingface.co#the-solution-vibegame)
...
###
[
](https://huggingface.co#design-philosophy)
Design Philosophy
...
##
[
](https://huggingface.co#so-does-it-actually-work)
