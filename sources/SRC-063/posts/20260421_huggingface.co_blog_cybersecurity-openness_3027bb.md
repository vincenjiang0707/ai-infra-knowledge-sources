...
#
[
](https://huggingface.co#ai-and-the-future-of-cybersecurity-why-openness-matters)
AI and the Future of Cybersecurity: Why Openness Matters

[Update on GitHub](https://github.com/huggingface/blog/blob/main/cybersecurity-openness.md)

[Mythos and Project Glasswing](https://www.anthropic.com/glasswing), institutions throughout the world are grappling with the potential dawn of a new era of cybersecurity. In this post, we break down the current situation, discuss the role of openness, and situate the future of cybersecurity within the larger AI ecosystem.

##
[
](https://huggingface.co#what-is-mythos)
What is Mythos?
...
##
[
](https://huggingface.co#how-openness-can-be-a-structural-advantage)
...
##
[
](https://huggingface.co#building-defenses-with-open-tools-and-semi-autonomous-agents)
...
##
[
](https://huggingface.co#why-this-matters-especially-for-high-stakes-organizations)
...
##
[
](https://huggingface.co#the-path-forward)
The Path Forward
