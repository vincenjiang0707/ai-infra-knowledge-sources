...
Paper • 2602.00161 • Published • 9

#
[
](https://huggingface.co#pruning-llms-like-a-physicist-block-removal-as-an-ising-optimization-problem)
Pruning LLMs Like a Physicist: Block Removal as an Ising Optimization Problem

[Team Article](https://huggingface.co/blog)

[block removal](https://huggingface.co/papers/2602.00161)(also called depth pruning) buys predictable inference speedups on top of the memory savings, and it stacks cleanly with quantization, low-rank compression, and other techniques. The hard part is deciding
...
Our latest paper, * LLM Compression by Block Removal with Constrained Binary Optimization*, takes that correspondence literally. We reformulate block selection as a constrained binary optimization (CBO) problem that maps directly onto an
...
**23 percentage points on MMLU**over the best competing block-removal method.

##
[
](https://huggingface.co#why-picking-blocks-is-a-many-body-problem)
...
##
[
](https://huggingface.co#the-idea-turn-block-selection-into-an-energy-minimization-problem)
...
That reformulation turns "which blocks should I remove?" into a clean optimization: find the set of *M* blocks whose removal minimizes the energy `xᵀH⁰x`
...
##
[
](https://huggingface.co#solving-it-exact-when-you-can-quantum-or-quantum-inspired-when-you-cant)
...
##
[
](https://huggingface.co#why-the-whole-low-energy-spectrum-matters)
...
##
[
](https://huggingface.co#it-generalizes-beyond-dense-transformers)
...
##
[
](https://huggingface.co#why-this-fits-multiverse-computing)
