...
Sentence Similarity • 8B • Updated • 476 • 23

#
[
](https://huggingface.co#multimodal-embedding--reranker-models-with-sentence-transformers)
Multimodal Embedding & Reranker Models with Sentence Transformers

[Update on GitHub](https://github.com/huggingface/blog/blob/main/multimodal-sentence-transformers.md)

[Sentence Transformers](https://sbert.net/)is a Python library for using and training embedding and reranker models for applications like retrieval augmented generation, semantic search, and more. With the v5.4 update, you can now
...
[What are Multimodal Models?](https://huggingface.co#what-are-multimodal-models)[Installation](https://huggingface.co#installation)[Multimodal Embedding Models](https://huggingface.co#multimodal-embedding-models)[Multimodal Reranker Models](https://huggingface.co#multimodal-reranker-models)[Retrieve and Rerank](https://huggingface.co#retrieve-and-rerank)[Input Formats and Configuration](https://huggingface.co#input-formats-and-configuration)[Supported Models](https://huggingface.co#supported-models)[Additional Resources](https://huggingface.co#additional-resources)

##
[
](https://huggingface.co#what-are-multimodal-models)
...
##
[
](https://huggingface.co#multimodal-embedding-models)
Multimodal Embedding Models

###
[
](https://huggingface.co#loading-a-model)
Loading a Model
...
###
[
](https://huggingface.co#encoding-images)
Encoding Images
...
[Supported Input Types](https://huggingface.co#supported-input-types)for all accepted formats):
...
###
[
](https://huggingface.co#cross-modal-similarity)
...
###
[
](https://huggingface.co#encoding-queries-and-documents)
...
[are the recommended methods. Many retrieval models prepend different instruction prompts depending on whether the input is a query or a document, similar to how chat models might apply different system prompts depending on the goal. Model authors can specify their prompts in the model config, and](https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.encode_document)
...
automatically load and apply the correct one:`encode_query()`

uses the model's`"query"`

prompt (if available) and sets`task="query"`
...
##
[
](https://huggingface.co#multimodal-reranker-models)
...
###
[
](https://huggingface.co#ranking-mixed-modality-documents)
...
[, just like with embedding models:](https://sbert.net/docs/package_reference/cross_encoder/cross_encoder.html#sentence_transformers.cross_encoder.CrossEncoder.supports)
...
###
[
](https://huggingface.co#predicting-pair-scores)
...
##
[
](https://huggingface.co#retrieve-and-rerank)
Retrieve and Rerank
...
##
[
](https://huggingface.co#input-formats-and-configuration)
Input Formats and Configuration

###
[
](https://huggingface.co#supported-input-types)
...
- Strings |
Image |
- `PIL.Image.Image` objects- File paths (e.g. `"./photo.jpg"` )- URLs (e.g. `"https://.../image.jpg"` )- Numpy arrays, torch tensors |
Audio |
- File paths (e.g. `"./audio.wav"` )- URLs (e.g. `"https://.../audio.wav"` )- Numpy/torch arrays - Dicts with `"array"` and `"sampling_rate"` keys- `torchcodec.AudioDecoder` instances |
Video |
- File paths (e.g. `"./video.mp4"` )- URLs (e.g. `"https://.../video.mp4"` )- Numpy/torch arrays - Dicts with `"array"` and `"video_metadata"` keys- `torchcodec.VideoDecoder` instances |
Multimodal |
- Dicts mapping modality names to values, e.g. `{"text": "a caption", "image": "https://.../image.jpg"}` Valid keys: `"text"` , `"image"` , `"audio"` , `"video"` |
Message |
- List of message dicts with `"role"` and `"content"` keys,e.g. `[{"role": "user", "content": [...]}]` |

###
[
](https://huggingface.co#checking-modality-support)
...
[method:](https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.supports)
...
###
[
](https://huggingface.co#processor-and-model-kwargs)
...
controls how inputs are preprocessed (e.g., image resolution bounds). Higher`max_pixels`

means higher quality but more memory and compute. These are passed directly to`AutoProcessor.from_pretrained(...)`

.`model_kwargs`

controls how the underlying model is loaded (e.g., precision, attention implementation). These are passed directly to the appropriate`AutoModel.from_pretrained(...)`
...
has been renamed to`processor_kwargs`
...
###
[
](https://huggingface.co#supported-multimodal-embedding-models)
...
needed[Qwen/Qwen3-VL-Embedding-8B](https://huggingface.co/Qwen/Qwen3-VL-Embedding-8B)`revision`

needed[nvidia/llama-nemotron-embed-vl-1b-v2](https://huggingface.co/nvidia/llama-nemotron-embed-vl-1b-v2)`revision`

needed[nvidia/omni-embed-nemotron-3b](https://huggingface.co/nvidia/omni-embed-nemotron-3b)`revision`

needed[LCO-Embedding/LCO-Embedding-Omni-3B](https://huggingface.co/LCO-Embedding/LCO-Embedding-Omni-3B)`revision`

needed[LCO-Embedding/LCO-Embedding-Omni-7B](https://huggingface.co/LCO-Embedding/LCO-Embedding-Omni-7B)`revision`

needed[BidirLM/BidirLM-Omni-2.5B-Embedding](https://huggingface.co/BidirLM/BidirLM-Omni-2.5B-Embedding)`revision`

needed[BAAI/BGE-VL-base](https://huggingface.co/BAAI/BGE-VL-base)`revision`

needed[BAAI/BGE-VL-large](https://huggingface.co/BAAI/BGE-VL-large)`revision`

needed[BAAI/BGE-VL-MLLM-S1](https://huggingface.co/BAAI/BGE-VL-MLLM-S1)`revision`

needed[BAAI/BGE-VL-MLLM-S2](https://huggingface.co/BAAI/BGE-VL-MLLM-S2)`revision`

needed[BAAI/BGE-VL-v1.5-zs](https://huggingface.co/BAAI/BGE-VL-v1.5-zs)`revision`

needed[BAAI/BGE-VL-v1.5-mmeb](https://huggingface.co/BAAI/BGE-VL-v1.5-mmeb)`revision`

needed[BAAI/BGE-VL-Screenshot](https://huggingface.co/BAAI/BGE-VL-Screenshot)`revision`

needed[royokong/e5-v](https://huggingface.co/royokong/e5-v)`revision`

needed[eagerworks/eager-embed-v1](https://huggingface.co/eagerworks/eager-embed-v1)`revision="refs/pr/2"`

[nomic-ai/nomic-embed-multimodal-3b](https://huggingface.co/nomic-ai/nomic-embed-multimodal-3b)`revision="refs/pr/4"`

[nomic-ai/nomic-embed-multimodal-7b](https://huggingface.co/nomic-ai/nomic-embed-multimodal-7b)`revision="refs/pr/3"`

[Haon-Chen/e5-omni-3B](https://huggingface.co/Haon-Chen/e5-omni-3B)`revision="refs/pr/2"`

[Haon-Chen/e5-omni-7B](https://huggingface.co/Haon-Chen/e5-omni-7B)`revision="refs/pr/1"`

###
[
](https://huggingface.co#supported-multimodal-reranker-models)
...
needed[Qwen/Qwen3-VL-Reranker-8B](https://huggingface.co/Qwen/Qwen3-VL-Reranker-8B)`revision`

needed[nvidia/llama-nemotron-rerank-vl-1b-v2](https://huggingface.co/nvidia/llama-nemotron-rerank-vl-1b-v2)`revision`

needed[jinaai/jina-reranker-m0](https://huggingface.co/jinaai/jina-reranker-m0)`revision`

needed###
[
](https://huggingface.co#text-only-reranker-models-also-new-in-v54)
...
needed[Qwen/Qwen3-Reranker-4B](https://huggingface.co/Qwen/Qwen3-Reranker-4B)`revision`

needed[Qwen/Qwen3-Reranker-8B](https://huggingface.co/Qwen/Qwen3-Reranker-8B)`revision`

needed[mixedbread-ai/mxbai-rerank-base-v2](https://huggingface.co/mixedbread-ai/mxbai-rerank-base-v2)`revision`

needed[mixedbread-ai/mxbai-rerank-large-v2](https://huggingface.co/mixedbread-ai/mxbai-rerank-large-v2)`revision`

needed[ContextualAI/ctxl-rerank-v2-instruct-multilingual-1b](https://huggingface.co/ContextualAI/ctxl-rerank-v2-instruct-multilingual-1b)`revision="refs/pr/2"`

[ContextualAI/ctxl-rerank-v2-instruct-multilingual-2b](https://huggingface.co/ContextualAI/ctxl-rerank-v2-instruct-multilingual-2b)`revision="refs/pr/1"`

[ContextualAI/ctxl-rerank-v2-instruct-multilingual-6b](https://huggingface.co/ContextualAI/ctxl-rerank-v2-instruct-multilingual-6b)`revision="refs/pr/1"`
...
###
[
](https://huggingface.co#clip-models)
CLIP Models
...
[sentence-transformers/clip-ViT-B-16](https://huggingface.co/sentence-transformers/clip-ViT-B-16)[sentence-transformers/clip-ViT-B-32](https://huggingface.co/sentence-transformers/clip-ViT-B-32)[sentence-transformers/clip-ViT-B-32-multilingual-v1](https://huggingface.co/sentence-transformers/clip-ViT-B-32-multilingual-v1)These simple CLIP models still work well on lower-resource hardware.
...
[Sentence Transformer > Usage](https://sbert.net/docs/sentence_transformer/usage/usage.html)[Sentence Transformer > Pretrained Models](https://sbert.net/docs/sentence_transformer/pretrained_models.html)[Cross Encoder > Usage](https://sbert.net/docs/cross_encoder/usage/usage.html)[Cross Encoder > Pretrained Models](https://sbert.net/docs/cross_encoder/pretrained_models.html)[Installation](https://sbert.net/docs/installation.html)
...
[Sentence Transformer > Training Overview](https://sbert.net/docs/sentence_transformer/training_overview.html)[Sentence Transformer > Training Examples](https://sbert.net/docs/sentence_transformer/training/examples.html)[Cross Encoder > Training Overview](https://sbert.net/docs/cross_encoder/training_overview.html)[Cross Encoder > Training Examples](https://sbert.net/docs/cross_encoder/training/examples.html)[Sparse Encoder > Training Overview](https://sbert.net/docs/sparse_encoder/training_overview.html)[Sparse Encoder > Training Examples](https://sbert.net/docs/sparse_encoder/training/examples.html)
...
[Sentence Transformers models on the Hub](https://huggingface.co/models?library=sentence-transformers)[Sentence Transformers datasets on the Hub](https://huggingface.co/datasets?other=sentence-transformers)[v5.4 Integrations Collection](https://huggingface.co/collections/sentence-transformers/sentence-transformers-v54-integrations)
...
[Training and Finetuning Multimodal Embedding & Reranker Models with Sentence Transformers](https://huggingface.co/blog/train-multimodal-sentence-transformers): the direct training companion to this post, with a Visual Document Retrieval walkthrough.[Training and Finetuning Embedding Models with Sentence Transformers](https://huggingface.co/blog/train-sentence-transformers): the general training guide for text-only bi-encoder embedding models.[Training and Finetuning Reranker Models with Sentence Transformers](https://huggingface.co/blog/train-reranker): Cross Encoder (reranker) training, applicable to text-only and multimodal rerankers.[Training and Finetuning Sparse Embedding Models with Sentence Transformers](https://huggingface.co/blog/train-sparse-encoder): SPLADE training for sparse retrieval.[🪆 Introduction to Matryoshka Embedding Models](https://huggingface.co/blog/matryoshka): variable-size embeddings; also applied to multimodal models in the training companion post.[Train 400x faster Static Embedding Models with Sentence Transformers](https://huggingface.co/blog/static-embeddings): CPU-friendly text embedding models.[Binary and Scalar Embedding Quantization for Significantly Faster & Cheaper Retrieval](https://huggingface.co/blog/embedding-quantization): post-training compression of embedding vectors.