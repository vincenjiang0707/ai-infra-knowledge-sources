...
[Update on GitHub](https://github.com/huggingface/blog/blob/main/hf-cli.md)
...
##
[
](https://huggingface.co#🔀-migration)
🔀 Migration
...
##
[
](https://huggingface.co#one-more-thing-💥-hf-jobs)
...
Hugging Face Jobsare available only to[Pro users]and[Team or Enterprise organizations]. Upgrade your plan to get started!