...
Text-to-Image • 8B • Updated • 42 • 8

#
[
](https://huggingface.co#bringing-nunchaku-4-bit-diffusion-inference-to-diffusers)
Bringing Nunchaku 4-bit Diffusion Inference to Diffusers
...
[Getting started with Nunchaku Lite](https://huggingface.co#getting-started-with-nunchaku-lite)[Background: SVDQuant and Nunchaku](https://huggingface.co#background-svdquant-and-nunchaku)[Introducing Nunchaku Lite](https://huggingface.co#introducing-nunchaku-lite)[Native loading in Diffusers](https://huggingface.co#native-loading-in-diffusers)[Getting more speed and lower memory](https://huggingface.co#getting-more-speed-and-lower-memory)[Benchmarks](https://huggingface.co#benchmarks)[Quantizing your own model](https://huggingface.co#quantizing-your-own-model)[Ready-to-use checkpoints](https://huggingface.co#ready-to-use-checkpoints)[Conclusion](https://huggingface.co#conclusion)[Acknowledgements](https://huggingface.co#acknowledgements)

##
[
](https://huggingface.co#getting-started-with-nunchaku-lite)
...
##
[
](https://huggingface.co#background-svdquant-and-nunchaku)
...
##
[
](https://huggingface.co#introducing-nunchaku-lite)
...
##
[
](https://huggingface.co#native-loading-in-diffusers)
...
###
[
](https://huggingface.co#hardware-support)
Hardware support
...
##
[
](https://huggingface.co#getting-more-speed-and-lower-memory)
...
###
[
](https://huggingface.co#end-to-end-latency-and-memory)
...
###
[
](https://huggingface.co#image-quality)
Image quality

##
[
](https://huggingface.co#quantizing-your-own-model)
...
###
[
](https://huggingface.co#1-inspect-what-will-be-quantized)
...
###
[
](https://huggingface.co#2-run-quantization)
2. Run quantization
...
###
[
](https://huggingface.co#3-package-a-diffusers-pipeline)
...
###
[
](https://huggingface.co#4-load-verify-and-push-to-the-hub)
...
###
[
](https://huggingface.co#quantizing-models-with-structural-rewrites)
...
##
[
](https://huggingface.co#ready-to-use-checkpoints)
