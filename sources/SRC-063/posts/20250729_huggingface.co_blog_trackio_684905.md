...
published: Tue, 29 Jul 2025 00:00:00 GMT

#
[
](https://huggingface.co#introducing-trackio-a-lightweight-experiment-tracking-library-from-hugging-face)
Introducing Trackio: A Lightweight Experiment Tracking Library from Hugging Face

[Update on GitHub](https://github.com/huggingface/blog/blob/main/trackio.md)

[Trackio](https://github.com/gradio-app/trackio)is a new, open-source, and free experiment tracking Python library that provides a local dashboard and seamless integration with Hugging Face Spaces for easy sharing and collaboration. Since

`trackio`

is a drop-in replacement for `wandb`

, you can get started with the syntax you already know!
##
[
](https://huggingface.co#background)
Background
...
##
[
](https://huggingface.co#why-we-switched-to-trackio)
...
**Standardization and Transparency**: Metrics like GPU energy usage are important to track and share with the community so we can have a better idea of the energy demands and environmental impacts of model training. Using Trackio, which directly gets information from the `nvidia-smi`

command, makes it easy to quantify and compare energy usage and to add it to [model cards](https://huggingface.co/docs/hub/model-cards).
...
##
[
](https://huggingface.co#using-trackio)
Using Trackio
...
##
[
](https://huggingface.co#installing)
Installing

You can install `trackio`
...
is designed to be a drop-in replacement for experiment tracking libraries like `wandb`

. The API is compatible with `wandb.init`

, `wandb.log`

, and `wandb.finish`

, so you can simply import `trackio`
...
###
[
](https://huggingface.co#visualizing-results)
Visualizing Results
...
###
[
](https://huggingface.co#sharing-with-🤗-spaces)
Sharing with 🤗 Spaces

To sync your local dashboard to Hugging Face Spaces, simply pass a `space_id`
...
Tip: you can set the name of this dataset by passing in a `dataset_id`
...
###
[
](https://huggingface.co#integrated-with-🤗-transformers-and-🤗-accelerate)
Integrated with 🤗 Transformers and 🤗 Accelerate

Trackio integrates natively with Hugging Face libraries like `transformers`

and `accelerate`

, so you can log metrics with minimal setup.
...
##
[
](https://huggingface.co#design-principles)
Design Principles
...
Trackio is intentionally lightweight and is currently in beta. Some features found in other tracking tools, such as artifact management, or complex visualizations, are not available yet. If you'd like to have these features, please create issues here: [https://github.com/gradio-app/trackio/issues](https://github.com/gradio-app/trackio/issues)
