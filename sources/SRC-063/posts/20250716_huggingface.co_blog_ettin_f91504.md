...
published: Wed, 16 Jul 2025 00:00:00 GMT

Fill-Mask • Updated • 3.55k • 6

#
[
](https://huggingface.co#ettin-suite-sota-paired-encoders-and-decoders)
Ettin Suite: SoTA Paired Encoders and Decoders

[Update on GitHub](https://github.com/huggingface/blog/blob/main/ettin.md)
...
##
[
](https://huggingface.co#encoders-vs-decoders-the-architecture-divide)
...
**Encoder models**use bidirectional attention, allowing each token to "see" all other tokens in the sequence (fully visible)**Decoder models**use causal attention, where tokens can only "see" previous tokens to enable autoregressive generation
...
##
[
](https://huggingface.co#training-recipe-modern-techniques-for-both-architectures)
...
###
[
](https://huggingface.co#three-phase-training-process)
...
###
[
](https://huggingface.co#modern-architecture-components)
...
###
[
](https://huggingface.co#data-sources-and-quality)
...
##
[
](https://huggingface.co#encoder-results-beating-modernbert)
...
##
[
](https://huggingface.co#decoder-results-beating-llama-32-and-smollm2)
...
##
[
](https://huggingface.co#fair-fight-encoders-vs-decoders-on-even-ground)
...
###
[
](https://huggingface.co#architecture-specific-advantages-persist)
...
###
[
](https://huggingface.co#cross-objective-training-falls-short)
...
##
[
](https://huggingface.co#beyond-performance-understanding-model-behavior)
...
**Encoder models**prefer gender-neutral pronouns more often (60%+ neutral vs 30%+ for decoders)**Both architectures**show male bias, but decoders slightly more so**Cross-objective training**affects bias patterns in measurable ways

This opens doors for systematic studies of how training objectives influence model behavior beyond just accuracy metrics.

##
[
](https://huggingface.co#usage-examples)
Usage Examples
...
##
[
](https://huggingface.co#fine-tuning-examples)
Fine-tuning Examples

###
[
](https://huggingface.co#encoders-1)
Encoders
...
###
[
](https://huggingface.co#decoders-1)
Decoders
...
#
[
](https://huggingface.co#full-training)
Full training
...
##
[
](https://huggingface.co#model-family-and-links)
...
[ettin-encoder-17m](https://huggingface.co/jhu-clsp/ettin-encoder-17m)/[ettin-decoder-17m](https://huggingface.co/jhu-clsp/ettin-decoder-17m)(17M params)[ettin-encoder-32m](https://huggingface.co/jhu-clsp/ettin-encoder-32m)/[ettin-decoder-32m](https://huggingface.co/jhu-clsp/ettin-decoder-32m)(32M params)[ettin-encoder-68m](https://huggingface.co/jhu-clsp/ettin-encoder-68m)/[ettin-decoder-68m](https://huggingface.co/jhu-clsp/ettin-decoder-68m)(68M params)[ettin-encoder-150m](https://huggingface.co/jhu-clsp/ettin-encoder-150m)/[ettin-decoder-150m](https://huggingface.co/jhu-clsp/ettin-decoder-150m)(150M params)[ettin-encoder-400m](https://huggingface.co/jhu-clsp/ettin-encoder-400m)/[ettin-decoder-400m](https://huggingface.co/jhu-clsp/ettin-decoder-400m)(400M params)[ettin-encoder-1b](https://huggingface.co/jhu-clsp/ettin-encoder-1b)/[ettin-decoder-1b](https://huggingface.co/jhu-clsp/ettin-decoder-1b)(1B params)

**Research Resources:**

[🤗 Ettin Model Collection](https://huggingface.co/collections/jhu-clsp/encoders-vs-decoders-the-ettin-suite-686303e16142257eed8e6aeb)[📝 Paper](https://github.com/jhu-clsp/ettin-encoder-vs-decoder)[🗂️ Training Data](https://huggingface.co/datasets/jhu-clsp/ettin-pretraining-data)(2T+ tokens, fully open)[💻 GitHub Repository](https://github.com/jhu-clsp/ettin-encoder-vs-decoder)[📊 250+ Training Checkpoints](https://huggingface.co/jhu-clsp/ettin-checkpoints)for studying training dynamics or knowledge learning