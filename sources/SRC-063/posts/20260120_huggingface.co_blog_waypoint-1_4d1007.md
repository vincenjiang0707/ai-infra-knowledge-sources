...
source: https://huggingface.co/blog/waypoint-1
published: Tue, 20 Jan 2026 00:00:00 GMT

#
[
](https://huggingface.co#waypoint-1-real-time-interactive-video-diffusion-from-overworld)
Waypoint-1: Real-time Interactive Video Diffusion from [Overworld](http://over.world)

[Update on GitHub](https://github.com/huggingface/blog/blob/main/waypoint-1.md)


[
](https://huggingface.co#waypoint-1-weights-on-the-hub)
...
##
[
](https://huggingface.co#try-out-the-model)
Try Out The Model
...
##
[
](https://huggingface.co#what-is-waypoint-1)
What is Waypoint-1?
...
##
[
](https://huggingface.co#how-was-it-trained)
How was it trained?
...
##
[
](https://huggingface.co#the-inference-library-worldengine)
