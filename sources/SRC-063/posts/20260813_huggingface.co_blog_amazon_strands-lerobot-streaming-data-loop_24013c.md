...
#
[
](https://huggingface.co#record-train-and-deploy-from-one-place-with-strands-agents-lerobot-and-hugging-face-storage-buckets)
Record, train, and deploy from one place with Strands Agents, LeRobot, and Hugging Face Storage Buckets
...
####
[
](https://huggingface.co#advanced-buckets-hardware-real-policies)
...
##
[
](https://huggingface.co#step-1---record-a-demonstration-into-a-bucket)
...
##
[
](https://huggingface.co#step-2---store-with-byte-level-deduplication)
...
##
[
](https://huggingface.co#step-3---train-by-streaming-from-the-hub)
...
##
[
](https://huggingface.co#step-4---deploy-the-policy-and-return-data-to-the-loop)
