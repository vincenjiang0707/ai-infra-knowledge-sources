...
Text Generation • 0.8B • Updated • 25.4M • 1.67k

#
[
](https://huggingface.co#codex-is-open-sourcing-ai-models)
Codex is Open Sourcing AI models

[Update on GitHub](https://github.com/huggingface/blog/blob/main/hf-skills-training-codex.md)

This article is also available in Chinese [简体中文](https://huggingface.co/blog/zh/hf-skills-training-codex).
...
##
[
](https://huggingface.co#goal-end-to-end-machine-learning-experiments)
...
##
[
](https://huggingface.co#setup-and-install)
Setup and Install

Before starting, you'll need:

- A Hugging Face account with a
[Pro](https://hf.co/pro)or[Team / Enterprise](https://hf.co/enterprise)plan (Jobs require a paid plan) - A write-access token from
[huggingface.co/settings/tokens](https://huggingface.co/settings/tokens) [Codex](https://developers.openai.com/codex/)installed and configured

###
[
](https://huggingface.co#install-codex)
Install Codex
...
###
[
](https://huggingface.co#install-the-hugging-face-skills)
...
###
[
](https://huggingface.co#connect-to-hugging-face)
Connect to Hugging Face

Authenticate with Hugging Face using the `hf auth login`

command and a write-access token from [hf.co/settings/tokens](https://huggingface.co/settings/tokens):
...
Codex supports [MCP (Model Context Protocol)](https://developers.openai.com/codex/) servers. You can configure the Hugging Face MCP server for additional Hub integration capabilities. You can add the Hugging Face MCP server to your Codex configuration by adding the following to your `~/.codex/config.toml`
...
##
[
](https://huggingface.co#your-first-ai-experiment)
...
###
[
](https://huggingface.co#instruct-codex-to-do-an-end-to-end-fine-tuning-experiment)
...
###
[
](https://huggingface.co#updating-the-training-report)
...
###
[
](https://huggingface.co#dataset-validation)
Dataset Validation
...
###
[
](https://huggingface.co#review-before-submitting)
...
###
[
](https://huggingface.co#track-progress-using-the-training-report)
...
###
[
](https://huggingface.co#use-your-model)
Use Your Model
...
###
[
](https://huggingface.co#hardware-and-cost)
Hardware and Cost
...
###
[
](https://huggingface.co#hugging-face-skills)
Hugging Face Skills
