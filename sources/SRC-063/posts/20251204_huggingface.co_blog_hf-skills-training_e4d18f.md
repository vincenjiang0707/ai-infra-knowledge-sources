...
Viewer • Updated • 83.1k • 1.91k • 219

#
[
](https://huggingface.co#we-got-claude-to-fine-tune-an-open-source-llm)
We Got Claude to Fine-Tune an Open Source LLM
...
[huggingface.co/settings/tokens](https://huggingface.co/settings/tokens) - A coding agent like Claude Code, OpenAI Codex, or Google's Gemini CLI
...
###
[
](https://huggingface.co#gemini-cli)
Gemini CLI
...
- See
[Gemini CLI extensions docs](https://geminicli.com/docs/extensions/#installing-an-extension)for more help.
...
##
[
](https://huggingface.co#your-first-training-run)
...
###
[
](https://huggingface.co#instruct-the-coding-agent-to-fine-tune)
...
###
[
](https://huggingface.co#track-progress)
Track Progress
...
###
[
](https://huggingface.co#supervised-fine-tuning-sft)
...
###
[
](https://huggingface.co#direct-preference-optimization-dpo)
...
[openbmb/RLAIF-V-Dataset]. Claude will apply minor modifications but will succeed in training.

###
[
](https://huggingface.co#group-relative-policy-optimization-grpo)
...
###
[
](https://huggingface.co#model-size-to-gpu-mapping)
...
###
[
](https://huggingface.co#demo-vs-production)
Demo vs Production
...
##
[
](https://huggingface.co#monitoring-training)
Monitoring Training
...
##
[
](https://huggingface.co#converting-to-gguf)
Converting to GGUF
