...
Viewer • Updated • 1.5k • 484 • 5

#
[
](https://huggingface.co#timescope-how-long-can-your-video-large-multimodal-model-go)
TimeScope: How Long Can Your Video Large Multimodal Model Go?

[Update on GitHub](https://github.com/huggingface/blog/blob/main/timescope-video-lmm-benchmark.md)
...
##
[
](https://huggingface.co#why-timescope-motivating-a-better-benchmark-for-video)
...
##
[
](https://huggingface.co#benchmark-design)
Benchmark Design
...
###
[
](https://huggingface.co#1-localized-retrieval)
...
###
[
](https://huggingface.co#2-information-synthesis)
...
###
[
](https://huggingface.co#3-fine-grained-temporal-perception)
...
##
[
](https://huggingface.co#evaluations--leaderboard)
...
###
[
](https://huggingface.co#what-did-we-learn)
What did we learn?
...
##
[
](https://huggingface.co#conclusion--lets-raise-the-bar-for-long-video-ai)
...
**Dataset**:[Apollo-LMMs/TimeScope](https://huggingface.co/datasets/Apollo-LMMs/TimeScope)**Leaderboard**:[Apollo-LMMs/TimeScope](https://huggingface.co/spaces/Apollo-LMMs/TimeScope)**Evaluation Framework**:[lmms-eval](https://github.com/EvolvingLMMs-Lab/lmms-eval)