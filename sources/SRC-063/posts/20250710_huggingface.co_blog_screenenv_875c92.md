...
source: https://huggingface.co/blog/screenenv
published: Thu, 10 Jul 2025 00:00:00 GMT

#
[
](https://huggingface.co#screenenv-deploy-your-full-stack-desktop-agent)
ScreenEnv: Deploy your full stack Desktop Agent
...
##
[
](https://huggingface.co#what-is-screenenv)
What is ScreenEnv?
...
##
[
](https://huggingface.co#why-screenenv)
Why ScreenEnv?

**🖥️ Full Desktop Control**: Complete mouse and keyboard automation, window management, application launching, file operations, terminal access, and screen recording**🤖 Dual Integration Modes**: Support both Model Context Protocol (MCP) for AI systems and direct Sandbox API - adapting to any agent or backend logic**🐳 Docker Native**: No complex VM setup - just Docker. The environment is isolated, reproducible, and easily deployed anywhere in less than 10 seconds. Support AMD64 and ARM64 architecture.

###
[
](https://huggingface.co#🎯-one-line-setup)
🎯 **One-Line Setup**
...
##
[
](https://huggingface.co#two-integration-approaches)
...
###
[
](https://huggingface.co#option-1-direct-sandbox-api)
...
###
[
](https://huggingface.co#option-2-mcp-server-integration)
...
##
[
](https://huggingface.co#✨-create-a-desktop-agent-with-screenenv-and-smolagents)
✨ Create a Desktop Agent with screenenv and smolagents

`screenenv`

natively supports `smolagents`

, making it easy to build your own custom Desktop Agent for automation. Here’s how to create your own AI-powered Desktop Agent in just a few steps:

###
[
](https://huggingface.co#1-choose-your-model)
**1. Choose Your Model**
...
###
[
](https://huggingface.co#2-define-your-custom-desktop-agent)
**2. Define Your Custom Desktop Agent**

Inherit from `DesktopAgentBase`

and implement the `_setup_desktop_tools`

method to build your own action space!
...
###
[
](https://huggingface.co#3-run-the-agent-on-a-desktop-task)
...
If you encounter acces denied docker error, you can try to run the agent with
...
💡 For a comprehensive implementation, see this

[CustomDesktopAgent]source on GitHub.
