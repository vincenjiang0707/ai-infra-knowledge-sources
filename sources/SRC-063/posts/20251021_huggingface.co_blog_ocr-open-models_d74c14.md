...
Image-Text-to-Text • 1.0B • Updated • 7.87k • 1.66k

#
[
](https://huggingface.co#supercharge-your-ocr-pipelines-with-open-models)
Supercharge your OCR Pipelines with Open Models

[Update on GitHub](https://github.com/huggingface/blog/blob/main/ocr-open-models.md)

This article is also available in Chinese [简体中文](https://huggingface.co/blog/zh/ocr-open-models).
...
[Supercharge your OCR Pipelines with Open Models](https://huggingface.co#supercharge-your-ocr-pipelines-with-open-models)

##
[
](https://huggingface.co#brief-introduction-to-modern-ocr)
...
###
[
](https://huggingface.co#model-capabilities)
Model Capabilities

####
[
](https://huggingface.co#transcription)
Transcription
...
####
[
](https://huggingface.co#handling-complex-components-in-documents)
...
####
[
](https://huggingface.co#output-formats)
Output formats
...
####
[
](https://huggingface.co#locality-awareness)
Locality Awareness
...
####
[
](https://huggingface.co#model-prompting)
Model Prompting
...
##
[
](https://huggingface.co#cutting-edge-open-ocr-models)
...
###
[
](https://huggingface.co#comparing-latest-models)
...
Handles checkboxes, flowcharts, and handwriting

[PaddleOCR-VL](https://huggingface.co/collections/PaddlePaddle/paddleocr-vl-68f0db852483c7af0bc86849)Allows prompting

Converts tables & charts to HTML

Extracts and inserts images directly

[dots.ocr](https://huggingface.co/rednote-hilab/dots.ocr)Extracts and inserts images

Handles handwriting

[OlmOCR-2](https://huggingface.co/allenai/olmOCR-2-7B-1025)Optimized for large-scale batch processing

[Granite-Docling-258M](https://huggingface.co/ibm-granite/granite-docling-258M)Ability to prompt element locations with location tokens

Rich output

[DeepSeek-OCR](https://huggingface.co/deepseek-ai/DeepSeek-OCR)Can parse and re-render all charts, tables, and more into HTML

Handles handwriting

Memory-efficient, solves text through image

[Chandra](https://huggingface.co/datalab-to/chandra)Extracts and inserts images as is

[Qwen3-VL](https://huggingface.co/collections/Qwen/qwen3-vl)Handles handwriting

Extracts and inserts images as is
...
###
[
](https://huggingface.co#evaluating-models)
Evaluating Models
...
####
[
](https://huggingface.co#cost-efficiency)
Cost-efficiency
...
####
[
](https://huggingface.co#open-ocr-datasets)
Open OCR Datasets
...
**Synthetic data generation**(e.g.,[isl_synthetic_ocr](https://huggingface.co/datasets/Sigurdur/isl_synthetic_ocr))**VLM-generated transcriptions**filtered manually or through heuristics**Using existing OCR models**to generate training data for new, potentially more efficient models in specific domains**Leveraging existing corrected datasets**like the[Medical History of British India Dataset](https://huggingface.co/NationalLibraryOfScotland), which contains extensively human-corrected OCR for historic documents
...
##
[
](https://huggingface.co#tools-to-run-models)
Tools to Run Models
...
Here is a simple method of deploying `nanonets`
...
- Click on the “Deploy” button and select the “HF Inference Endpoints”
...
###
[
](https://huggingface.co#going-beyond-ocr)
Going Beyond OCR
...
####
[
](https://huggingface.co#visual-document-retrievers)
...
####
[
](https://huggingface.co#using-vision-language-models-for-document-question-answering)
