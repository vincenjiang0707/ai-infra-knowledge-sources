...
The model might decide the first thing it needs to do to answer that question is search the codebase for terms such as `auth`
...
- PI:
[https://pi.dev/](https://pi.dev/) - OpenCode:
[https://opencode.ai/](https://opencode.ai/) - Amp:
