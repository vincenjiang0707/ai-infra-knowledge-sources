...
| SRC-011 | llama.cpp | 推理引擎与部署配⽅ | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-012 | MLC LLM | 推理引擎与部署配⽅ | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
...
| SRC-035 | Ascend | 昇腾与其他国产芯⽚ | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-036 | Ascend | 昇腾与其他国产芯⽚ | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok |
...
| SRC-044 | 昆仑芯官⽅开 | 昇腾与其他国产芯⽚ | success | github_org:ok |
| SRC-045 | Paddle 推理 | 昇腾与其他国产芯⽚ | success | github_repo:ok |
...
| SRC-053 | Kimi 模型⻚ | 模型作者与模型平台 | success | hf:ok(19) |
| SRC-054 | DeepSeek 官⽅ | 模型作者与模型平台 | success | github_org:ok |
| SRC-055 | DeepSeek 模型 | 模型作者与模型平台 | success | hf:ok(105) |
| SRC-056 | MiniMax 官⽅组 | 模型作者与模型平台 | success | github_org:ok |
| SRC-057 | MiniMax 模型⻚ | 模型作者与模型平台 | success | hf:ok(21) |
| SRC-058 | InternLM | 模型作者与模型平台 | success | github_org:ok |
| SRC-059 | Baidu ERNIE | 模型作者与模型平台 | success | github_repo:ok |
| SRC-060 | 腾讯 Hunyuan | 模型作者与模型平台 | success | github_org:ok; github_repo:ok; reference:ok; reference:ok; reference:ok |
...
| SRC-068 | FlashInfer | Kernel、编译与⾃动优化 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-069 | DeepGEMM | Kernel、编译与⾃动优化 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-070 | DeepEP | Kernel、编译与⾃动优化 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok |
...
| SRC-078 | GPU MODE | Kernel、编译与⾃动优化 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-079 | NVIDIA Model | 量化、推测解码与精度验证 | success | github_repo:ok |
| SRC-080 | LLM | 量化、推测解码与精度验证 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-081 | GPTQModel | 量化、推测解码与精度验证 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-082 | AWQ | 量化、推测解码与精度验证 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok |
| SRC-083 | bitsandbytes | 量化、推测解码与精度验证 | success | github_repo:ok |
| SRC-084 | HQQ | 量化、推测解码与精度验证 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok |
| SRC-085 | EAGLE | 量化、推测解码与精度验证 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-086 | Medusa | 量化、推测解码与精度验证 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-087 | Speculators | 量化、推测解码与精度验证 | success | github_repo:ok |
| SRC-088 | lm-evaluation- | 量化、推测解码与精度验证 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok |
| SRC-089 | NVIDIA Dynamo | KV、路由、分布式与基础设施 | success | github_repo:ok |
| SRC-090 | Dynamo 调优 | KV、路由、分布式与基础设施 | success | github_repo:ok; reference:ok; reference:ok; reference:ok; site:ok |
| SRC-091 | LMCache | KV、路由、分布式与基础设施 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-092 | Mooncake | KV、路由、分布式与基础设施 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-093 | AIBrix | KV、路由、分布式与基础设施 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-094 | Ray Serve LLM | KV、路由、分布式与基础设施 | success | sitemap:ok(27) |
| SRC-095 | KubeRay | KV、路由、分布式与基础设施 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-096 | UCX | KV、路由、分布式与基础设施 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-097 | NIXL | KV、路由、分布式与基础设施 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
...
| SRC-105 | DCGM | Profiling、压测与公开结 | success | github_repo:ok; github_repo:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok; reference:ok |
| SRC-106 | AMD SMI | Profiling、压测与公开结 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-107 | vLLM benchmark | Profiling、压测与公开结 | success | sitemap:ok(4) |
| SRC-108 | vLLM 性能看板说明 | Profiling、压测与公开结 | success | sitemap:ok(1) |
| SRC-109 | GenAI Perf | Profiling、压测与公开结 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-110 | EvalScope | Profiling、压测与公开结 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-111 | GuideLLM | Profiling、压测与公开结 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-112 | InferenceX | Profiling、压测与公开结 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
| SRC-113 | MLPerf Inference | Profiling、压测与公开结 | success | github_repo:ok |
| SRC-114 | MLCommons 提交 | Profiling、压测与公开结 | success | github_repo:ok; reference:ok; reference:ok; reference:ok; academic:ok |
| SRC-115 | arXiv | 论⽂、会议与课程 | success | academic:ok |
| SRC-116 | MLSys | 论⽂、会议与课程 | success | academic:ok |
| SRC-117 | USENIX | 论⽂、会议与课程 | success | academic:ok |
| SRC-118 | ACM Digital | 论⽂、会议与课程 | blocked | PDF 标 403（ACM Digital Library） |
...
| SRC-146 | GitHub | 精选作者、专业社区与新来源发现 | success | reference:ok |
| SRC-147 | GitHub | 精选作者、专业社区与新来源发现 | success | github_org:ok |
| SRC-148 | Hugging Face | 精选作者、专业社区与新来源发现 | success | hf:ok |
| SRC-149 | Reddit | 精选作者、专业社区与新来源发现 | success | site:ok |
| SRC-150 | 知乎 | 精选作者、专业社区与新来源发现 | blocked | PDF 标登录拦截（知乎） |
...
| SRC-158 | 海光 DTK 专区 | 昇腾与其他国产芯⽚ | success | site:ok |
| SRC-159 |  | 昇腾与其他国产芯⽚ | success | site:ok |
| SRC-160 | 寒武纪 SDK | 昇腾与其他国产芯⽚ | blocked | PDF 标获取失败（寒武纪 SDK 文档） |
| SRC-161 | FlashInfer-Bench | Profiling、压测与公开结 | success | github_repo:ok; reference:ok; reference:ok; reference:ok |
